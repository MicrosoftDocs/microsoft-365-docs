...
6. To start a new chat session with Copilot, select ![Screenshot of the New chat icon in Copilot in Defender.](media/defender-ti-and-copilot/copilot-defender-new-chat.png).
