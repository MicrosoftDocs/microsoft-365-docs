...
data sets include Resolutions, Whois, SSL Certificates, Subdomains, Hashes, DNS, Reverse DNS, and Services. Advanced data sets include Trackers, Components, Host Pairs, and Cookies. Trackers, Components, Host Pairs, and Cookies data sets are collected from observing the Document Object Model (DOM) of web pages crawled. Additionally, Components and Trackers are also observed from detection rules that are triggered based on the banner responses from   
...
**Questions this data set may help answer:**  
  ...
  - Did you identify additional related IOCs from pivoting on potentially shared Whois values across domains?  
     -	For example, pivoting from a phone number, email address, and Whois Organization Name pivot may lead to more domains that share or have shared the same values in their Whois records.  
...
**Questions this data set may help answer:**  
  ...
  - Have any of the connected artifacts been block-listed?  
...
For more information, see:  
  ...
  - [Searching and pivoting](https://microsoft.sharepoint.com/:w:/t/RiskIQ-PM-Team/EcY2_tq3v91HjB4-CGzkrt0BMFlcXsw-cWFv1MK9Nppymw?e=5IarUI)
  - [Sorting, filtering, and downloading data](https://microsoft.sharepoint.com/:w:/t/RiskIQ-PM-Team/ERLnyiRVFLFKui5dDx9GApUBuQHrSCz2s6ckaVFnrcP1zQ?e=C4vHcc)
  - [Infrastructure chaining](https://microsoft.sharepoint.com/:w:/t/RiskIQ-PM-Team/EfwtUfzY6w1Aq9t2DB7sxqsBJv-4wkkCgWnJaFiUHNcDJw?e=2rIErN)
  - [Tutorial: Gathering threat intelligence and infrastructure chaining](https://microsoft.sharepoint.com/:w:/t/RiskIQ-PM-Team/EVEhyLUqdzZLqAQldkTMV1YBmDP06tor0GGPbaFia0PGGA?e=JMrK7t) 
