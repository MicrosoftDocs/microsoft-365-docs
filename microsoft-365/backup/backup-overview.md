...
|**Billing model**    |$0.15 per GB per month for all data protected by Backup<br><br>Restores are free<br><br>(Different price for third-party providers)  |$0.15 per GB per month for all data protected by Backup<br><br>Restores are free<br>(Different price for third-party providers)   |$0.15 per GB per month for all data protected by Backup<br><br>Restores are free<br><br>(Different price for third-party providers)  |
