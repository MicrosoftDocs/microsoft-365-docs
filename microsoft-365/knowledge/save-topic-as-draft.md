...
4. When you're ready for users to see your changes, you will see either a **Publish** or **Republish** button. 
    ...
    - **Publish** is available when the topic only has AI-discovered content and you are editing for the first time. When you publish, edits you made to the topic name, alternate name, description, or pinned people will display to users who can view the topic. Specific files, pages, sites, AI-discovered alternate names, and people will still be visible only to those who have permissions to those resources.

    - **Republish** means that you are editing a previously published topic.
 
## Lifecycle of a draft page
 
1. When you save a topic as a draft and close this page, it is checked in as a minor version, and becomes a "shared" draft. This means that anyone with edit permissions (or site owners) can now see the draft and edit it.
