...
Topic experience uses existing content security features in Microsoft 365 to prevent users from seeing content that they shouldn't. 

Topic experiences provides two additional ways to control access to topics:

- Admin controls to prevent specified sites and topic names from being included in topic experiences
...
As topics move through the stages to published, they become more likely to be presented to users in highlights and topic cards.
