...
> ![Left-hand menu](Media/uploadingzip01.png)
...
1. In the **Package source** section, select Pre-built package (.zip) in the Package source type.
   ...
   > [!div class="mx-imgBorder"]
   > ![New package](Media/uploadingzip02.png)

2. Then upload your pre-built package (zip) file by clicking 'Select file' button.
...
3. Type in your package's name and version in the **Basic information** section.
   ...
   > [!div class="mx-imgBorder"]
   > ![Basic information](Media/uploadingzip03.png)
...
4. After all the requested information is specified, you can proceed to the next phase by clicking the **Next: Configuration test** button.
   ...
   > [!div class="mx-imgBorder"]
   > ![Next: Configuration test](Media/uploadingzip04.png)
...
1. Select the **Type of test** according to your pre-built package. There are two test types supported:
   ...
   > [!div class="mx-imgBorder"]
   > ![Out of Box test option](Media/uploadingzip05.png)

2. Once all required info is filled out, you can proceed to step 3 by clicking the Next button at the bottom.
...
1. In the Edit package tab, you can
   ...
   > [!div class="mx-imgBorder"]
   > ![PowerShell code editor](Media/uploadingzip06.png)
...
4. Once all required info is filled out, you can proceed to step 4 by clicking the Next button at the bottom.
...
3. Select options for Feature update tests.
   ...
   > [!div class="mx-imgBorder"]
   > ![Test matrix](Media/uploadingzip11.png)

4. Once all the required info is filled out, you can proceed to step 5 (the last step) by clicking the Next button at the bottom.
...
1. Review all the information for correctness and accuracy of your draft package. To make corrections, you can navigate back to early steps where you specified the settings as needed.
   ...
   > [!div class="mx-imgBorder"]
   > ![Review and publish](Media/uploadingzip12.png)
