...
|Factor|Description|
|---|---|
|Is the tenant licensed for the required services associated with the task?|<ul><li>Tasks that are not licensed won't be eligible for deployment.</li><li>Tasks that aren't licensed may be Dismissed.</li><li>Lighthouse will direct users to the Business Workshop Tool to determine licensing needs.</li><li>Once Lighthouse detects that the tenant is licensed for the required services associated with the task, the status will be updated automatically.</li></ul>|
