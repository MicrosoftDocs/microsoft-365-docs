...
2. Do one of the following:
    ...
    - If you don't see an error message, then
    
    - If you see the error message, "You need to sign up for Microsoft 365 Lighthouse in the Microsoft 365 admin center," then follow these steps:     
