...
|**Lighthouse page**  | **Account Managers**| **Service Desk** |**System Administrators** | **Escalation Engineers**|
|--|--|--|--|--|
...
|   |  | |   |  |
|**Home**     | <ul><li>View All</li></ul> | <ul><li>View All</li></ul>| <ul><li>View All</li></ul>  | <ul><li>View All</li></ul> | 
...
|**Users**   | <ul><li>View tenant level (non-user specific) information</li><li>Search user accounts across tenants</li><li>Reset password for non-administrators*</li></ul>  | <ul><li>View all user-specific information</li><li>Search user accounts across tenants</li><li>Reset password for non-administrators*</li></ul>|  <ul><li>View all user-specific information</li><li>Search user accounts across tenants</li><li>Reset password for non-administrators*</i><li>Block sign-in</li></ul>  | <ul><li>View all user-specific information</li><li>Search user accounts across tenants</li><li>Reset password for non-administrators*</li><li>Block sign-in</li><li>Confirm user(s) compromised</li><li>Dismiss user(s) risk</li></ul> |
|**Devices**    | <ul><li>View All</li></ul> | <ul><li>View All</li></ul>| <ul><li>View All</li></ul>  | <ul><li>View all</li><li>Sync device</li><li>Restart device</li><li>Collect diagnostics</li></ul>|
|**Threat management**  | <ul><li>View All</li></ul> | <ul><li>View All</li></ul>| <ul><li>View All</li></ul>  | <ul><li>View all</li><li>Run full scan</li><li>Run quick scan</li><li>Update antivirus</li><li>Reboot device</li></ul>|
|**Baselines**    | <ul><li>View All</li></ul> | <ul><li>View All</li></ul>| <ul><li>View All</li></ul>  | <ul><li>View All</li></ul> | 
|**Windows 365** |<ul><li>View All</li></ul> | <ul><li>View All</li></ul>| <ul><li>View All</li></ul>  | <ul><li>View All</li></ul> | 
|**Service health**|  **  |   |   | |  |
|**Audit logs**|   **  |   |   | |  |
