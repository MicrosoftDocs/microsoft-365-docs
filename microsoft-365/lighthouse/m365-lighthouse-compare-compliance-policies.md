...
[What is device enrollment in Intune?](https://docs.microsoft.com/mem/intune/enrollment/device-enrollment) (article)  
[Use compliance policies to set rules for devices you manage with Intune](https://docs.microsoft.com/mem/intune/protect/device-compliance-get-started) (article)  
[Overview of using baselines to deploy standard tenant configurations](https://ppc-word-edit.officeapps.live.com/we/m365-lighthouse-deploy-standard-tenant-configurations-overview.md) (article)
