...
To install the Azure Information Protection client to add the **Protect** icon and the classification ribbon for your Office apps, see [Install the Azure Information Protection client for users](https://docs.microsoft.com/azure/information-protection/rms-client/client-admin-guide-install).
  
To see how to add custom setting to the Azure Information Protection client, see [Create custom settings for AIP](https://docs.microsoft.com/azure/information-protection/rms-client/client-admin-guide-customizations).
