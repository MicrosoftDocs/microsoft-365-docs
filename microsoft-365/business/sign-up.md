...
2. On the **Create your user ID** page:
    ...
    - **Select a domain**: If you own your domain name already, select .onmicrosoft.com from the drop down men and we'll ask you to set it up later. Otherwise, it's easy to buy a domain name that represents your business. To do that, select the domain you prefer from the drop down menu. For example, your full email address might be *Teresa@ContosoSkis.net*. We'll let you know right away if the domain name is available. If it is, we'll add the cost of your domain to the cost of your Microsoft 365 Business subscription. The new domain will also be set up and ready for use in Microsoft 365 if you purchase it here. For information about domains, see [Domains FAQ](https://docs.microsoft.com/office365/admin/setup/domains-faq).
