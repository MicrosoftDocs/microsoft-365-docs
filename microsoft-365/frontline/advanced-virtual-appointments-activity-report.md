...
|**4**   |This table shows detailed usage information for each user in your organization during the selected date range. <ul><li>**Primary** shows the name assigned to each user.</li>li>**Primary's email** shows the email address of each user.</li><li>**Total Appointments** shows the total number of virtual appointments in which this user used an advanced feature.</li><li>**SMS** shows the total number of times this user used SMS in a virtual appointment.</li><li>**On-demand** shows the total number of times this user joined an on-demand appointment by selecting **Join** on the **Queue** tab in the Virtual Appointments app.</li><li>**Queue** shows the total number of times this user navigated to the **Queue** tab in the Virtual Appointments app.</li></ul>
