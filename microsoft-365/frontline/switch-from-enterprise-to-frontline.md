...
&sup1;No Long-Term Servicing Channel (LTSC) or Microsoft Desktop Optimization Pack (MDOP). Virtual desktop infrastructure (VDI) is only for licensed users of a shared device with a Qualifying Operation System (except for Azure Virtual Desktop).
