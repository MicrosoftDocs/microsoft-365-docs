...
&sup1;No Long-Term Servicing Channel (LTSC) or Microsoft Desktop Optimization Pack (MDOP). Virtual desktop infrastructure (VDI) is only for licensed users of a shared device with a Qualified Operation System (QOS), (except for Azure Virtual Desktop).
