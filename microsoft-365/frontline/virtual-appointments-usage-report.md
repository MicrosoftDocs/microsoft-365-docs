...
> [!NOTE]
> This feature is temporarily available as preview for all customers. To get this feature after the preview, each user will need a [Teams Premium]() license or a Teams EHR connector license.
...
> [!NOTE]
> Premium appointments are appointments that use at least one advanced Virtual Appointments capability available in [Teams Premium]() (preview). For more analytics on advanced Virtual Appointments usage, see the [Virtual Appointments active user report](virtual-appointments-active-user-report.md).
...
:::image type="content" source="media/va-usage-report-dashboard.png" alt-text="Screenshot of the Virtual Appointments usage card in the Teams admin center dashboard":::
