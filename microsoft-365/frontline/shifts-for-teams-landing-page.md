...
|&nbsp;  |&nbsp; |
|---------|---------|
|:::image type="icon" source="/office/media/icons/deploy-teams.png":::|**[Deploy Shifts at scale](deploy-shifts-at-scale.md)** Configure Shifts settings for all your frontline teams and manage them centrally by deploying Shifts at scale in the Teams admin center.|
