...
|&nbsp;  |&nbsp; |
|---------|---------|
|:::image type="icon" source="/office/media/icons/deploy-teams.png":::|**[Deploy Shifts at scale](deploy-shifts-at-scale.md)** Learn how to deploy Shifts to your frontline teams at scale in the Teams admin center. You can configure and manage Shifts settings centrally, and deploy Shifts to all your frontline teams at once.|
