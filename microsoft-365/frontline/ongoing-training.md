---
title: Ongoing training for frontline workers
description: Learn how you can use Viva Learning to manage ongoing training for your frontline team.
ms.topic: conceptual
author: daisyfell
...
# Ongoing training for frontline workers
...
Viva Learning is automatically enabled for Teams users, so you don't need to do additional set up in the admin center. You can [pin the Viva Learning app](/microsoftteams/teams-app-setup-policies#pin-apps) to make sure your frontline workers can find it easily.

[Learn more about getting and setting up Viva Learning](/viva/learning/set-up-viva-learning).

## Choose and manage your content

Content from Microsoft, as well as select content from LinkedIn Learning, is available by default in Viva Learning. You can also [bring in custom content from your organization with SharePoint](/viva/learning/configure-sharepoint-content-source). Using SharePoint allows you to create and distribute learning content created by and for your organization, so you can choose to share exactly what your workforce needs.
...
Use [Viva Connections](/viva/connections/viva-connections-overview) to distribute a SharePoint news post that highlights new learning opportunities or required trainings.
...
Make sure your workforce knows how to use Viva Learning. Share [this content set](https://support.microsoft.com/office/viva-learning-01bfed12-c327-41e0-a68f-7fa527dcc98a) to help your frontline team get comfortable using Viva Learning.
