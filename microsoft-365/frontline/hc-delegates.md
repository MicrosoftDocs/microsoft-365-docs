...
1. The user who's going to be away @mentions another user (the delegate) in their status message to let people know to contact the delegate instead while the user is away. <br>
    ![Screenshot of a status message with a user set as a delegate.](media/message-delegation.png) <br>
