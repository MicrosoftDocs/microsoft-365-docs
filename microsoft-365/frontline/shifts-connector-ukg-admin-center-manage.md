...
- To change an existing connection instance, go to **Actions**, and then select **Edit**. You'll be taken to the wizard, where you can [update the settings and mappings](shifts-connector-wizard-ukg.md#create-a-connection-instance).
- To delete an existing connection instance, go to **Actions**, and then select **Delete**. You can't undo this action.
...
- Edit existing mappings to update the Microsoft Teams team to which a WFM instance is connected.
