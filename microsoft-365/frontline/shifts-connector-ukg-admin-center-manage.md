...
- Edit existing mappings, to update the team in Microsoft Teams to which a WFM instance is connected.
  If you're mapping to a team in Microsoft Teams that has previously used Shifts, make sure you [remove schedule entities from teams you want to map](/microsoft-365/frontline/shifts-connector-wizard-ukg#remove-schedule-entities-from-teams-you-want-to-map)
- Deleting active mappings, either by clearing the checkbox of the mapped WFM instance, or by uploading the CSV file with the mapping row removed.
