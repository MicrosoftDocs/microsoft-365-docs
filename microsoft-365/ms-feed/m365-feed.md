---
title: "Admin Guide for Microsoft Feed"
ms.author: temanteleary
author: temanteleary
manager: scotv
ms.date: 03/28/2023
audience: Admin
...
# Admin Guide for Microsoft Feed
...
In Microsoft 365 (previously Office.com), select Feed Icon from the left navigation bar.

## Where can users see Microsoft Feed?

In **Microsoft 365** (previously Office.com), select **Feed** from the left navigation bar.

![Select Feed in Microsoft 365.](../media/MS-select-feed.png)

In **Microsoft Edge**, while signed in with a work or school account, select the **Microsoft 365** page when opening a new tab.
...
Microsoft Feed is built on Microsoft 365 and implicitly respects all settings and restrictions enabled by admins and users, such as Customize people insights privacy in Microsoft Graph [Customize people insights privacy in Microsoft Graph](https://learn.microsoft.com/en-us/graph/insights-customize-people-insights-privacy)  For more information on how item insights setting works, see [Item insights overview](https://learn.microsoft.com/en-us/graph/item-insights-overview)
...
1.    Responding to our Message Center post with feedback. You can leave your email address if you would like us to contact you. This option is only available for tenant admins with access to the Microsoft Admin Center in Microsoft 365.
