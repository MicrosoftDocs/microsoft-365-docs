---
title: Step 1. Use a document processing model to identify contract files and extract data
ms.author: chucked
...
ROBOTS: 
description: Learn how to use document processing models to identify contract files and extract data by using a Microsoft 365 solution.
---

# Step 1. Use a document processing model to identify contract files and extract data

Your organization needs a way to identify and classify all contract documents from the many files you receive. You also want to be able to quickly view several key elements in each of the contract files identified (for example, *Client*, *Contractor*, and *Fee amount*). You can do this by creating an unstructured document processing model and applying it to a document library.
