...
description: Learn about how to export and import document processing models with PowerShell.
---
...
Document processing models can be exported as PnP templates, enabling reuse across content centers or tenants.
