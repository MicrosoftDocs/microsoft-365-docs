...
## Microsoft 365 for business: Subscription lifecycle
...
- If you cancel your monthly subscription, it will be disabled immediately (at the date of cancellation). This means your users will lose access to the Microsoft 365 assets immediately and only admins will have access to the data for the next 90 days.
...
When your trial ends, you won't be able to continue using Microsoft 365 for free. You have a few options:
...
::: moniker range="o365-21vianet"
- **Buy Microsoft 365.** When your trial expires, it moves into a grace period, giving you another 30 days (for most trials, in most countries and regions) to purchase Microsoft 365. To learn how to convert your trial into a paid subscription, see [Buy or try subscriptions for Microsoft 365 operated by 21Vianet](../../admin/services-in-china/buy-or-try-subscriptions.md).
