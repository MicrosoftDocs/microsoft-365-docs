...
1. Find the subscription that you want to cancel. Select **More actions** (three dots), then select **Cancel subscription**.
1. In the **Cancel subscription** pane, choose a reason why you're canceling. Optionally, provide any feedback.
1. Select **Save**.
