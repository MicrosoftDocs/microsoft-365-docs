---
title: "Switch to a different Microsoft 365 for business plan"
f1.keywords:
- NOCSH
ms.author: cmcatee
author: cmcatee-MSFT
...
- You're using more than one Microsoft 365 plan. You can only use the **Switch plans** button if all users subscribe to the same plan.
