...
If recurring billing is turned off for a billing profile, you can use the **Pay now** button on the invoice summary in the admin center to pay for it every billing period, regardless of what payment method is linked with the billing profile. You can also pay by electronic funds transfer (EFT). Instructions for how to do that are included on the PDF copy of your invoice.
...
If you have a billing profile that is set up to be paid by invoice, you can pay for your subscription with EFT. You can also use a credit or debit card to make a one-time payment by using the **Pay now** button on your invoice.
