...
| Transactional cost | Not applicable. | For per-user licensing, uses AI Builder credits.<br>3,500 credits are included for each Syntex license per month.<br>1 million credits will allow processing of 10,000 file pages.<br>For pay-as-you-go licensing, not applicable. | FOr per-user licensing, uses AI Builder credits.<br>3,500 credits are included for each Syntex license per month.<br>1 million credits will allow processing of 10,000 file pages.<br>For pay-as-you-go licensing, not applicable. |
