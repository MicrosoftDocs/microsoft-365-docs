...
1. Follow the instructions in [Create a model in Syntex](create-syntex-model.md&tabs=teaching-method%2Csensitive-information-processing#set-up-a-prebuilt-model) to create a prebuilt sensitive information model. Then continue with the following steps to complete your model.
