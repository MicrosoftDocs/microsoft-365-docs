...
1. Follow the instructions in [Create a model in Syntex](create-syntex-model.md#set-up-a-prebuilt-model) [test link1](https://learn.microsoft.com/en-us/microsoft-365/syntex/create-syntex-model?tabs=teaching-method%2Creceipt-processing#tabpanel_2_sensitive-information-processing) [test link2](https://review.learn.microsoft.com/en-us/microsoft-365/syntex/create-syntex-model?branch=pii-prebuilt-working&tabs=layout-method%2Ccontract-processing#tabpanel_2_sensitive-information-processing) [test link3](create-syntex-model.md#tab/sensitive-information-processing) [test link4](create-syntex-model.md/#tab/sensitive-information-processing) [test link5](https://review.learn.microsoft.com/en-us/microsoft-365/syntex/create-syntex-model?branch=pii-prebuilt-working&tabs=teaching-method%2Ccontract-processing#tabpanel_2_sensitive-information-processing) to create a prebuilt sensitive information model. Then continue with the following steps to complete your model.
