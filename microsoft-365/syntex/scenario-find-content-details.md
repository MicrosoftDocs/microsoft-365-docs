...
The team decides to use Microsoft Syntex as the solution.

1. Set up a SharePoint document library where you want to store the legal content.

2. Copy the content of the email messages and attachments to the document library.

3. Use Syntex to extract information and metadata from email messages as well as the attachments to help organize content.
