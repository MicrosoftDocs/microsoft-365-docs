...
|[:::image type="content" source="../media/content-understanding/uc-unstructured-repos.png" alt-text="Image of a generic business person in an office setting." border="false":::](scenario-handle-incoming-documents.md)|[**Organize unstructured repositories**](scenario-handle-incoming-documents.md) <br>Use Syntex to make documents in documents easy to find. <br>[Policies and procedures](scenario-handle-incoming-documents.md#insurance-claims) <br>[Example2](scenario-handle-incoming-documents.md#rental-contract-management) |
