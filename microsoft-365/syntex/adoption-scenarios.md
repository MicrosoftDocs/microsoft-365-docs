...
|[:::image type="content" source="../media/content-understanding/uc-unstructured-repos.png" alt-text="Image of a generic business person in an office setting." border="false":::](scenario-organize-repositories.md)|[**Organize unstructured repositories**](scenario-handle-incoming-documents.md) <br>Use Syntex to make business documents in document libraries easier for users to find and use. <br>[Policies and procedures](scenario-organize-repositories.md#policies-and-procedures) <br>[Example2](scenario-organize-repositories.md#example2) |
