...
|---|---|
|[**Site template solutions**](site-templates.md) <br>:::image type="content" source="../media/content-understanding/uc-site-template.png" alt-text="Image of a generic business person using a computer." border="false":::|Use SharePoint site templates to jumpstart a professional site to manage, process, and track the status of business documents in your organization. <br>[Accounts payable](/microsoft-365/freelance-toolkit/communication-deploy-sharepoint-site.md) <br>[Contracts management](/microsoft-365/freelance-toolkit/communication-deploy-sharepoint-site.md) |
|[**Automatically generate routine documents**](site-templates.md) <br>:::image type="content" source="../media/content-understanding/uc-automatic-content-assembly.png" alt-text="Image of a generic business person using a computer in a manufacturing setting." border="false":::|Use Syntex content assembly to create modern templates for files that need to be generated on a regular basis. <br>[Routine maintenance reports](/en-us/microsoft-365/freelance-toolkit/collaboration-teams) <br>[Job descriptions](/en-us/microsoft-365/freelance-toolkit/collaboration-teams)|
