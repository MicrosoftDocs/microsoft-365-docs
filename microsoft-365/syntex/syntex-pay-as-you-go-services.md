...
|Image tagging|The number of images processed. Each processed image counts as one transaction. You won’t be charged if you only enable pay-as-you-go billing for image tagging. You will be charged only when you enable image tagging on a document library.|$0.001/image|
