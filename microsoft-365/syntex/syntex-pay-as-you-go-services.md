...
|Microsoft 365 Archive (Preview)  |Monthly site archive is calculated as the sum (in gigabytes) of the usage of all currently archived sites.<br><br>Monthly site reactivation is charged based on the site storage usage (in gigabytes) of each site being restored. |$0.05/GB/month<br><br>$0.6/GB|
