...
|Syntex eSignature |The number of electronic signature requests processed. Each signature request for up to 10 recipients counts as one transaction. |$2.00/transaction |
