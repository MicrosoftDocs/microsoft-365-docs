...
|Translation |For both document translation and video transcript translation, the number of characters from the source document or transcript. Character count includes letters, Unicode code points, punctuation, and white spaces. (This meter is charged only when the translation has successfully resulted in a new document or transcript.) |$15.00/1M characters |
