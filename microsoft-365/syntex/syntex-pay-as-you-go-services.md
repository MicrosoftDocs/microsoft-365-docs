...
> [!NOTE]
> From January 1 to June 30, 2024, if you have [pay-as-you-go billing](syntex-azure-billing.md) set up, you will receive a limited amount of included capacity each month for each service, enabling you to try these services at no cost. For more information, see [Try out Microsoft Syntex and explore its features](trial-syntex.md).
