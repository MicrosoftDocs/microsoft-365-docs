...
In addition to image-based PDF, Syntex OCR starts to support hybrid PDF (text plus image PDF) beginning November 2024. After that time, newly uploaded hybrid PDFs will be processed by the OCR service.
