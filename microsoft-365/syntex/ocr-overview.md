...
The OCR service can be used for multiple solutions. The following table shows solutions for end users. For details on compliance solutions, see [Supported locations and solutions in Microsoft Purview](https://learn.microsoft.com/en-us/purview/ocr-learn-about#supported-locations-and-solutions).
