...
The OCR service supports multiple solutions, as shown in the following table. For details on compliance solutions, see [Supported locations and solutions in Microsoft Purview](https://learn.microsoft.com/en-us/purview/ocr-learn-about#supported-locations-and-solutions).
