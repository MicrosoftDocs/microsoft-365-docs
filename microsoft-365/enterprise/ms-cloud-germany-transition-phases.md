...
<ul><li> Transition users and services off Germany URLs to Office 365 services URLs (https://outlook.office365.com). </li><li> Users will continue to access the service via legacy Germany URLs during the migration. No immediate action needed. </li><li> Users should begin to use the office.com portal for Office Online features (Calendar, Mail, People). Navigation to services not yet migrated to Office 365 services will not function until migrated. </li><li> Public folder Outlook Web Access experience during migration is not available. </li></ul>|
|||||

To find out more information about the differences for organizations in migration and after Exchange Online resources are migrated, review the Customer experience during the migration to Office 365 services in the new German datacenter regions <<add link>>.
...
<ul><li> Microsoft managed DNS entries update from Office365 Germany Exchange Online Protection to Office 365 services. </li><li>  </li><li> Customer should wait for 30 days after EOP dual write for EOP migration, otherwise may cause data loss. </li></ul> |
|||||
...
<ul><li> Content will be read-only for two brief periods during migration (less than x minutes), expect “you can’t edit content” banner in SharePoint. </li><li> Search index will not be preserved, may take up to 10 days to rebuild. </li><li> SharePoint/OneDrive content will be read-only for two brief periods during migration (<x minutes). Users will see “you can’t edit content” banner briefly during this window. </li><li> Search Index may be unavailable while re-index completes. During this period search queries may not return complete results </li><li> Existing site are preserved </li></ul> |
|||||
