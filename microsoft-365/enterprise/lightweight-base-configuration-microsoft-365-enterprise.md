...
Use the instructions in [Connect to Microsoft 365 with PowerShell](connect-to-office-365-powershell,md#connect-with-the-azure-active-directory-powershell-for-graph-module) to connect to your subscription with the Azure Active Directory PowerShell for Graph module from your computer.
