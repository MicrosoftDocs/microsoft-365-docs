...
Although you can define your own security levels and might already have some in place, Microsoft recommendations that you use at least three different tiers of security and protection that can be applied: 
...
- **Sensitive:** This is a higher level of protection for a subset of your data that must be protected beyond those protections at the baseline level. You can apply this increased protection to specific data sets in your Office 365 environment. Microsoft recommends protecting identities and devices that access sensitive data with a sensitive security level. 
