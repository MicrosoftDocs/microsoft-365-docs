...
- Central security dashboard for IT with Azure Defender*
  ...
  Contoso uses the [Azure Defender*](https://azure.microsoft.com/services/security-center/) for a unified view of security and threat protection, to manage security policies across its workloads, and to respond to cyberattacks.
