...
- Secure email flow and mailbox audit logging with Microsoft Defender for Office 365
   ...
   Contoso is using [the built-in security features for all cloud mailboxes](/defender-office-365/eop-about) and [Defender for Office 365](/defender-office-365/mdo-about) to protect against unknown malware, viruses, and malicious URLs transmitted through emails.
