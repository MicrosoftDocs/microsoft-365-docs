...
- My Microsoft 365 People dataset which represents the list of the user's Microsoft 365 contacts (https://learn.microsoft.com/graph/api/resources/contact?view=graph-rest-1.0&preserve-view=true) along with the user’s version of their contacts' Microsoft 365 profile. This edited or unedited version of another user’s profile will always remain private in the current user’s mailbox and won't be replicated anywhere.
