...
|**Email** <br> (Exchange Online) | - Use the [Exchange migration advisor](https://aka.ms/office365setup) to get customized setup guidance  <br> - [Set up Exchange Online Protection for cloud protection of on-premises email environments](/exchange/standalone-eop/set-up-your-eop-service) |
