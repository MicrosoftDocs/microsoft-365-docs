...
|        |[Require apps that support Intune app protection policies](identity-access-policies.md#require-apps-that-support-intune-app-protection-policies)|Include Teams and dependent services in this policy.|
