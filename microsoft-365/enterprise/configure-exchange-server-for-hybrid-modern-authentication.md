...
> [!NOTE]
> Outlook Web App and Exchange Control Panel does not work with hybrid Modern Authentication.  In addition, publishing Outlook Web App and Exchange Control Panel through Azure AD Application Proxy is unsupported.
