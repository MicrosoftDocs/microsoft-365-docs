...
Users from a registered device will no longer be able to sign in after your migration enters the stage "Finalize Azure AD."<!--Where is this stage described? Is this a formal name that we need to reference? It doesn't seem like it. -->  
