...
5. On the Register an application page, under Supported account types, Select Accounts in any organizational directory (Any Azure AD directory - Multitenant). Then under Redirect URI (optional), select Web and enter <https://office.com>. Last, select Register.
