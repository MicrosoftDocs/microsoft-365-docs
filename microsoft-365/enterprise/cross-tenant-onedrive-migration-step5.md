...
:::image type="content" source="../media/cross-tenant-migration/t2t-onedrive-csv-mapping-users-guests-to-guests.png" alt-text="csv example when mapping a guest to a guest":::
