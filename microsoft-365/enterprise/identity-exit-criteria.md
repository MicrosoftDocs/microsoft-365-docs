...
Also see [Prerequisites](https://docs.microsoft.com/en-us/microsoft-365-enterprise/identity-access-policies#prerequisites) for additional recommendations on identity infrastructure.
