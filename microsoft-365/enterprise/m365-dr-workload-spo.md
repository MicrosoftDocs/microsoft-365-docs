...
If the OneDrive has a legal hold on it, the move would proceed but the Preservation Hold Library would contninue to exist in the site. Once the move completes, update the URLs in any cases and holds be updated with the new URL.
