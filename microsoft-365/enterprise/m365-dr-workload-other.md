...
See [Azure Active Directory Data Locations](https://aka.ms/aaddatamap).
...
See [Static data location information for select workloads](#static-data-location-information-for-select-workloads).

### Power Apps for Microsoft 365

See [Dynamics 365 availability and data locations | Microsoft Learn](/dynamics365/get-started/availability).
...
See [Static data location information for select workloads](#static-data-location-information-for-select-workloads).  The data region for Manager/Leader and Advanced is determined by the _Default Geography_ of the _tenant_, not individual users.
...
See [Data Residency - Yammer | Microsoft Learn](/yammer/manage-security-and-compliance/data-residency).
