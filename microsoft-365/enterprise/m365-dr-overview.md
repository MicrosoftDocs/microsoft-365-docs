...
1. Only available for _Local Region Geography_ and _Expanded Local Region Geography_ (when the future data center is launced) countries/regions. [Learn about supported Microsoft Purview services and solutions](m365-dr-workload-purview.md).
