...
When each external tenant accepts the invitation to join the multi-tenant organization, the following settings are configured in Azure Active Directory:
