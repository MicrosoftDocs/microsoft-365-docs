...
# Phase 1: Windows 10 Enterprise infrastructure exit criteria
...
## Optional: Use Windows Analytics Device Health to monitor your Windows 10 Enterprise-based devices
...
## Required: Use Windows Defender Antivirus or your own antimalware solution
...
## Required: Deploy Windows Defender Exploit Guard
...
## Required: Deploy Windows Defender Advanced Threat Protection (Microsoft 365 Enterprise E5 only)
