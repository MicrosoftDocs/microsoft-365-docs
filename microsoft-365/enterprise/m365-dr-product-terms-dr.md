...
2. Commitments period:  the length of the customers contract with Microsoft.  Typically, 1-3 years.
...
There are no plans to add additional *Geographies* or Online services in the future.  For data residency support for *Expanded Local Geographies* or additional services, refer to the *Multi-Geo* service and/or the *Advanced Data Residency* service.
...
Practically, this means that there are a number of tenants that did not opt in to move and remain in the *Regional Geography* data centers.  On our about Nov 1, 2022 with the introduction of the Advanced Data Residency add-on, all tenants that remain in the *Regional Geography* data centers will have another six month period to opt in for data migration to their *Local Geography*.  See the [Legacy Move Program page](https://review.learn.microsoft.com/en-us/microsoft-365/enterprise/m365-dr-legacy-move-program?view=o365-worldwide&branch=kvice-ADR-new#how-to-request-your-data-move---final-opportunity) for more details.
