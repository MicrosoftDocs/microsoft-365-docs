...
|25|**Azure Active Directory terms of use**<p>If your organization requires users to accept [Azure Active Directory terms of use](/azure/active-directory/conditional-access/terms-of-use), you may need to permit the token provider URL or access to Office 365 will fail.|tokenprovider.termsofuse.identitygovernance.azure.com<br><p>Also see [Quickstart: Require terms of use to be accepted before accessing cloud apps](/azure/active-directory/conditional-access/require-tou).|Inbound server traffic|
|
