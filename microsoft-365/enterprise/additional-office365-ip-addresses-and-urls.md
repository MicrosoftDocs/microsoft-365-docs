...
- BCS160
ms.assetid: 
description: "Summary: The new endpoint Web service does not include a few endpoints for specific scenarios."
hideEdit: true
---

# Other endpoints not included in the Office 365 IP Address and URL Web service

Some network endpoints were previously published and have not been included in the [Office 365 IP Address and URL Web Service](microsoft-365-ip-web-service.md). The web service scope is network endpoints that are required for connectivity from a user of Office 365 across an enterprise perimeter network. This group currently does not include:
