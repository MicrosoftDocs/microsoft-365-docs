...
All test measurements from client machines include the LAN subnet information and that is correlated with the office location details that you have entered. Measurement samples and office locations should start to appear 24 hours after these pre-requisites have been met.
