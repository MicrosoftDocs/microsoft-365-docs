   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
      ...
      mso-color-alt:windowtext;mso-no-proof:yes'><!--[if gte vml 1]><v:shapetype
       ...
       <v:imagedata src="media/desktop-deployment-center-home-media/desktop-deployment-center-home-media-2.png"
        o:title=""/>
      </v:shape><![endif]--><![if !vml]><img src="media/desktop-deployment-center-home-media/desktop-deployment-center-home-media-5.png" border=0 width=25 height=25 alt="Upgrade ConfigMgr" v:shapes="Picture_x0020_1"><![endif]></span></b><b><span
    ...
    <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
      ...
      </v:shape><![endif]--><![if !vml]><img src="media/desktop-deployment-center-home-media/desktop-deployment-center-home-media-3.png" border=0 width=25 height=25 alt="Device and App Readiness"
    ...
    <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:.4in'>
      ...
      </v:shape><![endif]--><![if !vml]><img src="media/desktop-deployment-center-home-media/desktop-deployment-center-home-media-9.png" border=0 width=25 height=25
