...
> [!IMPORTANT]
> The `AlertInfo` and `AlertEvidence` tables replace the `DeviceAlertEvents` table in the Microsoft Defender for Endpoint schema. To learn more, see [Map DeviceAlertEvents Table](/microsoft-365/defender/advanced-hunting-migrate-from-mde?view=o365-worldwide#map-devicealertevents-table).
