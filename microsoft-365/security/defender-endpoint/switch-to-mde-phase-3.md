...
| macOS (see [System requirements](microsoft-defender-endpoint-mac.md) | [Local scripts](mac-install-manually.md) <br/><br/> [Microsoft Endpoint Manager](mac-install-with-intune.md) <br><br/> [JAMF Pro](mac-install-with-jamf.md) <br/><br/> [Mobile Device Management](mac-install-with-other-mdm.md) |
