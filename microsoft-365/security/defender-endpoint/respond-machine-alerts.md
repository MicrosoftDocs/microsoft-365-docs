...
>- When isolating a device, only certain processes and destinations are allowed. Therefore, devices that are behind a full VPN tunnel won't be able to reach the Microsoft Defender for Endpoint Cloud service after the device is isolated. The recommendation is to use split-tunneling VPN for Microsoft Defender for Endpoint and Defender AV cloud-based protection related traffic.
...
- [Report inaccuracy](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/tvm-security-recommendation#report-inaccuracy)
