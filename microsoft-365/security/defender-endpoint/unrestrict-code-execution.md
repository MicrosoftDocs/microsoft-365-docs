...
If you send multiple API calls to to remove app restriction for the same device, it returns "pending machine action" or HTTP 400 with the message "Action is already in progress".
