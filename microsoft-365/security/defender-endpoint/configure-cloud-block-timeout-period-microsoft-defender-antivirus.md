...
4. In the **Configuration settings** section, expand **Cloud protection**. Then, in the **Defender for Cloud Cloud Extended Timeout In Seconds** box, specify the more time, in seconds, from 1 second to 50 seconds. Whatever you specify is added to the default 10 seconds.
