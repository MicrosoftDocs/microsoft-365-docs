...
description: Use Group Policy to deploy configuration package on Windows 10 devices so that they are onboarded to the service.
...
# Onboard Windows 10 devices using the Group Policy 
