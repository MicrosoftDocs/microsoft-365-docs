...
2. Browse to **Computer Configuration** > **Policies** > **Administrative Templates** > **Windows Components** > **Windows Defender SmartScreen** > **Microsoft Edge**.
    ...
    :::image type="content" source="images/config-windows-def-smartscr-edge.png" alt-text="Configure windows defender smart screen Edge" lightbox="images/config-windows-def-smartscr-edge.png":::
