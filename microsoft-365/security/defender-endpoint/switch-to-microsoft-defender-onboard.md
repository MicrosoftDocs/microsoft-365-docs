...
|Windows 7 SP1 <br/>Windows 7 SP1 Pro<br/>Windows 8.1 Pro<br/>Windows 8.1 Enterprise| [Microsoft Monitoring Agent (MMA)](onboard-downlevel.md) <br><br> **NOTE**: Microsoft Monitoring Agent is now Azure Log Analytics agent. To learn more, see [Log Analytics agent overview](/azure/azure-monitor/platform/log-analytics-agent).  
| macOS:<br/>11.3.1 (Big Sur)<br/>10.15 (Catalina)<br/>10.14 (Mojave) | [Local script](mac-install-manually.md)<br/>[Microsoft Endpoint Manager](mac-install-with-intune.md)<br/>[JAMF Pro](mac-install-with-jamf.md)<br/>[Mobile Device Management](mac-install-with-other-mdm.md)   |
| Linux:<br/>RHEL 7.2+<br/>CentOS Linux 7.2+<br/>Ubuntu 16 LTS, or higher LTS<br/>SLES 12+<br/>Debian 9+<br/>Oracle Linux 7.2 |  [Local script](linux-install-manually.md) <br> [Puppet](linux-install-with-puppet.md) <br> [Ansible](linux-install-with-ansible.md)|  
