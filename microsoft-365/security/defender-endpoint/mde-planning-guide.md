...
This article provides an overview of the steps to start your Defender for Endpoint deployment, you'll be guided through the steps on:
...
- **[Learn about deployment rings](use-deployment-rings.md)**: Learn how to deploy Microsoft Defender for Endpoint using rings
- **[Start onboarding to Defender for Endpoint](onboarding.md)**: Onboard devices to the service so that the Microsoft Defender for Endpoint service can get sensor data from them.
