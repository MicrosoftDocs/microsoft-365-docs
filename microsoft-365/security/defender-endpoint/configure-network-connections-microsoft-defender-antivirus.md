...
| Certificate Revocation List (CRL) <p>This list is used by Windows when creating the SSL connection to MAPS for updating the CRL | `https://www.microsoft.com/pkiops/crl/` <p> `https://www.microsoft.com/pkiops/certs` <p>   `https://crl.microsoft.com/pki/crl/products` <p> `https://www.microsoft.com/pki/certs` |
