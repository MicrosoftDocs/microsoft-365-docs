...
![Microsoft-Intune connector](images/enable-intune-connection.png)
- Go to **Microsoft Endpoint Manager (Intune)** and Validate whether ATP-Intune connector is enabled.
![ATP-Intune connector](images/validate-intune-connector.png)
...
- Click ‘Save’.
    ...
    *Example: Outlook as a managed app*
    ![Outlook as managed app](images/managed-app.png)
...
![Conditional launch](images/conditional-launch.png)
...
3.	On clicking Download, user is redirected to app store (Google play).
...
![Complete Defender onboarding steps](images/mde-onboarding-mam.png)
