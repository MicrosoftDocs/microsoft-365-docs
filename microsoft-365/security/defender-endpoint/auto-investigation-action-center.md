...
:::image type="content" source="images/mde-action-center-unified.png" alt-text="An example of the **Action center** page in the Microsoft 365 Defender portal" lightbox="images/mde-action-center-unified.png":::
...
| In the <a href="https://go.microsoft.com/fwlink/p/?linkid=2077139" target="_blank">Microsoft 365 Defender portal</a>, choose **Action center**. <p>:::image type="content" source="images/action-center-nav-new.png" alt-text="An example of a pane of navigation to the Action Center in the Microsoft 365 Defender portal" lightbox="images/action-center-nav-new.png"::: | In the Microsoft 365 Defender portal, choose **Automated investigations** > **Action center**. <p>:::image type="content" source="images/action-center-nav-old.png" alt-text="An example of an older version of a pane of navigation to the Action Center in the Microsoft 365 Defender portal" lightbox="images/action-center-nav-old.png":::  |
...
:::image type="content" source="images/new-action-center-columnsfilters.png" alt-text="An example of the Action center with Columns and filters" lightbox="images/new-action-center-columnsfilters.png":::
