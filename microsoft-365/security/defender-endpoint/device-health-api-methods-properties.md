...
> - Some additional columns might be returned in the response. These columns ar“Canceled“e temporary and might be removed, please use only the documented columns.
