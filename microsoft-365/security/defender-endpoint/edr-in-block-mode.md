...
|Operating system|Devices must be running one of the following versions of Windows: <br/>- Windows 10 (all releases)<br/>- Windows Server, version 1803 or newer<br/>- Windows Server 2019<br/>- Windows Server 2022<br/>- Windows Server 2016|
|Microsoft Defender for Endpoint|Devices must be onboarded to Defender for Endpoint. See [Minimum requirements for Microsoft Defender for Endpoint](minimum-requirements.md).<p>Also see [Onboard devices and configure Microsoft Defender for Endpoint capabilities](onboard-configure.md) and [Onboard Windows servers to the Defender for Endpoint service](configure-server-endpoints.md). |
