...
|Operating system     |One of the following versions: <br/>- Windows 10 (all releases) <br/>- Windows Server, version 1803 or newer <br/>- Windows Server 2019 <br/>- Windows Server 2016 (only when Microsoft Defender Antivirus is in active mode) <br> - Windows Server 2012 R2   |
...
For more information, see [Options to install Microsoft Defender Antivirus](configure-server-endpoints.md#options-to-install-microsoft-defender-antivirus).
