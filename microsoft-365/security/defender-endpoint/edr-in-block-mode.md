...
|Microsoft Defender Antivirus|Devices must have Microsoft Defender Antivirus installed and running in either active mode or passive mode. [Confirm Microsoft Defender Antivirus is in active or passive mode](edr-block-mode-faqs.yml#how-do-i-confirm-microsoft-defender-antivirus-is-in-active-or-passive-mode?).|
...
(<a id="fn1">1</a>) See [Is EDR in block mode supported on Windows Server 2016 and Windows Server 2012 R2?](edr-block-mode-faqs.yml#is-edr-in-block-mode-supported-on-windows-server-2016-and-windows-server-2012-r2)
