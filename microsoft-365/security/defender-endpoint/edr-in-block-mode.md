...
2. Choose **Settings** > **Endpoints** > **Advanced features**.

3. Turn on **Enable EDR in block mode**.

> [!NOTE]
> EDR in block mode can be turned on only in the Microsoft 365 Defender. You cannot use registry keys, Intune, or group policies to enable or disable EDR in block mode.
