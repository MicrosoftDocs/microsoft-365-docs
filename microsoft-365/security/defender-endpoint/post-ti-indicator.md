...
application|String|The application associated with the indicator. This field only works for new indicators. It will not updated the value on an existing indicator. **Optional**
