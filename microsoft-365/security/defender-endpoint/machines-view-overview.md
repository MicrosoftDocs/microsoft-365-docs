...
**Windows version** </br> | Filter by the Windows versions you're interested in investigating. If ‘future version’ appears in the Windows version field, it can mean the build:
-	is a pre-release version for a future Windows release 
-	has no version name
-	version name is not yet supported
