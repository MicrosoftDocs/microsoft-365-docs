...
**Windows version** </br> | Filter by the Windows versions you're interested in investigating. If ‘future version’ appears in the Windows version field, it means the build is a pre-release version of a future Windows release. The full OS version can be seen in the device details page. </br></br> (_Computers and mobile only_)
