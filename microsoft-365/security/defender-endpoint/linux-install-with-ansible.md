...
- SSH must be configured for an administrator account between the control node and all managed nodes (machines that will have Defender installed on them), and it is recommended be configured with public key authentication.
