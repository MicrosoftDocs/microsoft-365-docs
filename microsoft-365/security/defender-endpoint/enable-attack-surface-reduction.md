...
For information about per-rule exclusions, see [Configure ASR rules per-rule exclusions](/microsoft-365/security/defender-endpoint/attack-surface-reduction-rules-deployment-test#configure-asr-rules-per-rule-exclusions).
