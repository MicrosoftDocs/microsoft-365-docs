...
> [!IMPORTANT]
> Currently, warn mode is not supported for three ASR rules. To learn more, see [Cases where warn mode is not supported](attack-surface-reduction.md#cases-where-warn-mode-is-not-supported).
