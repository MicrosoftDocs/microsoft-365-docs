...
|7|Indicators - File/IP address/URL/Certificates allow/block |Your organization's security team can import threat intel, which blocks known Indicators of Compromise (IoC's) [Get an overview of Indicator of compromise (IoC)](/microsoft-365/security/defender-endpoint/manage-indicators).|
...
|11|Controlled Folder Access |Your organization's security team can reduce malware from encrypting end-users data by preventing unknown applications or services being able to write to protected folders. [Get an overview of the Controlled Folder Access](/microsoft-365/security/defender-endpoint/enable-controlled-folders).|
