...
1. On the **Add app** page, click on **Search the App Store** and type **Microsoft Defender for Cloud for Endpoint** in the search bar. In the search results section, click on *Microsoft Defender for Cloud for Endpoint* and click **Select**.
...
1. In the *Create app configuration policy* page, provide the following information:
    ...
    - Targeted app: Select **Microsoft Defender for Cloud for Endpoint** from the list
