...
<li>The default value for <b>EnableDynamicSignatureDroppedEventReporting</b> is <b>false</b>, which means <i>2011 events are not reported<i>. If it's set to true, 2011 events are reported.</li>
</ul>
</dt>
