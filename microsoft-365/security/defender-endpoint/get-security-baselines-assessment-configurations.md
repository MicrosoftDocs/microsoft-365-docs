...
|recommendedValue|Array [String]|Array of the recommended value for each source returned in the ‘source’ property array (value order corresponds with the source property array)
