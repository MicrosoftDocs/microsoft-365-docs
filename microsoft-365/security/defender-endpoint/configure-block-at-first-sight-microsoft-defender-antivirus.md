...
- Block at first sight can block non-portable executable files (such as JS, VBS, or macros) and executable files, running the latest Defender antimalware platform for Windows workstation or server.
