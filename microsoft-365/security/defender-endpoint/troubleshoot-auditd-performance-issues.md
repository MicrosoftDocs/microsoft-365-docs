...
When you use [XMDEClientAnalyzer](/microsoft-365/security/defender-endpoint/defender-endpoint/run-analyzer-macos-linux), the following files will display output that provide insights to help you troubleshoot issues.
- auditd_info.txt
