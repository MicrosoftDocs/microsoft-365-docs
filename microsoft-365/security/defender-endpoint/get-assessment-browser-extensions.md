...
IsActivated|Boolean|Indicates whether a browser extension is active or not.
...
Permissions|string|The set of permissions requested by a specific browser extension.
