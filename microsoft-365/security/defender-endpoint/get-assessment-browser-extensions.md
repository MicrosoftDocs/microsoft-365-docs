...
ExtensionDescription|string| Description of a specific extension.
ExtensionId|string|Unique identifier for a specific extension.
ExtensionName|string|Name of a specific extension.
ExtensionRisk|string|The highest risk level generated by the extension. Possible values are: "None", "Low", "Medium", "High", "Critical"
ExtensionVersion|string|Version number of a specific extension.
IsActivated|Boolean|Indicates whether an extension is active or not.
