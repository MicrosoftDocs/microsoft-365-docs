...
- There are multiple fixes and new changes in this release 
	...
	- Plugin directories path will be verified and created if it is not present in the system.
	- In presence of other conflicting application, mdatp health will show false only when mdatp is using blocking fanotify mask. The health will remain true if no blocking fanotify masks are used by mdatp.
