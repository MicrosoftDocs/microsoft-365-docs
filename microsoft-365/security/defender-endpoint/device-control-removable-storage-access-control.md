...
|Policy Creation|Allows you to create policy to enforce each removable media group|Steps 2 in the section, [Deploying policy via OMA-URI](#deploying-policy-via-oma-uri) | Step 2 and 3 in the section, [Deploying policy via Group Policy](#deploying-policy-via-group-policy) |
...
|Capture file information|Allows you to create policy to capture file information when Write access happens| Step 2 and 5 in the section, [Deploying policy via OMA-URI](#deploying-policy-via-oma-uri) | Step 2 and 6 in the section, [Deploying policy via Group Policy](#deploying-policy-via-group-policy) |
