...
|---|---|---|---|
|Removable Media Group Creation|Allows you to create reusable removable media group|Step 1 and step 3 of ‘Deploying policy via OMA-URI’ section below, <https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/device-control-removable-storage-access-control?view=o365-worldwide#deploying-policy-via-oma-uri>|Step 1 of ‘Deploying policy via Group Policy’ section below, <https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/device-control-removable-storage-access-control?view=o365-worldwide#deploying-policy-via-group-policy>|
|Policy Creation|Allows you to create policy to enforce each removable media group|Step 2 and step 3 of ‘Deploying policy via OMA-URI’ section below, <https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/device-control-removable-storage-access-control?view=o365-worldwide#deploying-policy-via-oma-uri>|Step 2 of ‘Deploying policy via Group Policy’ section below, <https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/device-control-removable-storage-access-control?view=o365-worldwide#deploying-policy-via-group-policy>|
|Default Enforcement|Allows you to set default access (Deny or Allow) to removable media if there is no policy|Step 4 of ‘Deploying policy via OMA-URI’ section below, <https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/device-control-removable-storage-access-control?view=o365-worldwide#deploying-policy-via-oma-uri>|Step 3 of ‘Deploying policy via Group Policy’ section below, <https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/device-control-removable-storage-access-control?view=o365-worldwide#deploying-policy-via-group-policy>|
|Enable or Disable Removable Storage Access Control|If you set Disable, it will disable the Removable Storage Access Control policy on this machine|Step 5 of ‘Deploying policy via OMA-URI’ section below, <https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/device-control-removable-storage-access-control?view=o365-worldwide#deploying-policy-via-oma-uri>|Step 4 of ‘Deploying policy via Group Policy’ section below, <https://docs.microsoft.com/en-us/microsoft-365/security/defender-endpoint/device-control-removable-storage-access-control?view=o365-worldwide#deploying-policy-via-group-policy>|
