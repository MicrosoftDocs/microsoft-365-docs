...
You can also schedule scans with Microsoft Intune. The [runMDATPQuickScan.sh]([https://github.com/microsoft/shell-intune-samples/tree/master/macOS/Config/MDATP](https://github.com/microsoft/shell-intune-samples/blob/master/macOS/Config/MDATP/runMDATPQuickScan.sh)) shell script available at [Scripts for Microsoft Defender for Endpoint]([https://github.com/microsoft/shell-intune-samples/tree/master/Misc/MDATP](https://github.com/microsoft/shell-intune-samples/tree/master/macOS/Config/MDATP)) will persist when the device resumes from sleep mode. 
