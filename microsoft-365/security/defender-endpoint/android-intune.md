...
**Android Apps** \> **Add \> Android store app** and choose **Select**.
   ...
   :::image type="content" source="images/mda-addandroidstoreapp.png" alt-text="An example of the page displaying Microsoft Endpoint Manager Admin Center add android store application."  lightbox="images/mda-addandroidstoreapp.png":::
...
2. On the **Add app** page and in the *App Information* section enter:
   ...
   :::image type="content" source="images/mda-addappinfo.png" alt-text=" The **Add App** page displaying of Microsoft Endpoint Manager Admin Center add app info" lightbox="images/mda-addappinfo.png":::
...
3. In the *Assignments* section, go to the **Required** section and select **Add group.** You can then choose the user group(s) that you would like to target Defender for Endpoint on Android app. Choose **Select** and then **Next**.
    ...
    >
    > :::image type="content" source="images/363bf30f7d69a94db578e8af0ddd044b.png" alt-text="An example of the Microsoft Endpoint Manager Admin Center selected user groups" lightbox="images/363bf30f7d69a94db578e8af0ddd044b.png":::
...
4. In the **Review+Create** section, verify that all the information entered is correct and then select **Create**.
    ...
    :::image type="content" source="images/86cbe56f88bb6e93e9c63303397fc24f.png" alt-text="The pane for Microsoft Endpoint Manager Admin Center notification of Defender for Endpoint app" lightbox="images/86cbe56f88bb6e93e9c63303397fc24f.png":::
...
5. In the app information page that is displayed, in the **Monitor** section, select **Device install status** to verify that the device installation has completed successfully.
    ...
    :::image type="content" source="images/513cf5d59eaaef5d2b5bc122715b5844.png" alt-text=" An example of Microsoft Endpoint Manager Admin Center device install" lightbox="images/513cf5d59eaaef5d2b5bc122715b5844.png":::
...
3. Upon successful onboarding, the device will start showing up on the Devices list in Microsoft Defender Security Center.
    ...
    :::image type="content" source="images/9fe378a1dce0f143005c3aa53d8c4f51.png" alt-text="An example of a device in Defender for Endpoint portal"  lightbox="images/9fe378a1dce0f143005c3aa53d8c4f51.png":::
...
1. In [Microsoft Endpoint Manager admin center](https://go.microsoft.com/fwlink/?linkid=2109431) , go to **Apps** \> **Android Apps** \> **Add** and select **Managed Google Play app**.
    ...
    :::image type="content" source="images/579ff59f31f599414cedf63051628b2e.png" alt-text="The application-adding pane of Microsoft Endpoint Manager admin center" lightbox="images/579ff59f31f599414cedf63051628b2e.png":::
...
3. In the App description page that comes up next, you should be able to see app details on Defender for Endpoint. Review the information on the page and then select **Approve**.
    ...
    > :::image type="content" source="images/07e6d4119f265037e3b80a20a73b856f.png" alt-text="An example of a Managed Google Play" lightbox="images/07e6d4119f265037e3b80a20a73b856f.png":::
...
4. You'll be presented with the permissions that Defender for Endpoint obtains for it to work. Review them and then select **Approve**.
    ...
    :::image type="content" source="images/206b3d954f06cc58b3466fb7a0bd9f74.png" alt-text="An example of Defender for Endpoint preview app approval" lightbox="images/206b3d954f06cc58b3466fb7a0bd9f74.png":::
...
5. You'll be presented with the Approval settings page. The page confirms your preference to handle new app permissions that Defender for Endpoint on Android might ask. Review the choices and select your preferred option. Select **Done**.
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="images/ffecfdda1c4df14148f1526c22cc0236.png" alt-text=" The **Notifications** page" lightbox="images/ffecfdda1c4df14148f1526c22cc0236.png":::

6. After the permissions handling selection is made, select **Sync** to sync Microsoft Defender for Endpoint to your apps list.

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="images/34e6b9a0dae125d085c84593140180ed.png" alt-text=" The **Sync** option page" lightbox="images/34e6b9a0dae125d085c84593140180ed.png":::

7. The sync will complete in a few minutes.

    :::image type="content" source="images/9fc07ffc150171f169dc6e57fe6f1c74.png" alt-text=" The application sync status pane on the **Android apps** page"  lightbox="images/9fc07ffc150171f169dc6e57fe6f1c74.png":::
...
8. Select the **Refresh** button in the Android apps screen and Microsoft Defender for Endpoint should be visible in the apps list.
    ...
    :::image type="content" source="images/fa4ac18a6333335db3775630b8e6b353.png" alt-text="The applications list pane" lightbox="images/fa4ac18a6333335db3775630b8e6b353.png":::
...
9. Defender for Endpoint supports App configuration policies for managed devices via Intune. This capability can be leveraged to autogrant applicable Android permission(s), so the end user does not need to accept these permission(s).
    ...
    1. In the **Apps** page, go to **Policy > App configuration policies > Add > Managed devices**.
       ...
       :::image type="content" source="images/android-mem.png" alt-text="The **App configuration policies** pane" lightbox="images/android-mem.png":::
...
4. **Assignment**
   ...
   :::image type="content" source="images/4autosetupofvpn.png" alt-text="An example of devices configuration profile Assignment" lightbox="images/4autosetupofvpn.png":::
...
The device configuration profile is now assigned to the selected user group.
   ...
   :::image type="content" source="images/5autosetupofvpn.png" alt-text="An example of devices configuration profile **Review + create** provision" lightbox="images/5autosetupofvpn.png":::
...
3. When the app is installed, open the app and accept the permissions and then your onboarding should be successful.
    ...
    :::image type="content" source="images/MDE_new.png" alt-text="An example of the Microsoft Defender for Endpoint application display on a mobile device" lightbox="images/MDE_new.png":::
...
4. At this stage the device is successfully onboarded onto Defender for Endpoint on Android. You can verify this on the [Microsoft Defender Security Center](https://securitycenter.microsoft.com) by navigating to the **Devices** page.
    ...
    :::image type="content" source="images/9fe378a1dce0f143005c3aa53d8c4f51.png" alt-text="An example of Microsoft Defender for Endpoint portal" lightbox="images/9fe378a1dce0f143005c3aa53d8c4f51.png":::
