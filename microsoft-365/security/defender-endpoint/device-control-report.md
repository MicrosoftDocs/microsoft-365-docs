...
In the **Reports** dashboard, the **Device protection** card shows the number of audit events generated by media type, over the last 180 days; the raw events under the **View details** show events over the last 30 days.
