...
> [!NOTE]
> Automated investigation and response requires Microsoft Defender Antivirus to be running in either passive mode or active mode. If Microsoft Defender Antivirus is disabled or uninstalled, Automated Investigation and response will not function correctly.
