...
## Use Microsoft Confniguration Manager to configure scanning options

For details on configuring Microsoft Confniguration Manager (current branch), see [How to create and deploy antimalware policies: Scan settings](/configmgr/protect/deploy-use/endpoint-antimalware-policies#scan-settings).
