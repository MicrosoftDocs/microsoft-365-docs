---
title: Submit suspected spam, phish, URLs, and files in Microsoft Defender for Endpoint
...
# Submit suspected spam, phish, URLs, and files in Microsoft Defender for Endpoint
...
In Microsoft Defender for Endpoint, admins can use the Submissions feature in the Microsoft 365 Defender to submit email messages, URLs, and attachments to Microsoft for scanning.

For other ways to submit email messages, URLs, and attachments to Microsoft, see [Report messages and files to Microsoft](add link when available).
