...
- **Verify that you're running a supported version of Windows**.
  ...
  - **macOS** - Only applicable for Public Preview, minimun required version: 101.43.84 
  - 
  - **Linux** - Only applicable for Public Preview, minimun required version: 101.45.13 
