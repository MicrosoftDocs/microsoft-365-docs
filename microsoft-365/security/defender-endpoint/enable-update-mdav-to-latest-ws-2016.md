...
First, ensure that Defender Antivirus is not disabled either through Group Policy or registry. Reference [Troubleshoot Microsoft Defender Antivirus while migrating from a third-party solution].(/microsoft-365/security/defender-endpoint/troubleshoot-microsoft-defender-antivirus-when-migrating)

On Windows Server 2016, in some cases, you may need to use the [Malware Protection Command-Line Utility](command-line-arguments-microsoft-defender-antivirus.md) to re-enable Defender Antivirus.
