...
|EDR|macOS:<br/> The three most recent major releases of macOS are supported.|[Defender for Endpoint on macOS: Network connections](microsoft-defender-endpoint-mac.md#network-connections)|
...
|Antivirus|macOS:<br/> The three most recent major releases of macOS are supported.|[Defender for Endpoint on macOS: Network connections](microsoft-defender-endpoint-mac.md#network-connections)|
|Antivirus|Linux:<br/> (see [System requirements](microsoft-defender-endpoint-linux.md#system-requirements))|[Defender for Endpoint on Linux: Network connections](microsoft-defender-endpoint-linux.md#network-connections)|
