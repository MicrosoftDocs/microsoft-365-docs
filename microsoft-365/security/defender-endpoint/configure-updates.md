...
For more information on the parameters and how to configure them, see [Set-MpPreference (Defender for Cloud)|Microsoft Docs](/powershell/module/defender/set-mppreference).
