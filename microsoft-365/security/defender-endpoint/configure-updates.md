...
For more information on the Defender CSPs used for the gradual rollout process, see https://docs.microsoft.com/en-us/windows/client-management/mdm/defender-csp
