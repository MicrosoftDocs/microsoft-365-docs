...
> [!IMPORTANT]
> To be eligible to acquire Microsoft Defender for Endpoint Server licenses (one per covered server instance), you already must have purchased a combined minimum of 50 licenses for one or more of the following: Microsoft Defender for Endpoint (per user), Windows E5/A5, Microsoft 365 E5/A5 and Microsoft 365 E5 Security User subscription licenses.
