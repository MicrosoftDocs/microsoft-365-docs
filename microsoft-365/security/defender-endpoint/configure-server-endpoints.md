...
- Please ensure connectivity requirements as specified in [Enable access to Microsoft Defender for Endpoint service URLs in the proxy server](/microsoft-365/security/defender-endpoint/configure-proxy-internet?enable-access-to-microsoft-defender-for-endpoint-service-urls-in-the-proxy-server) are met. They are equivalent to those for Windows Server 2019. **NOTE: For the public preview, if you are using a proxy solution, please ensure this proxy can be used system-wide**.
- Windows Update [KB5005292](https://go.microsoft.com/fwlink/?linkid=2168277) is a new update package for this solution and is required to ensure fixes and improvements arrive as appropriate.
