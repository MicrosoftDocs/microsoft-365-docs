...
| Phase | What happens |
|:---|:---|
| Built-in protection is rolling out (beginning in October 2022). | Customers who have opted to receive preview features have already received [notification](#what-does-the-notification-look-like) that built-in protection is coming, and now all enterprise customers are receiving notification. Tamper protection will be turned on for customers who have Defender for Endpoint Plan 2 or Microsoft 365 E5, if tamper protection isn't already configured. |
