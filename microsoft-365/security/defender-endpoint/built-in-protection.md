...
| [Turn tamper protection on or off  manually on a device]().| 1. On your **Mac Device**, open  **Finder**, and go to Applications> Utilities > Terminal.<br/>2. Once Terminal is open, type the following command `sudo mdatp config tamper-protection enforcement-level --value (chosen mode)`.<br/><br/>See [Manage tamper protection manually on an device](https://learn.microsoft.com/microsoft-365/security/defender-endpoint/tamperprotection-macos?view=o365-worldwide#manual-configuration). |
| [Turn tamper protection on or off  using **Mobile Device Management (MDM) solution.**]() | To change Tamper Protection mode using an MDM, go to the configuration profile and change the **enforcement level** in  [Intune](https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/tamperprotection-macos?view=o365-worldwide#intune) or [JAMF](https://learn.microsoft.com/en-us/microsoft-365/security/defender-endpoint/tamperprotection-macos?view=o365-worldwide#jamf).<br/><br/>**Configuration profile** set with the MDM will be the first point of reference. Any settings defined in the profile will be enforced on the device, **Built-in-Protection** default settings will not override these applied settings.  |
