...
- You must be on a non-Production update channel ([either Preview or Beta](https://docs.microsoft.com/en-us/deployoffice/office-insider/deploy/microsoft-autoupdate)), while the Tamper Protection feature is in preview. If you are on Production channel, configured tamper protection mode will ignored.
