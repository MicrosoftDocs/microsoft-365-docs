...
### Example - software vulnerabilities assessment by device

#### Request example - software vulnerabilities assessment by device

```http
GET https://api-us.securitycenter.contoso.com/api/machines/SoftwareVulnerabilitiesByMachine?pageSize=5
```

#### Response example - software vulnerabilities assessment by device
...
### Properties - software vulnerabilities assessment to Json
