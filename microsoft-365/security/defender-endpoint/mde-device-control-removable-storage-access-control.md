...
1. Options: The Group Id/GUID has to be used here, for example:
...
When there are conflict types (for example, one **Allow** and other **Deny**) for same media, the system will apply the first one in the policy.
