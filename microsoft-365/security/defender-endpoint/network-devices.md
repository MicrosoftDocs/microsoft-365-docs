...
As the authenticated scanner currently uses an algorithm that is yet not approved,  the scanner cannot operate when organizations enforce usage of only approved algorithms.
