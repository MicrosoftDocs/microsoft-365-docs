...
This topic describes how to deploy Microsoft Defender for Endpoint on macOS through Microsoft Endpoint Manager. A successful deployment requires the completion of all of the following steps:
