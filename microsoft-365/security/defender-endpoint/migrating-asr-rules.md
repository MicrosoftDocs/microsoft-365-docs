...
## Common questions and scenarios when migrating from a third-party HIPS product to ASR rules
...
- **Other recommended features**- We recommend enabling PowerShell constrained language mode, in order to minimize the attack surface from PowerShell.
...
- **Attack Surface Reduction rules**- ASR rules don't support these scenarios because they're part of Microsoft Defender Antivirus protection
...
- **Attack Surface Reduction rules**- ASR rules don't cover these kinds of scenarios because they are part of the Microsoft Defender for Endpoint built-in protection.
