...
| Disable Microsoft Defender Antivirus on Windows Server 2016 using PowerShell | Use the following PowerShell cmdlet: `Set-MpPreference -DisableRealtimeMonitoring $true` |
