...
## Why is there a discrepancy between listed devices?
...
## Can I onboard unmanaged devices that were found?
 Yes, Devices that have been discovered but have not yet been onboarded and secured by Microsoft Defender for Endpoint will be listed in Device Inventory within the Endpoints tab.
