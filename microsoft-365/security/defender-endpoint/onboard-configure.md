...
[Onboard Windows 10 and Windows 11 devices](configure-endpoints.md)|You'll need to onboard devices for it to report to the Defender for Endpoint service. Learn about the tools and methods you can use to configure devices in your enterprise.
