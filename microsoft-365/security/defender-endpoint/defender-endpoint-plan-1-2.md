...
> [!IMPORTANT]
> The standalone versions of Defender for Endpoint Plan 1 and Plan 2 do not support onboarding server endpoints. To onboard servers, such as Windows Server or Linux, you'll need Defender for Servers Plan 1 or Plan 2. To learn more. see [Overview of Microsoft Defender for Servers](/azure/defender-for-cloud/defender-for-servers-introduction).
