...
> :::image type="content" source="images/asr-rules-deployment-phases.png" alt-text="An example of ASR rules deployment phases" lightbox="images/asr-rules-deployment-phases.png":::
