---
title: Microsoft Defender for Endpoint on Linux and SAP Support
---

**Request title**: Microsoft Defender Endpoint for SAP Applications on Windows Server
...
Customer Intent for this Article: Understand how Microsoft Defender for Endpoint with EDR and other advanced security capabilities interacts with SAP applications.
Article:
\`\`\`html
