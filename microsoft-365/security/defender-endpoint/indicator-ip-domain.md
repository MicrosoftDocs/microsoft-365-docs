...
- Ensure that **Custom network indicators** is enabled in **Microsoft 365 Defender portal > Settings > General > Advanced features**. For more information, see [Advanced features](advanced-features.md).
