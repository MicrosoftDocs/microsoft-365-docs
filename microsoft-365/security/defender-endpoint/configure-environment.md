...
|--|--|
| Microsoft Defender for Endpoint consolidated URL list (NEW - Streamlined) <br> | **IMPORTANT:** Currently in public preview. <br> Spreadsheet of consolidated URLs for streamlining device connectivity. <br><br>[Download the spreadsheet here.](https://go.microsoft.com/fwlink/?linkid=2248278)<br><br> **Applicable OS:** <br/>For complete list, see [Streamlined connectivity process](configure-device-connectivity.md#prerequisites). <br> <br>- Windows 10 1809+<br>- Windows 11<br>- Windows Server 2019<br>- Windows Server 2022<br>- Windows Server 2012 R2, Windows Server 2016 R2  running [Defender for Endpoint modern unified solution](configure-server-endpoints.md) (requires installation through MSI). <br>- macOS supported versions<br/>- Linux supported versions<br><br> **Minimum component versions:**<br/>- Microsoft Defender Antimalware client: 4.18.2211.5<br/>- Microsoft Defender Engine: 1.1.19900.2<br/>- Microsoft Antivirus security intelligence): 1.391.315.0<br/> <br/>- Minimum Sensor/ KB version: >10.8040.*/ March 8, 2022+<br>- MDE Agent version (macOS/Linux): 101.23052.0009 +.<br><br> If you are moving previously onboarded devices to the streamlined approach, see [Migrating device connectivity](migrate-devices-streamlined.md).
...
> [!NOTE] Applies to public preview for streamlined connectivity <br/>
> 1. Windows 10 version 1607, 1703, 1709, 1803 (RS1-RS4) are supported on the streamlined onboarding package but require a longer URL list. See, [streamlined URL sheet](https://go.microsoft.com/fwlink/?linkid=2248278). These versions do not support reonboarding (must be fully offboarded first). 
> 2. Devices running on Windows 7, Windows 8.1, Windows Server 2008 R2 MMA, Windows Server 2012 R2, 2016 R2 not upgraded to unified agent will need to continue using MMA onboarding method. 
