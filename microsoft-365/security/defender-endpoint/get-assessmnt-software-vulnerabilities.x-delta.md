...
Test to go into Methods and properties at (+/-) line 128
...
**Text to go into Methods-Properties and Software Vulnerabilities**

Software vulnerabilities, directly above "See also" section at Line (+/-) 353.

## 3. Export software vulnerabilities delta assessment by device

### 3.1 API method description

Vulnerability Assessment:

As mentioned below, the “Full export software vulnerabilities assessment by device API response is per device and contains vulnerable software installed on your exposed devices as well as any known vulnerabilities in these software products. This table also includes operating system information, CVE IDs, and vulnerability severity information.
