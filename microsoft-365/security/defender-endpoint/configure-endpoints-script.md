...
3. Open an elevated command-line prompt on the device and run the script:
   ...
   2. Right-click **Command prompt** and select **Run as administrator**.
      ...
      :::image type="content" source="images/run-as-admin.png" alt-text="The Window Start menu pointing to the Run as administrator option" lightbox="images/run-as-admin.png":::
