...
| **More resources** | Displays a list of more portals and centers, such as Azure Active Directory and the Microsoft Purview portal. <br/><br/> To learn more, see [Microsoft security portals and admin centers](../defender/portals.md). |
