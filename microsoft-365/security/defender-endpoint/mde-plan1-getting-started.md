...
| **Settings** | Navigates to general settings for your Microsoft 365 Defender portal (listed as **Defender for Cloud**) and Defender for Endpoint (listed as **Endpoints**). <br/><br/> To learn more, see [Settings](../defender/microsoft-365-defender.md#the-microsoft-365-defender-portal). |
