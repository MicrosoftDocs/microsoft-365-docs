---
title: Getting started with Microsoft Defender for Endpoint Plan 1
...
After Defender for Endpoint is set up and configured, and your organization’s devices are onboarded, your next step is to visit the Microsoft 365 security center (https://security.microsoft.com). There, you can view information about detected threats, manage your alerts and incidents, take any needed action on detected threats, and manage devices.
...
When you sign into the Microsoft 365 security center (https://security.microsoft.com), you’ll start with the Home page, as shown in figure 4. 
 
Figure 4. The Microsoft 365 security center
NOTE: Our example might differ from your Microsoft 365 security center. What you see in your Microsoft 365 security center depends on your licenses and permissions. In addition, your security team can customize your page by adding, removing, and rearranging cards.
...
To learn more, see the Microsoft 365 security center overview.
Table 4 describes the navigation bar.

Table 4. Navigation bar items and what they do.
Navigation bar item	Description
Home	Navigates to the Home page of the Microsoft 365 security center. 
...
Settings
Navigates to general settings for your Microsoft 365 security center and Defender for Endpoint. To learn more, 
see Settings.
...
When you sign into the Microsoft 365 security center, make sure to view and manage your incidents and alerts. Start with your Incidents list. Figure 5 shows a list of incidents, including one with high severity, and another with medium severity. 
...
In Defender for Endpoint Plan 1, several reports are available in the Microsoft 365 security center. To access your reports, in the Microsoft 365 security center, choose Reports. Then select a report in the list. For more information, see Threat protection reports. 
...
Threat protection report
To access your Threat protection report, in the Microsoft 365 security center, choose Reports, and then choose Threat protection. The Threat Protection report shows alert trends, status, categories, and more. Views are arranged in two columns: Alert trends and Alert status, as shown in figure 9.
...
Web protection report
To access your Device health report, in the Microsoft 365 security center, choose Reports, and then choose Web protection. The Web protection report shows detections over time, such as malicious URLs and attempts to access blocked URLs, as shown in Figure 11. 
