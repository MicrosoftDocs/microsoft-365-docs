...
devices running Android 6.0 and higher. Devices that are registered with customer's tenant (enrolled or unenrolled) are supported. Both Android Enterprise (Work Profile)
...
running iOS 11.0 and higher. Devices that are registered with customer's tenant (enrolled or unenrolled) are supported. 
