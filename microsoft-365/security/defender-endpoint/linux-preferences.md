...
> [!NOTE]
> No restart of mdatp deamon is required for changes to most configs in mdatp_managed.json to take effect.
  **Exception:** Following configs will require deamon restart to take effect:
> - cloud-diagnostic
