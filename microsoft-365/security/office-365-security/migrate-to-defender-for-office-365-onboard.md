...
- Review user submissions, especially [user-reported phishing messages](automated-investigation-response-office.md#example-a-user-reported-phish-message-launches-an-investigation-playbook).
