...
- Specifically for third-party phishing simulations:
  ...
  - [Safe Links in Defender for Office 365](safe-links.md) doesn't block or detonate the specifically identified URLs in these messages at time of click. Note: URLs will still be wrapped but will not be blocked.
