...
Deleting a quarantined message might cause confusion if the message was sent to multiple recipients, and those other recipients are looking for the message in quarantine. Admins can search the audit log to find events for messages that were deleted from quarantine by using the following procedure:
...
3. When you're finished entering the search criteria, select **Search** generate the search.
