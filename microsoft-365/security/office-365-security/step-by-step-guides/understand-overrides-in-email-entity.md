...
|Tenant Allow/Block List file|An entry was matched for a file hash listed in the Tenant allow/block list.|Review the entries within the "Tenant Allow/Block Lists" page within the security portal. [Learn more](../tenant-allow-block-list-about.md).|
|Tenant Allow/Block List sender email address|An entry was matched for a sender address listed in the Tenant allow/block list.|Review the entries within the "Tenant Allow/Block Lists" page within the security portal. [Learn more](../tenant-allow-block-list-about.md).|
|Tenant Allow/Block List spoof|An entry was matched for spoof detection in the Tenant allow/block list.|Review the entries within the "Tenant Allow/Block Lists" page within the security portal. [Learn more](../tenant-allow-block-list-about.md).|
|Tenant Allow/Block List URL| An entry was matched for a URL listed in the Tenant allow/block list.|Review the entries within the "Tenant Allow/Block Lists" page within the security portal. [Learn more](../tenant-allow-block-list-about.md).|
