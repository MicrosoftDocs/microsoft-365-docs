...
1. Add your specific DMARC value. For more information, see [Form the DMARC TXT record for your domain](/microsoft-365/security/office-365-security/email-authentication-dmarc-configure#step-4-form-the-dmarc-txt-record-for-your-domain).
1. Press **Save**.
