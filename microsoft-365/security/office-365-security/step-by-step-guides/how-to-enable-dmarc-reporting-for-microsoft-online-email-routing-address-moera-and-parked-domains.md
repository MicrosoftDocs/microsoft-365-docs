...
1. Check if SPF is already configured for your parked domain, following this guide: [Set up SPF to help prevent spoofing - Office 365 | Microsoft Docs](set-up-spf-in-office-365-to-help-prevent-spoofing.md#how-to-handle-subdomains)
...
[Set up SPF to help prevent spoofing - Office 365 | Microsoft Docs](set-up-spf-in-office-365-to-help-prevent-spoofing.md)
[Use DMARC to validate email, setup steps - Office 365 | Microsoft Docs](use-dmarc-to-validate-email.md)
