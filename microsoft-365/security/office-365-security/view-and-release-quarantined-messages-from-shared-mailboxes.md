...
- for users where thier primary SMTP address string is different from thier UserPrincipalName(UPN) string, access to quarantine shared mailbox should be supported as of July 2022  
