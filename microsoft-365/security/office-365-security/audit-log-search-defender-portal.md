...
- [Microsoft Defender XDR Unified role based access control (RBAC)](/microsoft-365/security/defender/manage-rbac): **Security operations \ Security data \ Security data basics (read)**.
