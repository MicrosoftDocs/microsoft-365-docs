...
- **URL click protection action**: Shows the number of URL clicks by users in the organization and the results of the click:
  ...
  - **Blocked** (the user was blockedfrom navigating to the URL)
  ...
  - **Start date** and **End date**
  - The available click protection actions, plus the value **Allowed**(The user was allowed to navigate to the URL) to see information for all URL clicks (not just blocked clicks).
