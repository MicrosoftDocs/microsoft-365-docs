...
:::image type="content" source="../../media/tp_EOPATPEmailAuth.gif" alt-text="EOP and ATP and their specific strengths, going from Protect and Detect to Investigate and Respond, respectively. Also, Email Authentication configuration is shown as needed as of EOP up.":::
