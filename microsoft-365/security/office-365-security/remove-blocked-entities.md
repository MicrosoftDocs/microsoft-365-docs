---
title: Remove blocked entities from the Restricted entities portal in Microsoft 365
f1.keywords:
  - NOCSH
ms.author: dansimp
author: dansimp
...
ms.custom:
description: Learn how to remove blocked entities in Microsoft 365 Defender.
ms.technology: mdo
ms.prod: m365-security
---

# Remove blocked entities from the Restricted entities portal
...
This article provides instruction on handling restricted entities under the [Restricted entities portal](https://security.microsoft.com/restrictedentities).
