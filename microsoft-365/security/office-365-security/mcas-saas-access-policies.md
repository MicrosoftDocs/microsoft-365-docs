...
Microsoft Defender for Cloud Apps also integrates natively with Microsoft Information Protection, providing real-time content inspection to find sensitive data based on sensitive information types and sensitivity labels and to take appropriate action.
...
![Policies for managing SaaS apps in Defender for Cloud Apps.](../../media/microsoft-365-policies-configurations/mcas-manage-saas-apps-2.png)
...
![Example Defender for Cloud Apps policies for data loss prevention.](../../media/microsoft-365-policies-configurations/mcas-dlp.png)
