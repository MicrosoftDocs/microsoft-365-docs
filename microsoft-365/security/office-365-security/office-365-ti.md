---
title: Threat investigation & response capabilities - Microsoft Defender for Office 365
f1.keywords:
- NOCSH
ms.author: tracyp
author: msfttracyp
...
ms.custom:
- seo-marvel-apr2020
description: "Learn about threat investigation and response capabilities in Microsoft Defender for Office 365."
---
...
- Employing [automated investigation and response in Microsoft Defender for Office 365](automated-investigation-response-office.md) for critical email-based threats
...
As part of the Microsoft Defender for Office 365 offering, security analysts can review details about a known threat. This is useful to determine whether there are additional preventative measures/steps that can be taken to keep users safe.
...
Threat investigation and response capabilities are included in Microsoft Defender for Office 365, which is included in Enterprise E5 or as an add-on to certain subscriptions. To learn more, see [Office 365 ATP Plan 1 and Plan 2](office-365-atp.md#office-365-atp-plan-1-and-plan-2).
