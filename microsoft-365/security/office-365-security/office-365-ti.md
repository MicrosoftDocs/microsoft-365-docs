...
|:-----|:-----|
|Use the Threat dashboard (or the new [Security dashboard](security-dashboard.md))<br/> <br/>View information about recent or current threats  <br/> |One of the following: <br/>- **Office 365 Global Administrator**  <br/> - **Security Administrator** <br/>- **Security Reader** <br/>These roles can be assigned in either Azure Active Directory ([https://portal.azure.com](https://portal.azure.com)) or the Microsoft 365 admin center ([https://admin.microsoft.com](https://admin.microsoft.com)). |
