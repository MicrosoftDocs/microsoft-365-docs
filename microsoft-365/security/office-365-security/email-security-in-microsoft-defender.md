...
1. In the Microsoft 365 security center (<https://security.microsoft.com>), choose **Email & collaboration** \> **Explorer** (or **Real-time detections**). (This example uses Explorer.) 
