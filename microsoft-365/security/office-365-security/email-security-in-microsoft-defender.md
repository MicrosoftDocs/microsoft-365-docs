...
1. In the Microsoft 365 Defender (<https://security.microsoft.com>), choose **Email & collaboration** \> **Explorer** (or **Real-time detections**). (This example uses Explorer.) 
If you're in the converged Microsoft 365 Defender (https://security.microsoft.com/) scroll to **Email & collaboration** > **Explorer**.
