...
|**Records Management**|Members can configure all aspects of records management, including retention labels and disposition reviews.|RecordManagement <p> Retention Management <p> Disposition Management|
...
|**Disposition Management**|View and take action on content that's reached the end of its retention period. <p> | Compliance Data Administrator|
...
|**View-Only Record Management**|View the configuration of the records management feature.|Compliance Administrator <p> Compliance Data Administrator <p> Organization Management|
|**View-Only Retention Management**|View the configuration of retention policies, retention labels, and retention label policies.|Compliance Data Administrator <p> Organization Management <p> Compliance Administrator|
|
