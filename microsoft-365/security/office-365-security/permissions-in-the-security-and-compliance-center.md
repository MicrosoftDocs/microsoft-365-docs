...
||Don't use this role group in the Security & Compliance Center. Use the corresponding role in Azure AD.|Attack Simulator Payload Author|
|**Comms Compliance and IRM**||Case Management <p> Insider Risk Management Admin <p> Insider Risk Management Analysis <p> Insider Risk Management Investigation <p> Insider Risk Management Temporary contribution <p> Review <p> Supervisory Review Administrator|
...
|**Data Investigator**|Perform searches on mailboxes, SharePoint Online sites, and OneDrive for Business locations.|Communication <p> Compliance Search <p> Custodian <p> Data Investigation Management <p> Export <p> Preivew <p> Review <p> Decrypt <p> Search And Purge|
...
|**Subject Rights Request Administrators**||Case Management <p> Subject Rights Request Admin <p> View-Only Case|
