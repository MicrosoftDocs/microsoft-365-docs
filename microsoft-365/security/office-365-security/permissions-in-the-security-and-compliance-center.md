...
|**Supervisory Review**|Members can create and manage the policies that define which communications are subject to review in an organization. For more information, see [Configure communication supervision policies for your organization](../../compliance/configure-supervision-policies.md).|Supervisory Review Administrator|
