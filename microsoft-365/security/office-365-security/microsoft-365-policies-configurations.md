...
:::image type="content" source="../../media/zero-trust/zero-trust-architecture.png" alt-text="The Microsoft Zero Trust architecture" lightbox="../../media/zero-trust/zero-trust-architecture.png":::
