...
- To open the Security & Compliance Center, go to <https://protection.office.com/>. Attack simulator is available at **Threat management** \> **Attack simulator**. To go directly to Attack simulator, open <https://security.microsoft.com/attacksimulator>.
