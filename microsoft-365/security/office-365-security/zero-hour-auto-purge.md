...
>
> Currently, ZAP is available for internal messages that are identified as malware or high-confidence phishing. Blocking of potentially malicious messages by ZAP is only supported for Teams Chats. Channels and external messages are currently not supported. 
