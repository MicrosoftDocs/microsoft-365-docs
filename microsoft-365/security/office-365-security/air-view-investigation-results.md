...
|Remediated | The investigation finished and all actions were approved (fully remediated).<br/><br/>**NOTE**: Approved remediation actions can have errors that prevent the actions from being taken. This does not change investigation status. Check remediation status for detailed results.​ |
