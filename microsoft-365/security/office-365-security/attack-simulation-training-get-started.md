...
> [!NOTE]
> NOR, ZAF, ARE and DEU are our latest additions to the regions where AST becomes available. All features except reported email telemetry will be available in these regions. We are working to enable this and will notify our customers as soon as reported email telemetry becomes available. 
