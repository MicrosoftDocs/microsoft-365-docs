...
5. On the **Protection settings** page, configure the following settings:
   ...
   - **Notifications** section: Use the settings in the section to configure additional recipients who should receive copies and notifications of suspicious outbound email messages:
     ...
     - **Send a copy of suspicious outbound that exceed these limits to these users and groups**: This setting adds the specified recipients to the Bcc field of suspicious outbound messages. Suspicious messages refers to outbound messages marked spam, phish, or malware. 
