...
- **Built-in protection**: A profile that enables a base level of Safe Links and Safe Attachments protection that's on by default for all Defender for Office 365 customers. Learn more on this new policy and order of precedence here:  [Preset security policies](preset-security-policies.md) and learn about the specific Safe Links and Safe Attachment controls set here: [Safe Attachments settings](recommended-settings-for-eop-and-office365.md#safe-attachments-settings) and [Safe Links settings](recommended-settings-for-eop-and-office365.md#safe-links-settings).
