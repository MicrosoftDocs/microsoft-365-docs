...
- [View converted admin submission from user reported messages](admin-submission.md#convert-user-reported-messages-from-the-custom-mailbox-into-an-admin-submission): Configure a reporting mailbox to intercept user-reported messages without sending the messages to Microsoft for analysis.
