...
- **Collaboration Security for Microsoft Teams**: With the increased use of collaboration tools like Microsoft Teams, the possibility of malicious attacks using URLs and messages has increased as well. Microsoft Defender for Office 365 is extending it's [Safelinks](safe-links-about.md) protection with increased capabilities for zero-hour auto purge, quarantine, and user reported messages. For more information, see [Microsoft Defender for Office 365 support for Microsoft Teams (Preview)](mdo-support-teams-about.md).
