...
description: Admins can learn how to use the Submissions portal in the Microsoft 365 Defender portal to submit legitimate emails getting blocked, suspicious emails, suspected phishing emails, spam, other potentially harmful messages, URLs, and email attachments to Microsoft for rescanning.
ms.technology: mdo
