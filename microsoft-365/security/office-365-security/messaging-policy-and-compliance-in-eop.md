...
# Messaging policy and compliance in standalone EOP

Exchange Online Protection (EOP) provides messaging policy and compliance features for that can help you manage your email data.
...
|[Mail flow rules (transport rules) in EOPn](mail-flow-rules-transport-rules-0.md)|Provides information about mail flow rules (also known as transport rules), which provide you with the flexibility to apply your own company-specific policies to email.|
