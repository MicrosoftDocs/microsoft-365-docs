...
*Manual hunting* happens when security teams identify threats manually by using the search and filtering capabilities in Explorer. Manual email remediation can be triggered through any email view (*Malware*, *Phish*, or *All email*) after you identify a set of emails that need to be remediated.

:::image type="content" source="../../media/microsoft-365-defender-threat-explorer-manual-remediation.png" alt-text="Microsoft 365 Defender Threat Explorer for manual investigations and remediation.":::
...
Manual actions pending approval using the two-step approval process (1. add to remediation by one security operations team member, 2. reviewed and approved by another security operations team member) are only visible in the legacy Defender for Office 365 action center **Review** \> **Action center** and not in incidents/investigations and the Unified Action center.
...
:::image type="content" source="../../media/microsoft-365-defender-action-center-history-panel.png" alt-text="The Action Center panel with Move to Inbox selected.":::
