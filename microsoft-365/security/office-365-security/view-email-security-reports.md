...
|Get-MailTrafficTopReport|[Top senders and recipient report ] <p> [Get-MailTrafficSummaryReport] <p> **Note**: There is no replacement for the encryption reporting capabilities in Get-MailTrafficTopReport.|MC315742|April 2022|
