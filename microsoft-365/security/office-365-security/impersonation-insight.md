...
- You open the Microsoft 365 Defender at <https://security.microsoft.com/>. To go directly to the impersonation insight on the **Anti-phishing** page, use <https://security.microsoft.com/antiphishing>.

- You need to be assigned permissions in the Microsoft 365 Defender before you can do the procedures in this article:
  ...
  **Note**: Adding users to the corresponding Azure Active Directory role in the Microsoft 365 admin center gives users the required permissions in the Microsoft 365 Defender _and_ permissions for other features in Microsoft 365. For more information, see [About admin roles](../../admin/add-users/about-admin-roles.md).
...
## Open the impersonation insight in the Microsoft 365 Defender

1. In the Microsoft 365 Defender, go to **Email & collaboration** \> **Policies & rules** \> **Threat policies** \> **Anti-phishing**.
