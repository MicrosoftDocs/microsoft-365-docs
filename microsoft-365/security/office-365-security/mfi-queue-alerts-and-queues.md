...
- **Connector name**: Select the connector name to manage the connector in the <a href="https://go.microsoft.com/fwlink/p/?linkid=2059104" target="_blank">Exchange admin center (EAC)</a>.
- **Queue started time**
