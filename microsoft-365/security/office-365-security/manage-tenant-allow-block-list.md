...
After you add an allow entry through the Submissions portal or a block entry in the Tenant Allow/Block List, the entry should start working immediately within 99.999% of the time. For the rest it can take upto 24 hours.
