...
You view and manage quarantined messages in the Microsoft 365 Defender or in PowerShell (Exchange Online PowerShell for Microsoft 365 organizations with mailboxes in Exchange Online; standalone EOP PowerShell for organizations without Exchange Online mailboxes).
...
## Use the Microsoft 365 Defender to manage quarantined email messages

### View quarantined email

1. In the Microsoft 365 Defender, go to **Email & collaboration** \> **Review** \> **Quarantine**.

2. Verify that **View quarantined** is set to the default value **emails**.
...
## Microsoft Defender for Office 365 Only: Use the Microsoft 365 Defender to manage quarantined files
