...
- You can configure to send messages directly to Microsoft, a mailbox you specify, or both. For more information, see [Configure user reported message settings](user-submission.md).
