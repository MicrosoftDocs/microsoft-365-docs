...
During the automated investigation of alerts, Microsoft Defender for Office 365 analyzes the original email for threats and identify other emails that are related to the original email and potentially part of an attack. This is important because email attacks rarely consist of a single email.
...
- If analysis of the original email’s URLs and files identifies that some are malicious (that is, malware or phish), then it will also create queries/clusters of emails containing the malicious URL/file.
