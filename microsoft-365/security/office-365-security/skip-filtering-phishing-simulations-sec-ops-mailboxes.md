...
> [!NOTE]
> Do not add URLs that are part of phishing simulation emails to 'Do not rewrite' list in safe links policy. This may result in unwanted alerts getting generated for URL clicks. All URLs that are part of phishing simulation emails are automatically allowed both during mailflow and during time of click. 
