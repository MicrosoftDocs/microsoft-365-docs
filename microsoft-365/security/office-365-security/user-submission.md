...
The message formatting requirements are described in the next section. The formatting is optional, but if it does not follow the prexscribed format, the reports will always be submitted as phish.
