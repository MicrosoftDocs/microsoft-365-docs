...
:::image type="content" source="../../media/zero-trust-identity-device-access-policies-overview/M365-idquality-threetiers.png" alt-text="The Security cone" lightbox="../../media/zero-trust-identity-device-access-policies-overview/M365-idquality-threetiers.png":::
...
:::image type="content" source="../../media/zero-trust-identity-device-access-policies-overview/security-triad.png" alt-text="The Security triad balancing security, functionality, and ease of use" lightbox="../../media/zero-trust-identity-device-access-policies-overview/security-triad.png":::
...
:::image type="content" source="../../media/zero-trust-identity-device-access-policies-overview/identity-device-access-components.png" alt-text="The Components of Zero Trust identity and device access" lightbox="../../media/zero-trust-identity-device-access-policies-overview/identity-device-access-components.png":::
...
:::image type="content" source="../../media/zero-trust-identity-device-access-policies-overview/identity-device-access-steps.png" alt-text="The steps to configure Zero Trust identity and device access" lightbox="../../media/zero-trust-identity-device-access-policies-overview/identity-device-access-steps.png":::
