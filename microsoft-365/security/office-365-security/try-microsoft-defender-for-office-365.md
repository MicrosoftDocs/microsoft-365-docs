...
- Do I want to passively observe what Defender for Office 365 Plan 2 can do for me, or do I want Defender for Office 365 Plan 2 to take direct action on issues?
...
## Use your trial to observe or take action

The ability to observe Defender for Office 365 Plan 2 or let it take action on what it finds depends on the nature of your Microsoft 365 organization:
...
- **An 'evaluation' is for Microsoft 365 organizations that already have Defender for Office 365 Plan 2 features**. The same policies are created for these organizations as are created for E3 and EOP organizations, but additional licenses for Defender for Office 365 Plan 2 aren't required. Affected Microsoft 365 organizations include:
...
|Defender for Office 365 Plan 1|Unlimited<sup>\*</sup>|Yes|90 days <br><br> <sup>\*</sup>After 90 days, P2 capabilities are turned off. Evaluation policies continue to work.|
...
## Policies for trying Defender for Office 365 features
...
The protection features of EOP and Defender for Office 365 are implemented using policies. The following policies are included in your trial:
...
- **Defender for Office 365**: Policies that are exclusive to Defender for Office 365 are created for your evaluation as needed:
  ...
  - **Audit mode**: Special *evaluation policies* are created for anti-phishing, Safe Attachments, and Safe Links. These evaluation policies are configured only to *detect* threats. Defender for Office 365 detects harmful messages for reporting, but the messages aren't acted upon (for example, detected messages aren't quarantined). The settings of these evaluation policies are described in the [Policies in audit mode](#policies-in-audit-mode) section later in this topic.
...
##### Use Exchange Online PowerShell to configure recipient conditions and exceptions to the evaluation in audit mode
