...
description: As an Office 365 admin, you can turn off the ability for people to use the built-in reporting options in Outlook on the web to report email as junk.
