...
- Messages with links to malicious sites are considered phish. For more information about reporting phish and good messages, see [Report messages and files to Microsoft](submissions-report-messages-files-to-microsoft.md).
