...
- For SharePoint Online, OneDrive for Business, and Azure Active Directory, [audit logging is turned on in the Microsoft 365 security center](../../compliance/turn-audit-log-search-on-or-off.md).
