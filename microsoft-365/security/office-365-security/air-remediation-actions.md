...
|Email |Zapped phish​ <br/>(Email messages were delivered and then [zapped​](https://docs.microsoft.com/microsoft-365/security/office-365-security/zero-hour-auto-purge).) |Soft delete email/cluster​ <br/><br/>[See if ZAP moved a message](https://docs.microsoft.com/microsoft-365/security/office-365-security/zero-hour-auto-purge#how-to-see-if-zap-moved-your-message) |
