...
The following **Increase spam score** ASF settings results in an increase in spam score and therefore a higher chance of getting marked as spam with SCL of 5 or 6, which corresponds to a **Spam** filter verdict and the corresponding action in anti-spam policies. Note that not every email which matches below settings will be marked as spam.
