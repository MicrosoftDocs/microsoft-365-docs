...
## Additional information about trials

Once the trial is configured, it might take up to 2 hours for changes to be available. And, admins must log out and log back in to see the changes.
