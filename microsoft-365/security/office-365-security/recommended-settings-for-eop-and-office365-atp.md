...
- Send suspicious mails, suspected spam, phish, or URLs to Microsoft for scan. Use the **Admin Submissions** directions in [this article](https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/admin-submission).
