...
- Using the [built-in Report button in Outlook on the web](zzz-built-in-owa-report.md) or the [Microsoft Report Message or Report Phishing add-ins](enable-the-report-message-add-in.md) to report messages to Microsoft helps with the training of our detection systems. Admins should also take advantage of [admin submission](admin-submission.md) capabilities to report messages to Microsoft.
