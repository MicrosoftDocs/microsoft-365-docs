...
Attack simulation training supports on-premises mailboxes, but with limited functionality. Specifically, reported email telemetry isn't available for on-premises accounts.
