...
|ARC:|The ARC protocol has three headers as: <br/>AAR: Records the content of Authentication results header from DMARC. <br/>AMS: This includes cryptographic signatures of the message <br/>AS: Includes cryptographic signature of the message headers. This header contains a tag of chain validation called "cv=" which includes the outcome of the chain validation as **none, pass or fail**.|
