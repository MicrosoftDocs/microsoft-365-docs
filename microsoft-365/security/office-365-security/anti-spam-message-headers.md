...
|**Header field**|**Description**|
|:-----|:-----|
|BCL|The bulk complaint level (BCL) of the message helps distinguish the different types of bulk mailers. This is represented as a value between 0 to 9. A higher BCL indicates the bulk mail (also known as gray mail) is more likely to generate complaints. For more information, see [Bulk complaint level (BCL in Office 365)](bulk-complaint-level-values.md).|
