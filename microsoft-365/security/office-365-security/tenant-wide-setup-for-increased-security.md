...
For secure environments, be sure to disable authentication for apps that don't support modern authentication. You can do this in Azure Active Directory with a control that is coming soon.
