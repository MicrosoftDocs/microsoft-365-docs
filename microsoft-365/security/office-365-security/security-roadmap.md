...
|Threat protection|<ul><li>Implement [Secure Privileged Access](/windows-server/identity/securing-privileged-access/securing-privileged-access) (SPA) for identity components on premises (AD, AD FS).</li><li>Use Cloud App Security to monitor for insider threats.</li><li>Discover shadow IT SaaS usage by using Cloud App Security.</li></ul>|
