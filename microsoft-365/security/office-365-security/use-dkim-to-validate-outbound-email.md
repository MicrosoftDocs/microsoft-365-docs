...
3. Select the domain for which you want to enable DKIM and for **Sign messages for this domain with DKIM signatures**, choose **Enable**. Then select **Rotate DKIM keys** if needed. Repeat this step for each custom domain.
