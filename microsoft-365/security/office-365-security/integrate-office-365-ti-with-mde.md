...
3. In the **Microsoft Defender for Endpoint connection** flyout that appears, turn on **Connect to Microsoft Defender for Endpoint** (:::image type="icon" source="../../media/scc-toggle-on.png" border="false":::) and then select **Close**.
...
6. Scroll down to **Office 365 Threat Intelligence connection**, and turn it on (:::image type="icon" source="../../media/scc-toggle-on.png" border="false":::).
