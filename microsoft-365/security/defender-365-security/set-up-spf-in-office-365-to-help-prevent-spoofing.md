...
[DKIM](https://docs.microsoft.com/microsoft-365/security/defender-365-security/use-dkim-to-validate-outbound-email?view=o365-worldwide) email authentication's goal is to prove the contents of the mail haven't been tampered with.

[DMARC](https://docs.microsoft.com/microsoft-365/security/defender-365-security/use-dmarc-to-validate-email?view=o365-worldwide) email authentication's goal is to make sure that SPF and DKIM information matches the From address.
