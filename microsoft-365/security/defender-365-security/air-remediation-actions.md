...
|Email|Malicious URL​<br/>(A malicious URL was detected by [Safe Links](safe-links.md).)|Soft delete email/cluster​ <br/>Block URL (time-of-click verification)<p> Email that contains a malicious URL is considered to be malicious​.|
...
|User|Email delegation rules​ <br> (A user's account has delegation set up.)|Remove delegation rule​ <p> If your organization is using [Microsoft Defender for Endpoint](/windows/security/threat-protection/), consider [investigating the user](../defender-endpoint/investigate-user) who's getting the delegation permission.​|
...
- [Learn about capabilities in Microsoft 365 Defender](../defender/microsoft-threat-protection.md)
