...
|Use **Microsoft Microsoft Sentinel** or your current SIEM tool to monitor for threats across your environment. |         |![green check mark](../media/green-check-mark.png)|
...
|Use the **Microsoft Defender for Cloud*** to monitor for threats across hybrid and cloud workloads. Microsoft Defender for Cloud* includes a free tier of capabilities and a standard tier of capabilities that are paid for based on resource hours or transactions.|         |         |
