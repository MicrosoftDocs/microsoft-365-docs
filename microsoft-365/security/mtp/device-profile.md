...
* **Initiate Live Response Session** - Loads a remote shell on the device for [in-depth security investigations](/windows/security/threat-protection/microsoft-defender-atp/live-response).
...
* [Investigate entities on devices, using live response](/windows/security/threat-protection/microsoft-defender-atp/live-response)
