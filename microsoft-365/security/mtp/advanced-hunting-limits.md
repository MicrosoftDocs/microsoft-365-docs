---
title: Advanced hunting quotas and usage parameters in Microsoft Threat Protection
...
>[!NOTE] 
>A separate set of quotas and parameters apply to advanced hunting queries performed through the API. [Read about advanced hunting APIs](https://docs.microsoft.com/microsoft-365/security/mtp/api-advanced-hunting)
