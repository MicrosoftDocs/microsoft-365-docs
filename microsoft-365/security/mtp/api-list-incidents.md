...
| assignedTo                                | Either owner of the incident, or `Null` when no owner is assigned                                                                                                                                                                                                                                                                                                                         | [secop2@contoso.com](mailto:secop2@contoso.com)                                                                                                                                                                                                   |
...
| severity                                  | Indicates the possible impact on assets. The higher the severity the bigger the impact and typically requires the most immediate attention.<br>One of the following values: `Informational`, `Low`, `Medium` and `High`.                                                                                                                                | Medium                                                                                                                                                                                                                                            |
