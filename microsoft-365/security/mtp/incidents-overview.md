...
Microsoft Threat Protection connects the dots on individual alerts. Malicious events on the following entities are surfaced in Microsoft 365 security center:
- Devices
- Users
- Mailboxes
