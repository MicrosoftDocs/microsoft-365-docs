...
- **[EmailPostDeliveryEvents table](advanced-hunting-emailpostdeliveryevents-table.md)** — use this table to create advanced hunting queries that check for actions taken on emails after they have been delivered to recipient mailboxes
