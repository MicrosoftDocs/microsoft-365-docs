...
|Phase | Description | 
|:-------|:-----|
| ![Phase 1: Plan](../../media/prepare.png)<br>[Phase 1: Plan](mtp-pilot-plan.md)| Learn what you need to consider before running your Microsoft Threat Protection pilot project: <br><br>- Scope <br> - Use cases <br>- Requirements <br>- Test plan <br> - Success criteria <br> - Scorecard 
