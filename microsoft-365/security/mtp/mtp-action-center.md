...
|Block specific URLs when clicked<br/>or<br/>Turn off external email forwarding |**Both of the following**:<br/>- **Security Administrator** role assigned in Azure AD<br/>- **System administrator** role assigned in the Exchange admin center| |
