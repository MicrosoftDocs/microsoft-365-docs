...
description: How to redirect accounts and sessions from the Defender for Office 365 to the new Microsoft 365 security center.
...
## What to expect
Once automatic redirection is enabled and active, users accessing the security-related capabilities in  Office 365 Security and Compliance (protection.office.com), will be automatically routed to the Microsoft 365 security center ( security.microsoft.com).  
...
With automatic redirection turned on, users will be routed to the new portal when the Threat Management security capabilities are accessed. This includes the Threat Management section at the navigation bar, and the Threat Management dashboard and reports. Items in the Office Security and Compliance portal not related to security are not redirected to the Microsoft 365 security center. Compliance-related items can be found in the Microsoft 365 compliance center, and mail-flow related items can be found in the Exchange admin center. 

All other capabilities, whether compliance-related or capabilities that serve both won’t be affected by redirection. Office 365 security alerts will show up in M365 security center, as well as in the Security and Compliance center, without redirection.  
