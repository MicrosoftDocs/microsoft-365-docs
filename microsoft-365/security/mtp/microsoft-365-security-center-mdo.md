...
The [Getting Started](../office-365-security/office-365-atp.md#getting-started) section of the [Microsoft Defender for Office 365 article](../office-365-security/office-365-atp.md) has logical early configuration chunks that look like this:
...
- [Custom detection rules](/windows/security/threat-protection/microsoft-defender-atp/custom-detection-rules)
