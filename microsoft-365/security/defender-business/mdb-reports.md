...
|Report  |Description  |
|---------|---------|
| **License report**<br/>(*NEW and currently in preview!*) | The license report (currently in preview) provides information about licenses your organization has purchased and is using. To access this report, in the navigation pane, choose **Settings** > **Endpoints** > **License**. |
