...
| [Attack surface reduction](../defender-endpoint/overview-attack-surface-reduction.md) <br/>(attack surface reduction rules and other protection)	| Yes <br/>- Attack surface reduction rules built into Windows 10 and later<br/>- Firewall protection<br/>- Centrally managed capabilities | Yes <br/>- Attack surface reduction rules are built into Windows 10 and later<br/>- Firewall protection <br/>- Centrally managed capabilities |
| [Endpoint detection and response](../defender-endpoint/overview-endpoint-detection-response.md) | Yes <br/>- Behavior-based detection <br/>- Manual response actions <br/>- Live response	 | Yes Includes: <br/>- Behavior-based detection <br/>- Manual response actions <br/>- Live response	 |
