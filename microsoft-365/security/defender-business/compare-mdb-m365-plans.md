...
|:---|:---|
| <ul><li>[Next-generation protection](../defender-endpoint/microsoft-defender-antivirus-in-windows-10.md) (antivirus/antimalware protection on devices together with cloud protection)</li><li>[Attack surface reduction](../defender-endpoint/overview-attack-surface-reduction.md) <sup>[[a](#fna)]</sup></li><li>[Endpoint detection and response](../defender-endpoint/overview-endpoint-detection-response.md) (behavior-based detection and manual response actions)</li><li>[Automated investigation and response](../defender-endpoint/automated-investigations.md)</li><li>[Threat and vulnerability management](mdb-view-tvm-dashboard.md)</li><li>[Cross-platform support for devices](mdb-onboard-devices.md) (Windows, Mac, iOS, and Android) <sup>[[b](#fnb)]</sup></li><li>[Centralized management and reporting](mdb-get-started.md)</li><li>[APIs for integration with custom reporting](../defender-endpoint/management-apis.md)</li></ul> | <ul><li>[Microsoft 365 Business Standard](../../admin/admin-overview/what-is-microsoft-365-for-business.md) (includes Office apps and services, and Microsoft Teams)</li><li>[Auto-expanding archiving](../../compliance/autoexpanding-archiving.md)</li><li>[Exchange Online Protection](../office-365-security/exchange-online-protection-overview.md)</li><li>[Defender for Business](mdb-overview.md) </li><li>[Microsoft Defender for Office 365 Plan 1](../office-365-security/overview.md) (includes advanced antiphishing, real-time detections, Safe Attachments, Safe Links)</li><li>[Microsoft Intune](/mem/intune/fundamentals/what-is-intune) (device onboarding and management)</li><li>[Azure Active Directory Premium Plan 1](/azure/active-directory/fundamentals/active-directory-whatis) (identity management)</li><li>[Azure Information Protection Premium Plan 1](/azure/information-protection/what-is-information-protection) (protection for sensitive information)</li><li>[Windows Autopilot](/mem/autopilot/windows-autopilot) (for setting up and configuring Windows devices)</li><li>Azure Virtual Desktop</li><li>Windows 10/11 Business</li><li>Shared computer activation</li></ul> |
