...
Microsoft Defender for Business includes default policies that use recommended settings to protect your company's devices from day one. For example, you have **Next-generation protection** policies and **Firewall** policies built in. You can create new policies, too, as described in this article.
