...
**We recommend using the simplified configuration process in Microsoft Defender for Business**, even if you are already using MEM. The simplified configuration process is streamlined especially for small and midsized businesses. Microsoft Defender for Business is designed to protect your company's devices on day one.
