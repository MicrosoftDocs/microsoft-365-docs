...
| **Local script**  | Microsoft Defender for Business hosts a downloadable script that you can use to onboard up to ten (10) devices running Windows 10 or 11. <br/><br/> If you have 10 or fewer Windows devices to onboard, such as for a pilot, you can use a local script. You download the script in the Microsoft 365 Defender portal ([https://security.microsoft.com](https://security.microsoft.com)), extract it on a device, and then run the script using Command Prompt. <br/><br/>To learn more about this method, see [Onboard Windows devices using a local script](../defender-endpoint/configure-endpoints-script.md).|
