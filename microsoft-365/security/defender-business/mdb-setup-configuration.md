...
| 4| [Configure security settings](mdb-view-edit-device-policies.md)     | You can manage your company's security settings through device policies. Default policies are included in Microsoft Defender for Business; however, you can edit those policies or define new policies to suit your company's needs. See [View or edit device policies in Microsoft Defender for Business](mdb-view-edit-device-policies.md).         |
