...
If your tenant was created on or after October 22, 2019, security defaults might be enabled in your tenant. The following procedure can be used to confirm or enable security defaults.
