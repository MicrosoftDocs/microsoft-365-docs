...
| **Turn on real-time protection** | Enabled by default, real-time protection locates and stops malware from running on devices.<br/><br/>*We recommend keeping real-time protection turned on.*<br/><br/>When real-time protection is turned on, it configures the following settings:<br/><br/>- Turn on behavior monitoring (AllowBehaviorMonitoring)<br/><br/>- Scan all downloaded files and attachments (AllowIOAVProtection)<br/><br/>- Scan scripts that are used in Microsoft browsers (AllowScriptScanning)   |
| **Block at first sight** | Enabled by default, block at first sight blocks malware within seconds of detection, increases the time (in seconds) allowed to submit sample files for analysis, and sets your detection level to High.<br/><br/>*We recommend keeping block at first sight turned on.*<br/><br/>When block at first sight is turned on, it configures the following settings for Microsoft Defender Antivirus: <br/><br/>- [CloudBlockLevel](/windows/client-management/mdm/policy-csp-defender) is set to the default value of High<br/><br/>- CloudExtendedTimeout is set to a default value of 50 <br/><br/>**IMPORTANT**: If block at first sight is turned off, make sure to configure [CloudBlockLevel](/windows/client-management/mdm/policy-csp-defender) and [CloudExtendedTimeout](/windows/client-management/mdm/policy-csp-defender) for Microsoft Defender Antivirus.  |
