...
| ![Endpoint detection and response symbol](../../media/security/security-shield-lightning.png) | [Endpoint detection and response](#endpoint-detection-and-response) | Endpoint detection and response (EDR) receives security signals across your network, devices, and kernel behavior. |
| ![Automated investigation and response symbol](../../media/security/security-toolkit.png) | [Automated investigation and response](#automated-investigation-and-response) | Automated investigation and response (AIR) capabilities are designed to examine alerts and take immediate action to resolve breaches.|
...
When it comes to configuring your security features on your company’s devices, you have two options:
