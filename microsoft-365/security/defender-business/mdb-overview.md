...
| Microsoft Endpoint Manager | [Endpoint Manager](/mem/endpoint-manager-overview) helps deliver modern workplace and management to keep your data secure, in the cloud and on-premises. Endpoint Manager includes services and tools to manage and monitor mobile devices, desktop computers, virtual machines, embedded devices, and servers. Endpoint Manager includes Microsoft Intune, Configuration Manager, Desktop Analytics, co-management, and Windows Autopilot. These services are part of the Microsoft 365 stack to help secure access, protect data, and respond to and manage risk. <br/><br/>If you're already using Endpoint Manager to manage your devices and security settings, you can continue to use Endpoint Manager with Defender for Business. | 
| Non-Microsoft device management solution | If you're using a non-Microsoft device management solution, such as Jamf for macOS or Ansible for Linux, you can use your solution with Defender for Business. In general, devices that are supported in Defender for Endpoint are supported in Defender for Business. <br/><br/>To learn more, see [Defender for Endpoint: Onboard non-Windows devices](../defender-endpoint/configure-endpoints-non-windows.md).  |
