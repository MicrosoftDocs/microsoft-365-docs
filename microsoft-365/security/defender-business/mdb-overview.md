...
| [![Connector symbol](/office/media/icons/connector-blue.png)](#cross-platform-support) | [Cross-platform support](#cross-platform-support) | Most organizations use a variety of devices and operating systems, such as computers running Windows, macOS, or Linux, and mobile devices running iOS or Android. |
