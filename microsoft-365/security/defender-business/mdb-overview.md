...
| Non-Microsoft device management solution | If you are using a non-Microsoft device management solution, such as Jamf for macOS or ANsible for Linux, you can use your solution with Defender for Business. In general, devices that are supported in Defender for Endpoint are supported in Defender for Business.  |
