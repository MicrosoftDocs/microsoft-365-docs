...
| Azure Active Directory (Azure AD) | Azure AD is required for user permissions and device groups. Azure AD is included in your Defender for Business (preview) subscription. To learn more, see [What is Azure AD?](/azure/active-directory/fundamentals/active-directory-whatis) |
