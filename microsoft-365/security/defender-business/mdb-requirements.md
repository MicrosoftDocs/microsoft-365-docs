...
| User accounts | User accounts are created<br/><br/>Microsoft Defender for Business licenses are assigned (See [Add users and assign licenses](../../admin/add-users/add-users.md).) |
