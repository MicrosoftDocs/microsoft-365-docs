...
|:---|:---|
| Subscription and licensing | - Microsoft Defender for Business (preview)<br/>- Azure Active Directory (Azure AD) (included with any Microsoft 365 subscription, including Microsoft Defender for Business)  |
