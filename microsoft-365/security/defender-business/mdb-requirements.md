...
|:---|:---|
| Subscription and licensing | Microsoft Defender for Business (currently in preview!) <br/><br/>To apply for the Microsoft Defender for Business preview program, visit [https://aka.ms/MDB-Preview](https://aka.ms/MDB-Preview).*<br/><br/>You don't have to have Microsoft 365 Business Premium or any other Microsoft 365 subscription to buy and use Microsoft Defender for Business. If you do already have another subscription (such as Microsoft 365 Business Basic, Standard, or Premium), consider adding Microsoft Defender for Business to get additional endpoint protection capabilities. |
