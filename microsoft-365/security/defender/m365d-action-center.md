...
:::image type="content" source="../../media/m3d-action-center-columnsfilters.png" alt-text="An example of the page that dislays the sort, filter, and customize capabilities of the Action center." lightbox="../../media/m3d-action-center-columnsfilters.png":::
