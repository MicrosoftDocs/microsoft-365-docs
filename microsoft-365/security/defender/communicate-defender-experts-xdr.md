...
When an incident requires your attention, such as the incidents our experts issue [managed response actions](../defender/start-using-mdex-xdr.md#managed-detection-and-response), you are notified through one or more of the following channels:
...
Apart from using the in-portal chat, you also have the option to engage in real-time chat conversations with Defender Experts directly within Microsoft Teams. This capability provides you and your security operations center (SOC) team additional flexibility when responding to incidents that require managed response. [Learn more about turning on notifications and chat on Teams](../defender/get-started-xdr.md#receive-managed-response-notifications-and-updates-in-microsoft-teams)
...
- While Defender Experts might have access to all messages in any channel in **Defender Experts team**, tag or mention our experts by typing *@Defender Experts* in your replies, so they are notified to join the chat conversation.
...
However, our experts could also send out emails to your indentified notification contacts directly during any of the following situations:
...
The SDM enagages with your identified **service review contacts**. [Learn more about adding contact persons or groups for service review and delivery](../defender/get-started-xdr.md#tell-us-who-to-contact-for-important-matters)