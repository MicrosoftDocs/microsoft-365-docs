...
:::image type="content" source="../../media/threat-analytics/ta_analystreport_mtp.png" alt-text="An example of the analyst report section of a threat analytics report" lightbox="../../media/threat-analytics/ta_analystreport_mtp.png":::
