...
:::image type="content" source="../../media/defender/m365-defender-endpoint-architecture.png" alt-text="The page that displays the steps for adding Microsoft Defender for Office to the Defender evaluation environment"../../media/defender/m365-defender-endpoint-architecture.png":::
