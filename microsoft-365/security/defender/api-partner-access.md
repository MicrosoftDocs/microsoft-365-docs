...
3. In the registration form:
   ...
   :::image type="content" source="../..//media/atp-api-new-app-partner.png" alt-text="An application's registration sections in Microsoft 365 Defender portal" lightbox="../..//media/atp-api-new-app-partner.png":::
...
4. On your application page, select **API Permissions** > **Add permission** > **APIs my organization uses** >, type **Microsoft Threat Protection**, and select **Microsoft Threat Protection**. Your app can now access Microsoft 365 Defender.
   ...
   :::image type="content" source="../../media/apis-in-my-org-tab.PNG" alt-text="APIs usage section in Microsoft 365 Defender portal" lightbox="../../media/apis-in-my-org-tab.PNG":::
...
6. Select **Grant admin consent**. Every time you add a permission, you must select **Grant admin consent** for it to take effect.
    ...
    :::image type="content" source="../../media/grant-consent.PNG" alt-text="A section to grant admin consent in Microsoft 365 Defender portal" lightbox="../../media/grant-consent.PNG":::
...
7. To add a secret to the application, select **Certificates & secrets**, add a description to the secret, then select **Add**.
    ...
    > After you select **Add**, select **copy the generated secret value**. You won't be able to retrieve the secret value after you leave.
      ...
      :::image type="content" source="../../media/webapp-create-key2.png" alt-text="Secret addition section in Microsoft 365 Defender portal" lightbox="../../media/webapp-create-key2.png":::

8. Record your application ID and your tenant ID somewhere safe. They're listed under **Overview** on your application page.

   :::image type="content" source="../../media/app-and-tenant-ids.png" alt-text="The **Overview** pane in Microsoft 365 Defender portal" lightbox="../../media/app-and-tenant-ids.png":::
...
9. Add the application to your user's tenant.
   ...
   :::image type="content" source="../../media/app-consent-partner.png" alt-text="The consent application page in Microsoft 365 Defender portal" lightbox="../../media/app-consent-partner.png":::
