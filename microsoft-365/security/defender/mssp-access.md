...
2. Create Defender for Endpoint roles for appropriate access levels in Customer Defender for Endpoint in Microsoft 365 Defender portal roles and groups.
    ...
    :::image type="content" source="../../media/mssp-access.png" alt-text="An example of the page that displays details of the MSSP access in the Microsoft 365 Defender portal" lightbox="../../media/mssp-access.png":::
...
2. **Create a resource catalog in Customer AAD: Identity Governance**
    ...
    :::image type="content" source="../../media/goverance-catalog.png" alt-text="An example of a new catalog in the Microsoft 365 Defender portal" lightbox="../../media/goverance-catalog.png":::
...
3. **Create access packages for MSSP resources Customer AAD: Identity Governance**
    ...
    :::image type="content" source="../../media/new-access-package.png" alt-text="An example of the page that displays details of a new access package in the Microsoft 365 Defender portal" lightbox="../../media/new-access-package.png":::
...
4. **Provide access request link to MSSP resources from Customer AAD: Identity Governance**
    ...
    :::image type="content" source="../../media/access-properties.png" alt-text="An example of the page that displays the access properties in the Microsoft 365 Defender portal" lightbox="../../media/access-properties.png":::
