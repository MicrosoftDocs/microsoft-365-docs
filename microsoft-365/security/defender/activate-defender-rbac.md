...
1. **Activate workloads**
    ...
    > [!NOTE]
    > To activate the management of **Exchange Online permissions** in Microsoft 365 Defender Unified RBAC, **Defender for Office 365** in the **Email and Collaboration** workload must be enabled.
