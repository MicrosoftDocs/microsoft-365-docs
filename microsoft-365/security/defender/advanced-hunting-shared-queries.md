...
:::image type="content" source="../../media/shared-query-1.png" alt-text="An example of shared queries information in the Microsoft 365 Defender portal" lightbox="../../media/shared-query-1.png":::
...
3. Enter a name for the query. 
   ...
   :::image type="content" source="../../media/shared-query-2.png" alt-text="An example of a new query that is about to be saved in the Microsoft 365 Defender portal" lightbox="../../media/shared-query-2.png":::
