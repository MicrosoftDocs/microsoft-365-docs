...
| **Learn how to use the query results** | Learn about charts and various ways you can view or export your results. Explore how you can quickly tweak queries, drill down to get richer information, and take response actions. | [Work with query results](advanced-hunting-query-results.md) [Take action on query results](advanced-hunting-take-action.md) |
