...
Note that the coordination of alerts from Microsoft Entra ID Protection (Microsoft Entra IP) to Microsoft 365 Defender is in public preview and may be substantially modified before it's commercially released. Microsoft Entra IP is available to customers only if they already have Microsoft 365 Defender. 
