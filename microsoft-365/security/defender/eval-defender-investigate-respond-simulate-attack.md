...
3. The new incident for the simulated attack will appear in the incident queue.
   ...
   :::image type="content" source="../../media/mtp/fig2.png" alt-text="**Incidents** queue in Microsoft 365 Defender portal" lightbox="../../media/mtp/fig2.png":::
...
:::image type="content" source="../../media/mtp/fig6.png" alt-text="A generated alert in Microsoft 365 Defender portal" lightbox="../../media/mtp/fig6.png":::
...
:::image type="content" source="../../media/mtp/fig7.png" alt-text="Example of the alert for injection of potentially malicious code" lightbox="../../media/mtp/fig7.png":::
...
:::image type="content" source="../../media/mtp/fig8.png" alt-text="An example of the alert for unexpected behavior by a process run with no command line arguments" lightbox="../../media/mtp/fig8.png":::
...
:::image type="content" source="../../media/mtp/fig10.png" alt-text="An example of the Microsoft Defender for Identity alert for User and IP address reconnaissance" lightbox="../../media/mtp/fig10.png":::
...
:::image type="content" source="../../media/mtp/fig11.png" alt-text="Device timeline section in Microsoft 365 Defender portal" lightbox="../../media/mtp/fig11.png":::
...
:::image type="content" source="../../media/mtp/fig12.png" alt-text="A selected PowerShell file creation behavior's process tree in Microsoft 365 Defender portal" lightbox="../../media/mtp/fig12.png":::
...
:::image type="content" source="../../media/mtp/fig14.png" alt-text=" Section of automated investigations related to the incident in Microsoft 365 Defender portal" lightbox="../../media/mtp/fig14.png":::
...
:::image type="content" source="../../media/mtp/fig15.png" alt-text="An example of the Investigation details page in Microsoft 365 Defender portal" lightbox="../../media/mtp/fig15.png":::
...
[:::image type="content" source="../../media/eval-defender-investigate-respond/eval-defender-eval-investigate-respond-step2.png" alt-text="An  example of Microsoft 365 Defender incident response capabilities" lightbox="../../media/eval-defender-investigate-respond/eval-defender-eval-investigate-respond-step2.png":::](eval-defender-investigate-respond-additional.md)
