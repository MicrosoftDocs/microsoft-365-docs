...
:::image type="content" source="../../media/investigate-users/incidents-ss-user-pane.png" alt-text="The section that displays the summarized information for a user account summary pane for an incident in Microsoft 365 Defender portal" lightbox="../../media/investigate-users/incidents-ss-user-pane.png":::
...
:::image type="content" source="../../media/investigate-users/incidents-ss-user-details.png" alt-text="An example of the page that displays details of the user account in Microsoft 365 Defender portal" lightbox="../../media/investigate-users/incidents-ss-user-details.png":::
...
:::image type="content" source="../../media/investigate-users/user-group-membership.png" alt-text="An example of the page that displays information about the group membership for a user in Microsoft 365 Defender portal" lightbox="../../media/investigate-users/user-group-membership.png":::
...
:::image type="content" source="../../media/investigate-users/incidents-ss-user-details-actions.png" alt-text="The section that describes the actions on a user account for an incident in Microsoft 365 Defender portal" lightbox="../../media/investigate-users/incidents-ss-user-details-actions.png":::
...
:::image type="content" source="../../media/investigate-users/lateral-movement-path.png" alt-text="An example of the page that describes the lateral movement path for a user in Microsoft 365 Defender portal" lightbox="../../media/investigate-users/lateral-movement-path.png":::
