...
To start using Microsoft 365 Defender URBAC to manage your Secure Score permissions, see [Microsoft 365 Defender Unified role-based access control(URBAC)](manage-rbac.md).
