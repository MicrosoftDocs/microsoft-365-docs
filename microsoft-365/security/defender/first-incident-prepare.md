...
:::image type="content" source="../../media/first-incident-prepare/first-incident-secure-score.png" alt-text="The Microsoft Secure Score page in the Microsoft security center portal" lightbox="../../media/first-incident-prepare/first-incident-secure-score.png":::
...
:::image type="content" source="../../media/first-incident-prepare/first-incident-vulnerability.png" alt-text="The Threat and Vulnerability page in the Microsoft security center portal" lightbox="../../media/first-incident-prepare/first-incident-vulnerability.png"::: 
...
[![Step 1: Learn how to triage and analyze incidents.](../../media/first-incident-overview/first-incident-path-step1.png#lightbox)](first-incident-analyze.md)
