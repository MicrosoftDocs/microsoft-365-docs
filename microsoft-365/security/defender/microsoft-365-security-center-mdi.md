...
|Area |Description  |
|---------|---------|
|**Identity page**     |  The Microsoft 365 Defender identity details page provides inclusive data about each identity, such as: <br><br>- Any associated alerts <br>- Active Directory account control<br>- Risky lateral movement paths<br>- A timeline of activities and alerts<br>- Details about observed locations, devices and groups. <br><br><!--The identity page contains more inclusive view from the different available products. <br>-->For more information, see [Investigate users in Microsoft 365 Defender](investigate-users.md). |
...
| **Reports**                    |The following types of reports are available from the **Settings > Identities > Report management** page, either for immediate download or scheduled for a periodic email delivery: <br><br>- A summary of detected network activity, a list of suspicious activities you should take care of, and a list of Defender for Identity health issues you should take care of. Health issues are also available in **Settings** > **Identities** > **Health issues**<br><br>- A list of each time a modification is made to sensitive groups. Modify sensitive groups from the **Advanced hunting** page.<br><br>- A list of source computer and account passwords that are detected as being sent in clear text. <br><br>- A list of the sensitive accounts exposed in lateral movement paths. <br><br>Lateral movement path and passwords exposed in cleartext reports are also covered by the [Identity security posture assessments](/defender-for-identity/security-assessment#assessment-reports) (ISPM). View a summary of alerts by exporting the alerts queue or from the **Advanced hunting** page, which provides 30 days of data.<br><br>**Tip**: Use the **Advanced hunting** page to create customized reports in Microsoft 365 Defender.  |
