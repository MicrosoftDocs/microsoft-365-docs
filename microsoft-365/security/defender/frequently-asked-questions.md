...
| **What products does Defender Experts for XDR operate on?** | See the [Prerequisites]([dex-xdr-overview#prerequisites.md](https://learn.microsoft.com/microsoft-365/security/defender/dex-xdr-overview#prerequisites)) section for details. |
