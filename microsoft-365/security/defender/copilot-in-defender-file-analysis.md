...
1. Open a file entity page. Copilot automatically generates an analysis when opening a file page. The results, which shows the overview information by default, are then displayed on the Copilot pane. Select **Show details** to display the file’s information in full.  
