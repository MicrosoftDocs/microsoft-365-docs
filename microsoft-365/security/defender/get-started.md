...
:::image type="content" source="../../media/mtp/get-started-m365d.png" alt-text="An example of the page that describes the steps to get started with Microsoft 365 Defender" lightbox="../../media/mtp/get-started-m365d.png":::
