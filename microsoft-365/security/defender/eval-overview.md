...
|D    |    Microsoft Defender for Endpoint manages and enforce advanced device protections while integrating and evaluating signals from Microsoft Defender for Identity, Microsoft Defender for Office 365, and Microsoft Cloud App Security. Additionally, Azure Active Directory shares endpoint related health signals, including device compliance and device health, if these are included in conditional access policies.    |
