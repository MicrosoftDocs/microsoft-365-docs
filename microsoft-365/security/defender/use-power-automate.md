...
- [Integrate Power Automate with Microsoft Cloud App Security](/cloud-app-security/flow-integration.md)

- [Microsoft Power Automate documentation](/power-automate.md)