...
3. In the Action center, on the **Pending** tab, select an item in the list. Its flyout pane opens. Here's an example.
   ...
   :::image type="content" source="../../media/air-actioncenter-itemselected.png" alt-text="An example of the page that displays the options to approve or reject an action." lightbox="../../media/air-actioncenter-itemselected.png":::
