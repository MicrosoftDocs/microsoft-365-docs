...
### Map Defender for Office 365 (Exchange Online Protection) roles to the Microsoft 365 Defender RBAC permissions -temp
...
|Global Reader| Security operations\ security data basics\ read only</br>Security operations\ Email &amp; collaboration raw data\ Email messages headers\ read</br>Security operations\ security data\response\ manage</br>Configuration\System settings\ read only</br>Configuration\Security setting\ read only</li></ul>|
