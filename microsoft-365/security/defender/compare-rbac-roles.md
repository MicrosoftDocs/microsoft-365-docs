...
|:-------|:-----|:-------|:-------|
|Global Administrator|Security operations \ Security data \ Security data basics (read)</br>Security operations \ Security data \ Alerts (manage) </br>Security operations \ Security data \ Response (manage)</br>Configuration \ Authorization \ (All permissions)</br>Configuration \ Security settings \ (All permissions)</br>Configuration \ System settings \ (All permissions) </br>| _**Applies to Defender for Endpoint only**_ </br>Security operations \ Basic live response (manage)</br>Security operations \ Advanced live response (manage)</br>Security posture \ Posture management \ Vulnerability management (read)</br>Security posture \ Posture management \ Exception handling (manage)</br>Security posture \ Posture management \ Remediation handling (manage)</br>Security posture  \ Posture management \ Application handling (manage)</br>Security posture  \ Posture management \ Security baseline assessment (manage)</br></br> _**Applies to Defender for Office only**_ </br> Security operations \ Security data \ Email quarantine (manage)</br>Security operations \ Security data \ Email advanced actions  (manage)</br>Security operations \ Raw data (Email & collaboration) \ Email message headers (read)|
|Security Administrator|Same as Global admin| Same as Global admin|
|Global reader|Security operations \ Security data \ Security data basics (read)| _**Applies to Defender for Endpoint and Defender for Identity only**_ </br> Configuration \ Security settings \ (read)</br>Configuration \ System settings \ (read) </br></br> **Defender for Office only** </br> Security operations \ Security data \ Response (manage)</br>Security operations \ Raw data (Email & collaboration) \ Email message headers (read)</br>Configuration \ Authorization \ (read) </br></br>_**Defender for Identity only**_ </br>Security posture \ Posture management \ Vulnerability management (read)|
|Security reader|Same as Global reader| Same as Global reader|
|Security operator|Security operations \ Security data \ Security data basics (read) </br>Security operations \ Security data \ Alerts (manage) </br>Security operations \ Security data \ Response (manage)</br>Configuration \ Security settings \ (All permissions)|_**Applies to Defender for Endpoint only**_</br></br>Security operations \ Basic live response (manage)Security operations \ Advanced live response (manage)</br>Security posture \ Posture management \ Vulnerability management (read)</br>Security posture \ Posture management \ Exception handling (manage)</br>Security posture \ Posture management \ Remediation handling (manage)</br></br>_**Applies to Defender for Identity only**_ </br>Configuration \ System settings \ (read)|
|Compliance administrator|not applicable| **Applies to Defender for Office only** </br> Security operations \ Security data \ Security data basics (read)</br> Security operations \ Security data \ Alerts (manage)|
|Compliance data administrator|not applicable| Same as compliance administrator</br> Same as compliance administrator|
|Billing admin|not applicable|ot applicable|
