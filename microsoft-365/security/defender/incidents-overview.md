...
- Dive into [threat hunting](advanced-hunting-overview.md).
...
**If you are a SecOps team manager**:

- Understand how to [prioritize and assign incidents](incident-queue.md) based on severity and other factors. 
