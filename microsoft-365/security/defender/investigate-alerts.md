...
Microsoft 365 Defender alerts may come from solutions like [Microsoft Defender for Endpoint](../defender-endpoint/alerts-queue-endpoint-detection-response.md), [Microsoft Defender for Office 365](../office-365-security/mdo-sec-ops-manage-incidents-and-alerts.md), [Microsoft Defender for Identity](https://docs.microsoft.com/defender-for-identity/what-is), [Microsoft Defender for Cloud Apps](https://docs.microsoft.com/defender-cloud-apps/what-is-defender-for-cloud-apps), [the app governance add-on for Microsoft Defender for Cloud Apps](https://docs.microsoft.com/defender-cloud-apps/app-governance-manage-app-governance), [Azure Active Directory Identity Protection](https://docs.microsoft.com/azure/active-directory/identity-protection/overview-identity-protection), and [Microsoft Data Loss Prevention](../../compliance/dlp-learn-about-dlp.md). You may notice alerts with prepended characters in the alert. The following table provides guidance to help you understand the mapping of alert sources based on the prepended character on the alert.
