...
:::image type="content" source="../../media/defender/m365-defender-identity-eval-steps.png" alt-text="An example of the page that displays the various steps for adding Microsoft Defender for Identity to the Defender evaluation environment" lightbox="../../media/defender/m365-defender-identity-eval-steps.png":::
