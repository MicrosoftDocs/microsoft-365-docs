...
- (Preview) Microsoft Defender XDR now has built in deception technology to protect your environment from high-impact attacks that use human-operated lateral movement. Learn more about [deception](deception-overview.md) and how to [configure the deception feature](configure-deception.md).
