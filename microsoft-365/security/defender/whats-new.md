...
- (Preview) Assign incidents to any user account

  You can assign an incident, and all the alerts associated with it, to a specified user account. Select **Assign to:** from the **Manage incident** pane of an incident.
