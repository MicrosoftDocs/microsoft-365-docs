...
Centralized permissions management for Microsoft Defender Vulnerability Management capabilities using Microsoft 365 Defender Unified role-based access control (RBAC) is now available in Public Preview.
