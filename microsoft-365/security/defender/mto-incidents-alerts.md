---
title: View and manage incidents and alerts in the multi-tenant view in Microsoft 365 Defender
description: Learn about incidents and alerts in the multi-tenant view in Microsoft 365 Defender
...
The multi-tenant view in Microsoft 365 Defender enables security operation center (SOC) analysts to access and analyze data from multiple tenants in one place, allowing them to quickly identify and respond to threats.

You can manage incidents & alerts originating from multiple tenants under **Incidents & alerts**.

## View and investigate incidents

1. To View or investigate an incident, go to the [Incidents page](https://mto.security.microsoft.com/incidents) in the multi-tenant view in Microsoft 365 Defender. The **Tenant Name** column shows which tenant the incident originates from:
...
1. Go to the [Incidents page](https://mto.security.microsoft.com/incidents) in the multi-tenant view in Microsoft 365 Defender.
...
1. To view or investigate an alert, go to the [Alerts](https://mto.security.microsoft.com/alerts) in the multi-tenant view in Microsoft 365 Defender and select the incident you want to view. A flyout panel opens with the alert details page:
...
1. Go to the [Alerts page](https://mto.security.microsoft.com/alerts) in the multi-tenant view in Microsoft 365 Defender.
