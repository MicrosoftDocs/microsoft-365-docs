...
> [!NOTE]
> **Try our new APIs using MS Graph security API**. Find out more at: [Use the Microsoft Graph security API - Microsoft Graph | Microsoft Learn](/graph/api/resources/security-api-overview). For information about the new _get incident_ API using MS Graph security API, see [Get incident](graph/api/resources/security-incident-get.md).
