...
:::image type="content" source="../../media/custom-detect-rules-view.png" alt-text="Custom detection rule details page in Microsoft 365 Defender portal" lightbox="../../media/custom-detect-rules-view.png":::<br>
