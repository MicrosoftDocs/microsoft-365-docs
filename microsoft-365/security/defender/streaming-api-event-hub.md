...
7. To export the event data to a single Event Hub, enter your **Event Hub name** and your **Event Hub resource ID**.
   ...
   :::image type="content" source="../defender-endpoint/images/event-hub-resource-id.png" alt-text="An example of the page displays Event Hub resource Id1" lightbox="../defender-endpoint/images/event-hub-resource-id.png":::
...
- Here is an example for Device Info event:
  ...
  :::image type="content" source="../defender-endpoint/images/machine-info-datatype-example.png" alt-text="An example of the page displays the event hub resource Id2" lightbox="../defender-endpoint/images/machine-info-datatype-example.png":::
