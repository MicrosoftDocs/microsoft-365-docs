...
1. Sign in to [Multi-tenant management in Microsoft 365 Defender](https://mto.security.microsoft.com/).
...
The features available in multi-tenant management now appear on the navigation bar and you're ready to view and manage security data across all your tenants.
   ...
   :::image type="content" source="../../media/defender/mto-tenant-selection.png" alt-text="Screenshot of multi-tenant management in Microsoft 365 Defender" lightbox="../../media/defender/mto-tenant-selection.png":::
