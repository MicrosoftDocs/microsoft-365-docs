...
4. In the **Add new Streaming API settings** flyout that appears, configure the following settings:
   ...
   3. In the **Storage Account Resource ID** box that appears, type your **Storage Account Resource ID**. To get your **Storage Account Resource ID**, open the Azure portal at <https://portal.azure.com>, click **Storage accounts** \> go to the properties tab \> copy the text under **Storage Account Resource ID**.
      ...
      :::image type="content" source="../defender-endpoint/images/storage-account-resource-id.png" alt-text="The Event Hubs resource with the value ID1" lightbox="../defender-endpoint/images/storage-account-resource-id.png":::
...
- A blob container will be created for each event type:
  ...
  :::image type="content" source="../defender-endpoint/images/storage-account-event-schema.png" alt-text="The Event Hubs resource with the value ID2" lightbox="../defender-endpoint/images/storage-account-event-schema.png":::
...
- Here is an example for Device Info event:
  ...
  :::image type="content" source="../defender-endpoint/images/machine-info-datatype-example.png" alt-text="The Event Hubs resource with the value ID3" lightbox="../defender-endpoint/images/machine-info-datatype-example.png":::
