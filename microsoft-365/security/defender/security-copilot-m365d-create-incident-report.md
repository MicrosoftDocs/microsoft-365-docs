...
description: Write incident reports with Microsoft Copilot in Microsoft Defender XDR.
...
# Create an incident report with Microsoft Copilot for Security in Defender XDR
