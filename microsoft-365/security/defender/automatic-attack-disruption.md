...
- It automatically takes response action across relevant Microsoft Defender products to contain the attack in real time by isolating affected assets.
...
When automatic disruption actions are taken, the Microsoft 365 Defender incident page will reflect the attack story and status indicated by a yellow bar at the top as shown in image 4. The incident will show a dedicated disruption tag, point out the status of the contained assets in the incident graph, and add an action to the Action Center.

To ensure visibility of these automatic actions, the Microsoft 365 Defender user experience now includes additional visual cues. You will find them across the following experiences:
...
- [Configuration options](incidents-overview.md)
