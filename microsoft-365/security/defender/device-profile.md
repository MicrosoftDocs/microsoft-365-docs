...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-overall.png" alt-text="Device profile page in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-overall.png":::
...
:::image type="content" source="../../media/mtp-device-profile/azure-atp-only-device-sidebar.png" alt-text="Sidebar tab for device profile in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/azure-atp-only-device-sidebar.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-long-action-bar.png" alt-text="Action bar for device profile in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-long-action-bar.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-overview.png" alt-text="**Overview** tab for device profile in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-tab-overview.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-alerts.png" alt-text="Alerts tab for device profile  in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-tab-alerts.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-timeline.png" alt-text="**Timeline** tab for device profile in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-tab-timeline.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-security-recs.png" alt-text="**Security recommendations** tab for device profile in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-tab-security-recs.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-software-inventory.png" alt-text="**Software inventory** tab for device profile in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-tab-software-inventory.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-discovered-vulnerabilities.png" alt-text="**Discovered vulnerabilities** tab for device profile in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-tab-discovered-vulnerabilities.png":::
...
:::image type="content" source="../../media/mtp-device-profile/hybrid-device-tab-missing-kbs.PNG" alt-text="**Missing KBs** tab for device profile in Microsoft 365 Defender portal" lightbox="../../media/mtp-device-profile/hybrid-device-tab-missing-kbs.PNG":::
