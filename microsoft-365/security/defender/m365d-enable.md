...
Onboarding to Microsoft 365 Defender is simple. From the navigation menu, select any item, such as Incidents, Hunting, Action center, or Threat analytics to initiate the onboarding process. 
