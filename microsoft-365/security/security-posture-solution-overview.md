...
|Phase|Steps|
|---|---|
|[1 - Configure capabilities](#1-configure-capabilities)|<</li><li>[1.1 Configure device discovery](/strengthen-security-posture-configure-capabilities.md#11-configure-device-discovery)</li><li>[1.2 Configure ASR in audit mode](/strengthen-security-posture-configure-capabilities#12-configure-asr-in-audit-mode)</li><li> [1.3 Configure Microsoft Defender for Identity](/strengthen-security-posture-configure-capabilities#13-configure-microsoft-defender-for-identity)</li></li>|
