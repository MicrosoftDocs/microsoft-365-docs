...
|Phase|Steps|
|---|---|
|[1 - Configure capabilities](#configure-capabilities)|<ol><li>[Configure device discovery](strengthen-security-posture-configure-capabilities.md#11-configure-device-discovery)</li><li>[Configure ASR in audit mode](strengthen-security-posture-configure-capabilities.md#12-configure-asr-in-audit-mode)</li><li> [Configure Microsoft Defender for Identity](strengthen-security-posture-configure-capabilities#13-configure-microsoft-defender-for-identity)</li></ol>|
