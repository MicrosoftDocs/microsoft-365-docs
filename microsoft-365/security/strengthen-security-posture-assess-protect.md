...
|**Onboard newly discovered devices** | Devices that have been discovered but have not yet been onboarded and secured by Microsoft Defender for Endpoint appear in the device inventory Computers and Mobile tab <br /><br /> To start onboarding the devices, see [Onboard newly discovered devices](#onboard-newly-discovered-devices). |[Onboarding status](../security/defender-endpoint/device-discovery.md#device-inventory). |
