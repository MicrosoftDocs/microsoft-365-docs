...
In Microsoft Threat Protection, investigations can be done on devices (also referred to as endpoints), user accounts, and mailboxes. AIR capabilities in Microsoft Threat Protection correlate signals across Azure ATP (for your user identities), Microsoft Defender ATP (for your devices, or endpoints), and Office 365 ATP (for your Office files and email). This enables your security operations team to:
