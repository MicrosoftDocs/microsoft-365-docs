...
> [!TIP]
> You can change the view in your document library to fit your needs or preferences. For more information, see [Change the view in a document library](apply-a-model#change-the-view-in-a-document-library).
