...
Think of the intelligent content services available in Syntex as having three parts:
...
With new AI services and capabilities, you can build content understanding and classification apps directly into the content management flow using Syntex:
...
The following table explains what you get when you use Syntex:
...
Syntex integrates with Microsoft 365 compliance features like:
