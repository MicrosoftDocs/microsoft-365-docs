...
| Icon          | Description   |
| ------------- | ------------- |
| ![files](https://docs.microsoft.com/office/media/icons/files-blue.png)  | **Supported file types** <br>This model supports the following file types: see [file requirements](https://docs.microsoft.com/en-us/ai-builder/form-processing-model-requirements#requirements). |
...
| ![globe](https://docs.microsoft.com/office/media/icons/globe-internet.png)  | **Multi-Geo environments** <br>When setting up SharePoint Syntex in a [Microsoft 365 Multi-Geo environment](https://docs.microsoft.com/en-us/microsoft-365/enterprise/microsoft-365-multi-geo), you can only configure it to use the model type in the central location. If you want to use this model type in a satellite location, contact Microsoft support. |
