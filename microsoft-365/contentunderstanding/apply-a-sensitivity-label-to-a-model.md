...
> [!Important]
> For sensitivity labels to be available to apply to your document understanding models, they need to be [created and published in the Microsoft Purview portal](../admin/security-and-compliance/set-up-compliance.md).
...
> [!Important]
> For sensitivity labels to be available to apply to your form processing model, they need to be [created and published in the Microsoft Purview portal](../admin/security-and-compliance/set-up-compliance.md).
