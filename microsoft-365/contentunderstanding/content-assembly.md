...
1. In the **Name** field, enter a relevant name for the placeholder.
   ...
   ![Screenshot of the template viewer showing the All placeholders panel for input from a SharePoint list.](../media/content-understanding/content-assembly-create-template-term.png)
