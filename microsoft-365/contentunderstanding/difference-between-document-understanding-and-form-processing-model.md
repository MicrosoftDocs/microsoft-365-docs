...
| Supported languages| Language support for more than [73 languages](/ai-builder/form-processing-model-requirements?branch=extractor-working#languages-supported) | Models work on all Latin alphabet languages. In addition to English: German, Swedish, French, Spanish, Italian, and Portuguese.|
