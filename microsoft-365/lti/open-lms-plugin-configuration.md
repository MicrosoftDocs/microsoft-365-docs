...
To set up an installed Open LMS to work with Microsoft Teams:
...
> [!NOTE]
> While configuring the integration, keep your Microsoft 365 Open LMS Integration configuration page open in a separate browser tab because you'll need to return to these pages throughout the process.
...
> [!NOTE]
> It isn't required for all Open LMS users to the OpenID Connect authentication plugin as their authentication method; however, if they use other authentication methods, their Open LMS accounts needs to be *connected* to their corresponding Microsoft accounts before they can use certain features in the Teams integration, like syncing Teams ownership and membership.
...
- On operating systems that aren't Windows, you should only follow the manual process to register your Moodle instance in Azure. Check the *Important* alert section below for details.
...
#### Step 2: Set Azure app details in Moodle
...
1. To validate sync configuration, you'll need to run the scheduled tasks manually for the first time. Navigate to **Site administration** > **Server** > **Tasks** > **Scheduled tasks**.
    ...
    1. Next, find the **Sync Moodle courses to Microsoft Teams** task and select **Run now**.
        ...
        1. This task will also sync Moodle users enrolled in the course to Teams as owners or members.
            ...
            1. Similarly, a Team **member** is a Moodle user who meets all of the following criteria:
                1. is connected to a Microsoft 365 account.
                2. is enrolled in the course.
...
> - The default schedule of the **Sync Moodle courses to Microsoft Teams** task is daily at 1 am in the Moodle server default time zone.
