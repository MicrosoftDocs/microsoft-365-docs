...
:::image type="content" source="../../media/group-level-insights-data-accuracy.png" alt-text="Screenshot: Warning to run a data accuracy evaluation before enabling group-level insights" lightbox="../../media/prodscore-landing.png":::
...
:::image type="content" source="../../media/group-level-aggregates-data-evaluation.png" alt-text="Screenshot: Group-level data evaluation report" lightbox="../../media/prodscore-landing.png":::
...
:::image type="content" source="../../media/group-level-aggregates-filters.png" alt-text="Screenshot: Filters for group-level insights in Adoption Score" lightbox="../../media/prodscore-landing.png":::
