...
:::image type="content" source="../../media/trendline-devices-supportedversions.png" alt-text="Chart that show how many devices run supported and latest versions of apps over time.":::
