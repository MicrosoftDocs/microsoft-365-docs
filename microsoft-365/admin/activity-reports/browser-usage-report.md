...
> [!NOTE]
> Aggregate Microsoft browser usage and user level reporting is available. User level identification can be [removed per your organization’s policies](activity-reports.md#show-user-details-in-the-reports) and [role based access controls](/add-users/assign-admin-roles) can be used to adjust report access.
