...
[Forward emails that are sent to a shared mailbox](https://learn.microsoft.com/microsoft-365/admin/email/configure-a-shared-mailbox?view=o365-worldwide#forward-emails-that-are-sent-to-a-shared-mailbox) (article)\
