...
|:-----|:-----|
|Groups in Outlook  <br/> |A shared workspace that works across all applications in Office 365. Includes a shared inbox, calendar, and OneDrive for Business site for storing files. Users can create, find, and join Groups in Outlook right from their email or calendar. New and existing users with an Exchange Online or a Microsoft 365 or Office 365 subscription can use Groups in Outlook.  <br/> |
