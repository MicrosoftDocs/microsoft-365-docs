...
1. In the  [M365 admin center](https://admin.microsoft.com), go to the **Settings** \> **Org settings** > [Services](https://go.microsoft.com/fwlink/p/?linkid=2053743) page, and then select **User consent to apps**.
