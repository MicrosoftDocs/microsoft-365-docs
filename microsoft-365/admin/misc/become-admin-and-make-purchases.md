...
|By choosing **Upgrade to Microsoft 365** in Skype Meetings  <br/> |Microsoft 365 Business Basic or Microsoft 365 Business Standard  <br/> |
...
|****Task****|****Details****|
|:-----|:-----|
|Add or remove licenses  <br/> |You can [add more licenses](../../commerce/licenses/buy-licenses.md) for users who aren't using Microsoft 365 yet, or [remove licenses from users](../manage/remove-licenses-from-users.md) that you don't want using your organization's Microsoft 365 subscription.  <br/> |
...
|Start using Microsoft 365  <br/> |Visit the [Microsoft 365 Learning Center](https://support.office.com/learn/office365-for-business) and learn how to sign in, check email, share documents, and more. You and your users can use this site to get started with Microsoft 365.  <br/> |
