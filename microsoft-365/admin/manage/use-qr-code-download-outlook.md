...
> [!IMPORTANT]
> As of September 2024, this feature will be turned off indefinitely for Enterprise users. For more details on the settings and controls for this feature see, [Conditional Access: Authentication flows (Preview)](/entra/identity/conditional-access/concept-authentication-flows).
