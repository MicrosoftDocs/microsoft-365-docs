...
If one or more **eligible** distribution lists fail to be upgraded, open a [Support ticket]([Get support](../get-help-support.md)). The issue will need to be escalated to the Groups Engineering team for them to figure out the problem.
