---
title: "Search in the Microsoft 365 admin center"
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
We've started rolling out a new Search experience for the admin center. The Search box has moved to the banner region at the top of the admin center where is says **Microsoft 365 admin center** so you now search from any page, not just the Home page. You can also use the Alt+S shortcut to search from any page, not just the home page.
