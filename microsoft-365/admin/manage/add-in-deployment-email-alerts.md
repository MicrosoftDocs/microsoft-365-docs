...
- Email provides buttons to launch the add-in in the respective Microsoft 365 apps on the web, on Windows, and on Mac platforms to help make the add-in easier to discover. 

> [!Note]
> The launch buttons are currently not supported for iPad clients.
