...
> [!NOTE]
> An Exchange admin can deploy an add-in If the **Application Administatrator** role is added or if the **App Registrations** property is set to true in Azure Active Directory admin center as shown in the following image:
>
