...
|Tags|You can choose tags from the **Tag** drop-down to filter messages. <p> **Data Privacy**: Data privacy notification (limited to global administrator and Message center Privacy reader roles). <p> **Major update**: Changes communicated at least 30 days in advance (major updates). <p> **Retirement**: Retirement of a service or feature. <p> **New feature**: New feature or service. <p> **Feature update**: Update to an existing feature. <p> **Admin impact**: When the change clearly impacts the admin in the following ways:
        UI Change
        Workflow change
        Control available
        Specific/Potential Action <p> **User impact**: When the change to the service clearly impacts the user:
        UI Change
        Workflow change <p> **Updated message**: When a message is updated.|
