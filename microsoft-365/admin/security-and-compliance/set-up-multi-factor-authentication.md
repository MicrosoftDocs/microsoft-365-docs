...
Every new Office 365 for business or Microsoft 365 Business subscription will automatically have security defaults turned on. This means that every user will have to set up MFA and install the Microsoft Authenticator app on their mobile device. For more information, see [Set up 2-step verification](https://support.office.com/article/ace1d096-61e5-449b-a875-58eb3d74de14).  
...
> [!NOTE]
> You must be an global admin to set up or modify MFA. <br><br>
