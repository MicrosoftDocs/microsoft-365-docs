...
- If you have legacy per person MFA turned on, [turn it off](#turn-off-per-person-mfa).
- Make sure [modern authentication is turned on](#turn-on-modern-authentication-for-your-organization).
