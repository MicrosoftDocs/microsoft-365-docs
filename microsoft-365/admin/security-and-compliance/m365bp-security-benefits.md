...
Microsoft 365 Business Premium is a complete productivity and security solution for small and medium-sized businesses. It provides comprehensive cloud productivity and security and is designed especially for small and medium-sized businesses (up to 300 users). With Microsoft 365 Business Premium, you can:

- **Enable users to be connected and productive**, whether they're working on site or remotely, with best-in-class collaboration tools like [Microsoft Teams](/microsoft-365/business-premium/create-teams-for-collaboration).
- **Provide users with secure access to their business data and apps**, and help ensure that only authorized personnel can access confidential work data.
...
Microsoft 365 Business Premium offers you one comprehensive solution for productivity and security. You have everything you need in one place for administration, billing, and 24x7 support, while reducing cost and complexity for your business.

For instructions to secure your business, see [Microsoft 365 for business security best practices](m365b-security-best-practices.md).

## Video: Top five benefits of Microsoft 365 Business Premium

Watch the following video to see how Microsoft 365 Business Premium helps your business be more productive and secure:

> [!VIDEO https://learn-video.azurefd.net/vod/player?id=6f3cae8f-688c-46f3-9987-cfcf3168bf97]

> [!TIP]
> For detailed information about what's included in Microsoft 365 Business Premium, see the [Microsoft 365 User Subscription Suites for Small and Medium-sized Businesses](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RWR6bM).

## Configure security protection in Microsoft 365 Business Premium

After you complete the basic setup process for [Microsoft 365 Business Premium](/microsoft-365/business-premium/m365-business-premium-setup) (or [Microsoft 365 for Campaigns](/microsoft-365/business-premium/m365-campaigns-setup)), your next step is to set up and configure your security protection.
...
For more information, see [Microsoft 365 for business security overview](m365b-security-overview.md)
