...
#### Microsoft 365 features that can help
You can use [Microsoft Data Loss Prevention (DLP)](set-up-compliance.md#set-up-dlp-features) to help to protect your business's sensitive information. You can [set up a DLP policy](/microsoft-365/compliance/create-a-dlp-policy-from-a-template) that uses the [GDPR template](/microsoft-365/compliance/what-the-dlp-policy-templates-include#general-data-protection-regulation-gdpr).
