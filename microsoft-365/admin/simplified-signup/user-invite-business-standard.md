...
## Move files from Microsoft 365 personal to Microsoft 365 for business
...
## Move OneDrive files to your new OneDrive for work folder
...
- Another way to move your files from one OneDrive account to another is to use Mover. See this page for more info.
