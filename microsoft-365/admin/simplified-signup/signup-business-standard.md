...
This option does'nt provide branded email, admin control for use of the services by other users, or industry specific compliance support. **Subscribers don't have any access or control over other users’ (employees) usage or documents under this option, and users may choose not to transfer data created in storage such as OneDrive or Teams to your upgraded, enterprise-level domain account should you not choose option 2 immediately.**
