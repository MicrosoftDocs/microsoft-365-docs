---
title: "Get help with Microsoft 365 domains"
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
description: "Get started using your own domain for email, websites, and accounts in Microsoft 365. Learn about domains, make changes to your domain, integrate email and websites, and get tools and tips."
---

# Get help with Microsoft 365 domains

Use these resources to get started using your own domain for email, websites, and accounts in Microsoft 365. 
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Add your users and domain to Microsoft 365</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Quickly add a GoDaddy domain to Microsoft 365</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>Understand domains</h3>
                            ...
                            <p><a href="../setup/domains-faq.md">How DNS management works in Microsoft 365</a></p>
                            <p><a href="https://go.microsoft.com/fwlink/p/?LinkId=402693">Read the Microsoft 365 service description for domains</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>Get started</h3>
                            ...
                            <p><a href="domain-connect.md">Quickly add a GoDaddy domain to Microsoft 365</a></p>
                            <p>Get step-by-step help to <a href="create-dns-records-at-any-dns-hosting-provider.md">add the required DNS records for Microsoft 365 services</a></p>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Create DNS records for Microsoft 365</h3>
                            ...
                            <P><a href="create-dns-records-at-any-dns-hosting-provider.md">Create DNS records for Microsoft 365 when you manage your DNS records</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Change nameservers to Microsoft 365</h3>
                            <p><a href="../dns/change-nameservers-at-1-1-internet.md">Change nameservers to set up Microsoft 365 with 1&1 IONOS</a></p>
                            <p><a href="../dns/change-nameservers-at-network-solutions.md">Change nameservers to set up Microsoft 365 with Network Solutions</a></p>
                            <p><a href="domain-connect.md">Quickly add a GoDaddy domain to Microsoft 365</a></p>
                            <p><b>Help for many more popular domain registrars:</b></P> 
                            <p><a href="../get-help-with-domains/set-up-your-domain-host-specific-instructions.md">Change nameservers to Microsoft 365 so records are set up for you</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>Make changes</h3>
                            ...
                            <p><a href="../dns/add-or-edit-custom-dns-records.md">Add or edit custom DNS records in Microsoft 365</a></p>
                            ...
                            <p><a href="https://docs.microsoft.com/office365/enterprise/office-365-integration">Microsoft 365 integration with on-premises environments</a></p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>More videos</h3>
                            <p><a href="../dns/create-dns-records-at-godaddy.md">Set up a GoDaddy domain in Microsoft 365</a></p>
                    </div>
                </div>
            </div>
        </div>
