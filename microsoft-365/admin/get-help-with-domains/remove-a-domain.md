...
> [!NOTE]
> You can't remove the [".onmicrosoft.com"](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq) domain from your account. When you remove a domain, Office 365 user accounts will revert back to the .onmicrosoft.com address as the Primary SMTP/UserprincipalName.
