...
|Cancel the subscription for the plan you're done with by calling Microsoft Support for Microsoft 365.  <br/> | Verify that your new subscription is working and all data has been transferred.  <br/>  [Contact customer support]([Get support](../get-help-support.md)) to cancel your old subscription.  <br/> |
