...
|---------|---------|
|Billing admin     |   Assign the Billing admin role to users who make purchases, manage subscriptions and service requests, and monitor service health. Billing admins cannot assign licenses; you must be at least a License or User Administrator to assign licenses.<br><br> Billing admins also can:<br> &bull; Manage all aspects of billing<br> &bull; Create and manage support tickets in the Azure portal <br/><br/> **Note:** Only Global admins can view and manage subscriptions purchased through a Partner.|
