 ...
 **Tip**: When you assign someone to the Exchange Administrator role, it is recommended to assign them to the Service Support Administrator role. This way they can see important information in the Microsoft 365 admin center, such as the health of the Exchange Online service, and change and release notifications.
