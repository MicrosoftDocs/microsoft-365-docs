...
3. In the first box, type the first part of the new email address. If you added your own domain to Office 365, choose the domain for the new email alias by using the drop-down list. 
