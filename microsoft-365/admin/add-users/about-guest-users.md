...
- Viva Engage - [Work with external groups in Viva Engage networks not aligned to native mode](/yammer/work-with-external-users/create-and-manage-external-groups).
