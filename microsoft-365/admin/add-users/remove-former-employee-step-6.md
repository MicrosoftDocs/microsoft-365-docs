...
If you don't want to pay for a license after someone leaves your organization, you need to remove their Microsoft 365 license and then delete it from your subscription. You can assign a license to another user if you don't delete it. Before you remove a license you MUST remove all holds for the user. For more information regarding holds: [Remove an In-Place Hold in Exchange Online](https://learn.microsoft.com/exchange/security-and-compliance/create-or-remove-in-place-holds)
