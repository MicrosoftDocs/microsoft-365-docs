...
2. On the **Prevent leaks of sensitive data** page, accept the defaults to turn on Microsoft Purview Microsoft Purview Data Loss Prevention to track sensitive data in Office apps and prevent the accidental sharing of these outside your organization.
