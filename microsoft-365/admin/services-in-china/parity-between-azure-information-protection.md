...
> [!TIP]
> When [installing the scanner](/azure/information-protection/deploy-aip-scanner-configure-install#install-the-scanner), you can associate multiple scanner nodes to the same cluster, and then have all scanners in the cluster work together to perform your scans.
>
