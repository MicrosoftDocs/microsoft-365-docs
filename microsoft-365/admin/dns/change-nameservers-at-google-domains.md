---
title: "Change nameservers to set up Microsoft 365 with Google Domains"
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
description: "Learn how you can set up Microsoft 365 to manage the DNS records of your custom domain at Google Domains."
---

# Change nameservers to set up Microsoft 365 with Google Domains

 **[Check the Domains FAQ](../setup/domains-faq.md)** if you don't find what you're looking for. 
  
Follow these instructions if you want Microsoft 365 to manage your Microsoft 365 DNS records for you. (If you prefer, you can [manage all your Microsoft 365 DNS records at Google Domains](create-dns-records-at-google-domains.md).)
...
|@  <br/> |TXT  <br/> |1H  <br/> |MS=ms *XXXXXXXX* <br/> **Note:** This is an example. Use your specific **Destination or Points to Address** value here, from the table in Microsoft 365. [How do I find this?](../get-help-with-domains/information-for-dns-records.md)       <br/>  |
