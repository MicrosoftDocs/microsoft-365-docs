---
title: "Change nameservers to set up Microsoft 365 with Network Solutions"
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
description: "Learn to set up your Microsoft 365 custom domain with Network Solutions if you want Microsoft 365 to manage your DNS records. "
---

# Change nameservers to set up Microsoft 365 with Network Solutions

 **[Check the Domains FAQ](../setup/domains-faq.md)** if you don't find what you're looking for.
  
Follow these instructions if you want Microsoft 365 to manage your Microsoft 365 DNS records for you. (If you prefer, you can [manage all your Microsoft 365 DNS records at Network Solutions](create-dns-records-at-network-solutions.md).)
...
Ready to change your NS records so Microsoft 365 can set up your domain? Follow the steps below or [watch the video (start at 2:23)](https://support.office.com/article/Video-Change-nameservers-to-set-up-Office-365-with-Network-Solutions-69b092e3-c026-4d19-a7d0-16cdb2d8b261?ui=en-US&amp;rs=en-US&amp;ad=US).
