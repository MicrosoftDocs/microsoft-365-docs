---
title: "Change nameservers to set up Microsoft 365 with MyDomain"
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
description: "Learn how you can set up Microsoft 365 to manage the DNS records of your custom domain at MyDomain."
---

# Change nameservers to set up Microsoft 365 with MyDomain

 **[Check the Domains FAQ](../setup/domains-faq.md)** if you don't find what you're looking for.
  
Follow these instructions if you want Microsoft 365 to manage your Microsoft 365 DNS records for you. (If you prefer, you can [manage all your Microsoft 365 DNS records at MyDomain](create-dns-records-at-mydomain.md).)
