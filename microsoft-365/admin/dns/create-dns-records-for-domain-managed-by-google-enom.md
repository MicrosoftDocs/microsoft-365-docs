...
To migrate your mail accounts to Microsoft 365, you need to create a DNS record at your domain registrar.
...
11. In the boxes for the new record, type or copy and paste the values from the following table.
    ...
    > [!NOTE]
    > This is an example. Use your specific **Destination or Points to Address** value here, from the table in Microsoft 365. 
