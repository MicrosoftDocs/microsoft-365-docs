---
title: "Create DNS records at Register365"
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
description: "Learn to verify your domain and set up DNS records for email, Skype for Business Online, and other services at Register365 for Microsoft 365."
---

# Create DNS records at Register365
...
- [Add the six CNAME records that are required for Microsoft 365](#add-the-six-cname-records-that-are-required-for-office-365)
...
After you add these records at Microsoft 365, your domain will be set up to work with Microsoft 365 services.
...
3. On the **Add/Modify DNS Zone** page, in the **A, CNAME, AAAA, TXT and NS records** section, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |:-----|:-----|:-----|
    |(Leave this field empty.)  <br/> |TXT  <br/> |MS=ms *XXXXXXXX*  <br/> **Note:** This is an example. Use your specific **Destination or Points to Address** value here, from the table in Microsoft 365.           [How do I find this?](../get-help-with-domains/information-for-dns-records.md)          |
