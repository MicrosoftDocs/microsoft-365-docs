...
Microsoft Managed Desktop recommends adjusting guest invite settings, as the default setting allows all users and guests in your directory to invite guests.
