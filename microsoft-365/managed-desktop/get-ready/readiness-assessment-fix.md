...
Allow access to unlicensed admins should be enabled. For steps, see [Prerequisites for guest accounts](https://docs.microsoft.com/microsoft-365/managed-desktop/get-ready/guest-accounts?view=o365-worldwide)
