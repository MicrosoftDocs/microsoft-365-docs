...
Microsoft Managed Desktop can work with brand-new devices or you re-use devices you might already have (which will re-image them). You can register devices by using the Managed Desktop Admin Center or save time and gain flexibility by using an API.

## Prepare to register devices

If you haven't already obtained the devices you want to use, see [Order devices](get-started/devices.md) for options to get some. In either case, you should check [Microsoft Managed Desktop devices](device-list.md) to ensure that they are supported.
