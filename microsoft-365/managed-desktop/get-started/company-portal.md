...
- How to send requests to IT administrators for applications that are not currently available. Documentation on this can be found [here in the Intune user help documentation](https://docs.microsoft.com/intune-user-help/install-apps-cpapp-windows#request-an-app-for-work-or-school).  
