...
Admins should verify that they can meet these prerequisites:
...
- **Company Portal** -  The Company Portal must be available in your tenant for your users to install these applications. If the Company Portal isn’t deployed in your tenant, see [Company Portal](https://aka.ms/mmdportal).
...
Once assigned to these groups, applications will be available in the Company Portal. Your users can install the apps from Company Portal. It may take a few minutes to sync.

## Communicate changes
It’s important for the IT administrator to let their users know how to instal Project and Visio. This includes: 
