...
- Conditional Access policies: for any new conditional access policies related to Azure AD, Intune and Microsoft Defender Advanced Threat Protection created by admins in your company after Microsoft Managed Desktop enrollment, exclude the **Modern Workplace Service Accounts** Azure AD group. For steps, see [Conditional Access: Users and groups](https://docs.microsoft.com/azure/active-directory/conditional-access/concept-conditional-access-users-groups). Microsoft Managed Desktop maintains separate conditional access policies to restrict access to these accounts. Go to Conditional Access in Endpoint Security, Microsoft Endpoint Manager to review the Microsoft Managed Desktop conditional access policy (named, Modern Workplace – Secure Workstation). Additionally, do not modify any Azure AD Conditional Access policies created by Microsoft Managed Desktop that have "Modern Workplace" in the name.

- Multifactor authentication: for any new multifactor authentication requirements in conditional access policies related to Azure AD, Intune and Microsoft Defender Advanced Threat Protection created by admins in your company after Microsoft Managed Desktop enrollment, exclude the **Modern Workplace Service Accounts** Azure AD group. For steps, see [Conditional Access: Users and groups](https://docs.microsoft.com/azure/active-directory/conditional-access/concept-conditional-access-users-groups). Microsoft Managed Desktop maintains separate conditional access policies to restrict access to members of this group. Go to Conditional Access in Endpoint Security, Microsoft Endpoint Manager to review the Microsoft Managed Desktop conditional access policy (named, Modern Workplace - ). 
