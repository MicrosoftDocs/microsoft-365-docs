...
- Autopilot deployment profile: for Autopilot profiles created by admins in your company, exclude the **Modern Workplace Devices -All**  Azure AD group. For steps, see [Enroll Windows devices in Intune by using Windows Autopilot](https://docs.microsoft.com/mem/autopilot/enrollment-autopilot). Do not exclude Modern Workplace Devices -All Azure AD group from Microsoft Managed Desktop created deployment policies which have Modern Workplacein the name (e.g. Modern Workplace Autopilot Profile). 
- Conditional Access policies: for Conditional Access policies created by admins in your company, exclude the **Modern Workplace Service Accounts** Azure AD group. For steps, see [Conditional Access: Users and groups](https://docs.microsoft.com/azure/active-directory/conditional-access/concept-conditional-access-users-groups). Do not exclude Modern Workplace Devices -All Azure AD group from Microsoft Managed Desktop created conditional access policies, which have Modern Workplace in the name (e.g. Modern Workplace Secure Workstation).
...
- Security baseline: for Security Baseline policies created by admins in your company, exclude the **Modern Workplace Devices -All**  Azure AD group. For steps, see [Use security baselines to configure Windows 10 devices in Intune](https://docs.microsoft.com/mem/intune/protect/security-baselines). Do not exclude Modern Workplace Devices -All Azure AD group from Microsoft Managed Desktop created security baseline policies, which have Modern Workplace in the name (e.g. Modern Workplace Security Baseline).
- Windows 10 update ring: for Windows 10 update ring policies created by admins in your company, exclude the **Modern Workplace Devices -All**  Azure AD group. For steps, see [Manage Windows 10 software updates in Intune](https://docs.microsoft.com/mem/intune/protect/windows-update-for-business-configure). Do not exclude Modern Workplace Devices -All Azure AD group from Microsoft Managed Desktop created Windows 10 update ring policies, which have Modern Workplace in the name (e.g. Modern Workplace Update policy).
