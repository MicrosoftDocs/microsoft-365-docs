...
If you need to pause or roll back Microsoft 365 App update for any reason, file an [admin support request](admin-support.md) through the Microsoft Managed Desktop portal.
