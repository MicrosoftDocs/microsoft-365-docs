...
4. On the product details, select **Get the App**.  Click Manage, then select Private store availability to choose which groups of users in your organization this app can use this app.
