...
**Configure and upload the app**
Next, configure your app and upload it to Microsoft Managed Desktop. There are different steps for configuring and uploading LOB apps and Windows apps. 
- Line-of-business apps - For more information on adding and configuring line-of-business apps, see [Add a Windows line-of-business app to Microsoft Intune](https://docs.microsoft.com/intune/lob-apps-windows).
- Windows apps (Win32) - For more information on adding and configuring Windows apps, see [Win32 app management](https://docs.microsoft.com/intune/apps-win32-app-management). 
...
--- | --- | ---
Available |  The app will be available from Company Portal app or website, or Microsoft Store for Business. | MMD – PowerBi Desktop – Available
