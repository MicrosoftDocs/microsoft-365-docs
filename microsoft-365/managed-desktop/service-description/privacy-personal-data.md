...
- Microsoft Managed Desktop uses Modern Management {WHAT DOES THIS MEAN?} for managing the enrolled devices. As part of that, the devices must be enrolled in the tenant’s Azure Active Directory.
