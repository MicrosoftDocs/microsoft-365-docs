...
The device profile you select will be applied to all devices you select in the first step. To move devices to different profiles, you’ll need to repeat this process for each device profile. 
...
2. Select the check boxes for the devices want to modify. 
3. Select **Change device profile**; a fly-in opens.
4. Use the drop-down menu to select the new device profile.  

{I THINK THIS UI IS CHANGING. ALSO DO YOU HAVE TO HIT SAVE OR SOMETHING OR DOES THE CHANGE HAPPEN AS SOON AS YOU SELECT THE NEW PROFILE?}
