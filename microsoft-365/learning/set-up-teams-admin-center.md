...
The Teams administrator needs to perform certain steps to enable Viva Learning (Preview) for their users in the tenant. These steps vary based on how the tenant is enabled:  *Public Preview* or *Private Preview* (or Beta).
...
3.	Notify users who will test Viva Learning (Preview) to switch their build client to Public Preview for Teams. Steps for this are in the later section on this page. [Provide Hyperlinks]

> [!IMPORTANT]
> For Public Preview tenants, Viva Learning (Preview) will not be displayed in **Managed apps** in the Teams admin center until final product release. However, enabled Public Preview users can find Viva Learning (Preview) in the app store and use it, once the correct policies and permissions have been set up.
