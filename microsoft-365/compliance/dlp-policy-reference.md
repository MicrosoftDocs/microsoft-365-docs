...
1. [Sensitive Infomration Type Limits](/compliance/sit-limits.md) - these limits apply to all Microsoft Purview policies that use sensitive information types.
