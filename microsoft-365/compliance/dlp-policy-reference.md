...
- Content contains
- Document or attachment is password protected (.pdf, Office files and Symantec PGP encrypted files are fully supported).This predicate detects both open protected files and digital rights managed (DRM) encrypted/ permission protected files.
