...
> <sup>6</sup> Indexing limits are based per organization per day. Alternatively, you can select multiple custodians and then click **Update index** to avoid creating one index job per custodian. <br/>
