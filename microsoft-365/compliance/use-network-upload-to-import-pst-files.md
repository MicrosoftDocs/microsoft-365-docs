...
The Microsoft Azure Storage Explorer desktop standalone application is generally available. You can download the latest version using the link provided below. There is an option of using Azure Storage Explorer via Azure Portal. However, it is currently in preview.
