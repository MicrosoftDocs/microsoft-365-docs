...
3. The Webpage Capture connector that you create in the Microsoft Purview compliance portal, connects to the Veritas Merge1 site every day and transfers the webpage items to a secure Azure Storage location in the Microsoft cloud.
...
To map users and complete the connector setup in the Microsoft Purview compliance portal, follow the steps below:
...
After you create the Webpage Capture connector, you can view the connector status in the Microsoft Purview compliance portal.
