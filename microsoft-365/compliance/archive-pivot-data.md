...
# Set up a connector to archive Pivot data (preview)
...
2. Click the **Connectors** tab and then select the **Pivot** connector to display the flyout page, which contains the properties and information about the connector.
