...
3. The Pivot connector that you create in the Microsoft Purview portal, connects to the Veritas Merge1 site every day and transfers the Pivot items to a secure Azure Storage location in the Microsoft cloud.
...
After you create the Pivot connector, you can view the connector status in the Microsoft Purview portal.
