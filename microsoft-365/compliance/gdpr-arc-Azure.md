...
keywords: ARC Microsoft 365, Microsoft 365 Education, Microsoft 365 documentation, GDPR
author: BrendaCarter
...
•	Azure Data Subject Requests for the GDPR [9] see Step 4: Restrict
...
•	Azure Data Subject Requests for the GDPR [9] see Step 6: Export
•	Privacy and personal data in Intune [15] see Audit, export, or delete personal data in Intune
...
•	Microsoft Online Services Terms, Data Protection Terms, see Processing of Personal Data; GDPR [1]
•	Key Information from Azure for Customer Data Protection Impact Assessments [11]
•	Privacy and personal data in Intune [15] see Data collection in Intune
...
•	Azure Data Subject Requests for the GDPR see Step1: Discover
...
•	Azure Data Subject Requests for the GDPR [9] see Step 3: Rectify
...
##### Supporting Microsoft Documentation:  
An overview of the role of Microsoft's Data Protection Officer, the nature of his duties, reporting structure and contact information. 
•	Microsoft Cloud Security Policy [4] see 03. Human Resources Security
•	FedRAMP Moderate FedRAMP System Security Plan [3] see 13.2 Awareness and Training (AT)
...
•	Microsoft Azure Data Security (Data Cleansing and Leakage) [5]
...
•	Azure and Breach Notification Under the GDPR [10]
...
### 6.	Bibliography of Resources and Links<p/>
1.	Online Services Terms http://www.microsoftvolumelicensing.com/Downloader.aspx?DocumentId=13754
2.	Azure Security Documentation on docs.microsoft.com https://docs.microsoft.com/en-us/azure/security/, see Governance and compliance, GDPR
...
8.	Contracts for sub-processors: Contracting with Microsoft https://www.microsoft.com/en-us/procurement/supplier-contracting.aspx
9.	Azure Data Subject Requests for the GDPR https://docs.microsoft.com/en-us/microsoft-365/compliance/gdpr-dsr-azure
10.	Azure and Breach Notification Under the GDPR https://docs.microsoft.com/en-us/microsoft-365/compliance/gdpr-breach-azure
11.	Key Information from Azure for Customer Data Protection Impact Assessments [Link TBD]
...
14.	Microsoft Trust Center Compliance offerings https://www.microsoft.com/en-us/trustcenter/compliance/complianceofferings
15.	Privacy and personal data in Intune https://review.docs.microsoft.com/en-us/intune/privacy-personal-data
16.	Compliance Manager https://servicetrust.microsoft.com/ComplianceManager
