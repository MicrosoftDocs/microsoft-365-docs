...
description: "Admins can set up a connector to import and archive Reuters Eikon data from Globanet in Microsoft 365. This lets you archive data from third-party data sources in Microsoft 365 so you can use compliance features such as legal hold, content search, and retention policies to manage your organization's third-party data."
---

# Set up a connector to archive Reuters Eikon data

Microsoft 365 lets administrators import and archive third-party data from financial collaboration platforms to mailboxes in your Microsoft 365 organization. Globanet provides you with a [Reuters Eikon](https://globanet.com/eikon/) connector that is configured to capture items from the third-party data source (on a regular basis) and then import those items to Microsoft 365. The connector converts the content from the Reuters platform, such as person-to-person messages, group chats, attachments, and disclaimers from users' Reuters Eikon account to an email message format and then imports those items to user mailboxes in Microsoft 365.

Once archived, Eikon Messenger communications can be retained, supervised for compliance, and searched for eDiscovery and internal Information Governance.

## Overview of archiving Reuters Eikon
...
![Archiving workflow for EML data](../media/ReutersEikonConnectorWorkflow.png)

1. Your organization works with Reuters Eikon to set up and configure a Reuters Eikon site.

2. Once every 24 hours, the content items from Reuters Eikon are copied to the Globanet Merge1 site. The connector also converts the content of the platform to an email message format.
...
4. The connector delivers the converted content items to the mailboxes of specific users using the value of the *Email* property of the automatic user mapping as described in Step 3. A new subfolder in the Inbox folder named **Reuters Eikon** will be created in the user mailboxes, and the content items will be imported to that folder. The connector does this by using the value of the *Email* property. Every content item contains this property, which is populated with the email address of every participant of the content item.

## Before you begin

An implementation step required to archive Reuters Eikon data is external to Microsoft 365 and must be completed before you can create the connector in the compliance center.

1. Create a Merge1 account by accepting their terms and conditions for the Reuters Eikon connector. Here you will need to contact [Globanet Customer Support](https://globanet.com/contact-us).
...
4. Select the **Reuters Eikon** option from the list.
...
## Step 2: Configure Reuters Eikon

The second step is to configure the Reuters Eikon connector in the Merge1 site. For more details on how to configure the Reuters Eikon connector in the Globanet Merge1 site, see [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Reuters%20Eikon%20User%20Guide%20.pdf).
