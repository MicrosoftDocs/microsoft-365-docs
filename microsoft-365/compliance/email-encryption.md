...
>[!IMPORTANT]
>Multiple email encryption technologies should not be applied to the same email message. Some email clients, such as Outlook for Mac, Outlook for iOS, and Outlook for Android, are not able to open messages with multiple email encryption technologies applied.
