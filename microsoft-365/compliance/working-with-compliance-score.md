...
2. On the row of your intended solution, under the **Open solution** column, select **Open**. You'll see the solution or location in the Microsoft 365 Security & Compliance Center where you can take the recommended action.
