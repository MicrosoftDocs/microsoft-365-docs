...
**Notes**:
<!-- check to see if this note contradicts the guidance in "customize a built in sensitive information type https://docs.microsoft.com/en-us/office365/compliance/customize-a-built-in-sensitive-information-type it sure seems like it does-->
