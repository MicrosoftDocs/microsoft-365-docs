...
> [!NOTE]
> In Outlook on the Web, to be able to see Override in Policy Tip, the DLP policy needs to be turned on since it won't be displayed in Test Mode (with notifications). In DLP configuration, some restriction action should also be in place.
