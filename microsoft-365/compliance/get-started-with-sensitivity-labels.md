...
|Discover, label, and protect files stored in data stores that are on premises |[Deploying the information protection scanner to automatically classify and protect files](/azure/information-protection/deploy-aip-scanner)|
