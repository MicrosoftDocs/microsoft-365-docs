...
Compliance Score gives you an out-of-the-box score based on the Microsoft 365 data protection baseline, which is a set of controls that includes common industry regulations and standards. While this score is a good starting point for assessing your compliance posture, Compliance Score becomes more relevant and powerful for you once you add assessments that are more relevant to your organization. 
...
A control defines how you assess and manage system configuration, organizational process, people accountability and more, to meet a specific requirement of a regulation, a standard, or a internal policy.
