...
|---|---|
| Add external data | NEED DESCRIPTION FROM PM |
...
| Delete items from original locations (preview) | NEED DESCRIPTION FROM PM |
...
| Purge data (Standard) | NEED DESCRIPTION FROM PM |
