...
**Azure Information Protection Unified Labeling Client** versions 2.14.89.0 or later. Download and install the Unified Labeling client from the [Microsoft download center](https://www.microsoft.com/download/details.aspx?id=53018).
...
Configuring DKE for supported scenarios will create a warning in the label configuration experience. For unsupported scenarios (EO/DNF), there is no warning in label configuration experience.
