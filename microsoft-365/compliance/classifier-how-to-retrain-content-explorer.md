...
> [!IMPORTANT]
> You provide feedback in content explorer for retention policies that auto-apply retention labels to Exchange items and uses the classifier as a condition. **If you don't have a retention policy that auto-applies a retention label to Exchange items and      uses a classifier as a condition, stop here.**
...
5. Choose **Improve classification**.
