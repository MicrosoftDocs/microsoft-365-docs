...
3. To resend a legal hold notice to a custodian, select the communication and click the **Re-Send** option.

If a custodian hasn't acknowledged the hold notification, then the reminder and escalation workflow is restarted. If a custodian has acknowledged the hold notice, the custodian will just receive a copy of the initial hold notice.
