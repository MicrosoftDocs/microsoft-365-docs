...
> If you do not want to use this feature, you must file a request with Microsoft Support. This will disable the display of your sensitive data that is not used in any labeling policies within Content Explorer. You may additionally disable scanning of your data as well. Please note that if scanning is turned off, sensitivity labeling and DLP policies with those classifiers will not work
