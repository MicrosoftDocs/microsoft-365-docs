...
| **ht**  | Indicates the hold type; **0** for LitigationHold, **1** for InPlaceHold, **2** for ComplianceTagHold, **3** for DelayReleaseHold, **4** for OrganizationRetention, **5** for CompliancePolicy, **6** for SubstrateAppPolicy, and **7** for SharepointPolicy. |
