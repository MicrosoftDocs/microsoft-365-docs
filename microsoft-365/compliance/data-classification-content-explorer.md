...
There are two roles that grant access to content explorer and it can be granted using the Microsoft Security and Complaince center(https://protection.office.com/permissions0:
