...
The scanner now has a token to authenticate to Azure AD. This token can be valid for a maximum of two years but is set according to your configuration of the **Web app /API** client secret in Azure AD. When the token expires, you must repeat this procedure.
