...
Unlike [sensitivity labels](sensitivity.md), you can't configure priorities for retention labels. Use the following information to understand whether a retention label that's applied to items can be replaced or removed.
