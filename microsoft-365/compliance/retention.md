...
2. You create and configure a retention label that automatically retains content for ten years. You add this label to a label policy that you publish to all or specific SharePoint and Microsoft 365 Groups so that a site admin can apply it as a default label to be inherited by all items in specific document libraries.
