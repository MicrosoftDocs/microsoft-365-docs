...
> [!NOTE]
> For US Government Community (GCC and GCC-HC) tenants, sensitivity labels are currently supported only for the Azure Information Protection unified labeling client and scanner. For more information, see the blog post announcement, [Announcing General Availability of Unified Labeling in GCC and GCC-H Environments](https://techcommunity.microsoft.com/t5/azure-information-protection/announcing-general-availability-of-unified-labeling-in-gcc-and/ba-p/1563215).
