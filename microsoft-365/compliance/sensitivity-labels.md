...
The following example shows the available sensitivity labels in Excel. You can access these from the **Home** tab on the Ribbon. In this example, the applied label displays on the status bar:
