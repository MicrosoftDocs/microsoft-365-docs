...
> [!NOTE]
> In addition to applying sensitivity labels to emails and documents, you can also [use sensitivity labels with Microsoft Teams, Office 365 groups, and SharePoint sites (public preview)](sensitivity-labels-teams-groups-sites.md).
