...
3. The Zoom Meetings connector that you create in the Microsoft Purview compliance portal, connects to the Veritas Merge1 every day, and transfers the meeting messages to a secure Azure Storage location in the Microsoft cloud.
...
The first step is to access the **Data Connectors** in the Microsoft Purview compliance portal and create a Zoom Meetings connector.
...
After you create the Zoom Meetings connector, you can view the connector status in the Microsoft Purview compliance portal.
