...
|:--|:--|:--|:--|:--|
|**Outlook On the Web**|:::image type="icon" source="../media/rightmrk.png" border="false":::|Subset, see [Data loss prevention policy tip reference for Outlook on the Web](dlp-owa-policy-tips.md) |Subset, see [Data loss prevention policy tip reference for Outlook on the Web](dlp-owa-policy-tips.md)|For details, see [Data loss prevention policy tip reference for Outlook on the Web](dlp-owa-policy-tips.md)|
