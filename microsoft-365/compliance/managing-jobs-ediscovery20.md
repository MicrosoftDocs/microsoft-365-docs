...
|Adding remediated data to a review set | Data with processing errors is remediated and loaded back into a review set. For more information, see:</br></br>• [Error remediation when processing data](error-remediation.md)</br>• [Single item error remediation](single-item-error-remediation.md)| 
