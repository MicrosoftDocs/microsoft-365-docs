...
- Fingerprints are stored in a separate rule pack which has a maximum size limit of 150KB. Given, this limit you will be able to create around 50 fingerprints per tenant.
