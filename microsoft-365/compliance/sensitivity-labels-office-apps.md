...
|[Let users assign permissions](encryption-sensitivity-labels.md#let-users-assign-permissions)                     | Preview: In [Monthly Channel (Targeted)]((https://office.com/insider))            | Preview: In [Office Insider](https://office.com/insider)        | Under review   | Under review         | Under review                                                        |
