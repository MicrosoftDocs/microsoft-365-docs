...
- For built-in labeling:
    ...
    - **S/MIME**: If the highest priority label applies S/MIME protection, and Outlook doesn't yet support this feature, no label or protection is selected for the email message.
