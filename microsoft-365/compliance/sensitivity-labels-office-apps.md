...
|Capability                                                                                                        |Office version: <br />Windows |Office version: <br />Mac |Mobile operating system version: <br />iOS    |Mobile operating system version: <br />Android      |Web                                                         |
|------------------------------------------------------------------------------------------------------------------|----------------|------------|-------|-------------|------------------------------------------------------------|
...
|Capability                                                                                                        |Office version: <br />Outlook for Windows |Office version:<br /> Outlook for Mac  |Mobile operating system version: <br />Outlook on iOS |Mobile operating system version: <br />Outlook on Android |Outlook on the web |
|------------------------------------------------------------------------------------------------------------------|---------------------------|------------------------|---------------|-------------------|-------------------|
