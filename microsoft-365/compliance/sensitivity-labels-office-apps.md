...
<sup>\*</sup>
Version numbers are for the **Current Channel**. Usually, newly released capabilities carry forward into the Monthly Enterprise Channel and then Semi-Annual Enterprise Channel. However, this isn't always the case because each update channel has release criteria for new features. [Learn more](/deployoffice/overview-update-channels)
<br /><br />
<sup>\*\*</sup>
