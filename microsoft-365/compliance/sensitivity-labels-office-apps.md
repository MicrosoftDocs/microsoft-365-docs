...
> [!IMPORTANT]
> Currently, not all apps on all platforms support dynamic content markings that you can specify for your headers, footers, and watermarks. These apps will apply the markings as the original text specified for the label configuration, rather than resolving the variables.
> 
