...
|[Let users assign permissions: Do Not Forward](encryption-sensitivity-labels.md#let-users-assign-permissions)                     | 1910+                     | 16.21+                 | 4.7.1+         | 4.0.39+           | Yes               |
|[Let users assign permissions: Encrypt-only](encryption-sensitivity-labels.md#let-users-assign-permissions)                     |xxx | xx.xx+   | Under review   | Under review         | Rolling out                                                        |
