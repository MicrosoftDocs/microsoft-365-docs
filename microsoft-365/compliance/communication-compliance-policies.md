...
| **Harassment** | Detects potentially offensive content in multiple languages that targets people regarding race, color, religion, national origin. |Content in .msg, .docx, .pdf, .txt, .rtf, .jpeg, .jpg, .png, .gif, .bmp, .svg files* |
...
| **Profanity** | Detects potentially profane content in multiple languages that would likely offend most people. |Content in .msg, .docx, .pdf, .txt, .rtf, .jpeg, .jpg, .png, .gif, .bmp, .svg files* |
...
| **Threat** | Detects potential threatening content in multiple languages aimed at committing violence or physical harm to a person or property. |Content in .msg, .docx, .pdf, .txt, .rtf, .jpeg, .jpg, .png, .gif, .bmp, .svg files* |
