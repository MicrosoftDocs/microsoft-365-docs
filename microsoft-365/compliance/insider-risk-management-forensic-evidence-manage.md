...
> [!NOTE]
> The commerce platform has [a legacy billing platform and a modern billing platform](https://partner.microsoft.com/partnership/new-commerce). Insider risk management billing is designed to work with the modern billing platform. Purchased capacity is metered on a monthly basis, starting and resetting on the first of the month. Any capacity purchased during the month can be fully used in that month and will be reset on the first of the next month. You can continue to [use the capacity until the license expiration date](https://partner.microsoft.com/partnership/new-commerce).