...
If you've selected the option to capture any security-related activity performed by users in forensic evidence policies, you'll view the clips for individual users on the **User activity report** dashboard.
