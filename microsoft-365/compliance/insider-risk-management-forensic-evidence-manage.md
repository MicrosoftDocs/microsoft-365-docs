...
> [!NOTE]
> The commerce platform has [a legacy billing platform and a modern billing platform](https://partner.microsoft.com/en-us/partnership/new-commerce). The modern billing platform is based on the calendar month. It starts on the first day of the month and ends on the last day of the month. The legacy platform monthly billing cycle can start on any day of the month. For example, if your billing cycle starts on March 20, the monthly billing period ends on April 19. Insider risk management billing reports are designed to work with the modern billing platform. For that reason, if you're using the legacy platform, your usage might not be accurately reflected in the monthly usage reports. It's possible that you may have used less or more capacity, depending on your monthly billing date. This is particularly true for the first and last month.  