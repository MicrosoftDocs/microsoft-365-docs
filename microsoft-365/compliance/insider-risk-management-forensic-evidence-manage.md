...
> [!IMPORTANT]
> You must be assigned to both the *Insider Risk Management Investigators* role group and the *Insider Risk Management Admins* role group to view capture clips. You won't see the **Investigate forensic captures** button if you aren't a member of both role groups. [Learn more about role groups](insider-risk-management-configure.md#step-1-required-enable-permissions-for-insider-risk-management)
...
When you select the **Forensic evidence** tab, captures and associated information are displayed in a list.
...
You can use the filters above the capture clips list to filter for specific activities and information. 
...
Users assigned to the *Insider Risk Management Investigators* role group can delete individual clips from the captures clips list. To do this:
