...
description: "Learn how to set up and use a connector in the Microsoft Purview portal to import and archive data from Skype for Business to Microsoft 365."
---
...
3. The Skype for Business connector that you create in the Microsoft Purview portal, connects to the Veritas Merge1 site every day, and transfers the Skype for Business content to a secure Azure Storage location in the Microsoft cloud.
...
The first step is to access to the **Data Connectors** page in the Microsoft Purview portal and create a connector for Skype for Business data.
...
After you create the Skype for Business connector, you can view the connector status in the Microsoft Purview portal.
