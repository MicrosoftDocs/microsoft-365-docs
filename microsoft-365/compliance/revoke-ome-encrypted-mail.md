...
1. In the Microsoft 365 Defender portal, navigate to the **Message encryption report**. For information about this report, see [View email security reports in the Security &amp; Compliance Center](../security/office-365-security/reports-email-security.md).
