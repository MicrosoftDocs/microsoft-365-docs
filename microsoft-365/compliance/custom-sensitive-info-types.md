...
- MOE150
- MET150
description: Get an overview of custom sensitive information types, such as primary pattern, character proximity, and confidence level.
ms.custom: seo-marvel-apr2020
---

<!-- DEPRECATING< ALL THIS IS MOVED TO LEARN ABOUT TOPIC-->
