...
|[Azure Purview](/azure/purview/overview) |Identifies sensitive data and applies automatic labeling to any content in Azure Purview assets, such as Azure Blob Storage, Azure Files, Azure Data Lake Storage, and multi-cloud data sources. |[Labeling in Azure Purview](/azure/purview/create-sensitivity-label.md) |
