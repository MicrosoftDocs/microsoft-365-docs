...
|[Information protection scanner](deploy-aip-scanner.md)| Discovers, labels, and protects sensitive information that resides in data stores that are on premises. | [Configuring and installing the information protection scanner](deploy-aip-scanner.md-configure-install)|
