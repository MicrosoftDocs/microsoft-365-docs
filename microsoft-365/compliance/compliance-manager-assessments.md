...
> [!NOTE]
> Only users who hold a Global Administrator, Compliance Manager Assessors or  Compliance Manager Administration role can create and modify assessments. Learn more about [roles and permissions](compliance-manager-setup.md#set-user-permissions-and-assign-roles).
