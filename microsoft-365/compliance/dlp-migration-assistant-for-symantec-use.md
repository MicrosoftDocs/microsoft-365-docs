...
2. Enter your username and select **Login**.
      1. Enter your password in the browser window that opens and select **Sign in**.
         ...
         > [!NOTE]
         > Currently, this application uses Exchange Online PowerShell module. It still requires Basic authentication to be enabled in WinRM on the local computer. For more information, see [Prerequisites for the Exchange Online PowerShell module](https://learn.microsoft.com/en-us/powershell/exchange/exchange-online-powershell-v2#prerequisites-for-the-exchange-online-powershell-module).
