...
> [!TIP]
> If you are migrating records to Microsoft 365 and need to validate that files haven't been altered, see [Validating records after migrating to SharePoint or OneDrive](records-management.md#validating-records-after-migrating-to-sharepoint-or-onedrive).
