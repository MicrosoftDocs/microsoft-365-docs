...
2. **Understand retention labels and how retention works** for SharePoint and OneDrive, and for Exchange, because retention labels are used to declare records: [Learn about retention policies and retention labels](retention.md)
