...
3. The Slack DataParser connector that you create in the Microsoft Purview portal connects to DataParser and transfers the messages to a secure Azure Storage location in the Microsoft cloud.
...
The first step is to access to the Data connectors page in the Microsoft Purview portal and create a 17a-4 connector for Slack data.
...
After you create a Slack DataParser connector, you can view the connector status in the Microsoft Purview portal.
