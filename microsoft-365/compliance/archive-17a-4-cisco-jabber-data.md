...
The first step is to access to the Data connectors page in the Microsoft Purview compliance portal and create a 17a-4 connector for Cisco Jabber data.
...
After you create a Cisco Jabber DataParser connector, you can view the connector status in the Microsoft Purview compliance portal.
