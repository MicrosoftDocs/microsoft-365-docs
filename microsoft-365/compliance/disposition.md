...
> [!NOTE]
> Even a global admin needs the permissions from the **Disposition Management** role group. So if global admins need to access the disposition tab, add these users to the **Disposition Reviewers** role group. 
