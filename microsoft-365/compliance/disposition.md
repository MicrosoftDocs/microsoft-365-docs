...
- **Approve disposal**:
    ...
    The exact timing for the item to be permanently deleted depends on the workload. For more information, see [How retention settings work with content in place](retention.md#how-retention-settings-work-with-content-in-place).
