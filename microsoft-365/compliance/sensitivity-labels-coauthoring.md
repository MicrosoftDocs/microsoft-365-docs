...
1. Sign in to the Microsoft 365 compliance center as a global admin for your test tenant, using the following link:
    ...
    Before you continue, confirm you're signed in to a test tenant that won't affect your users: Select the circle with your account initials in the top right of the compliance center. 
