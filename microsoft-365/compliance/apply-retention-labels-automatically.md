...
- Items from Microsoft 365 Groups and OneDrive locations that are stored in [arbitration](/powershell/module/exchange/new-mailbox#-arbitration) or [AuxPrimary](/powershell/module/exchange/get-mailboxlocation#-mailboxlocationtype) mailboxes aren't supported for simulation.
