---
title: "Set up a connector to Slack eDiscovery data"
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
## Overview of archiving Slack eDiscovery
...
The first step is to gain access to the **Data Connectors** and set up the Slack eDiscovery connector.

1. Go to <https://compliance.microsoft.com> and click **Data connectors** in the left nav.

2. Go to the **Connectors** tab.

3. Click **Add new connector** and select **Slack eDiscovery**.

4. On the **Terms of service** page, click **Accept**.

5. Define a unique name that can represent or identify the connector and click **Next**.

6. Log in to your Globanet Merge1 account to configure the connector.

## Step 2: Configure Slack eDiscovery

The second step is to configure the Slack eDiscovery connector in the Merge1 site. For more information about how to configure the Slack eDiscovery connector in the Globanet Merge1 site, see [Merge1 Third-Party Connectors User Guide](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20Slack%20eDiscovery%20User%20Guide.pdf).
...
1. On the **Map external users to Microsoft 365 users** page, enable automatic user mapping.
   ...
   The Slack eDiscovery items include a property called *Email*, which contains email addresses for users in your organization. If the connector can associate this address with a Microsoft 365 user, the items are imported to that user’s mailbox.
