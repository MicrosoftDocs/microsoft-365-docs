...
All users in your organization are able to view  the **Alerts** and **Alert policies** pages in Compliance Manager. However, only users with certain role types can create and edit policy alerts, or edit alerts. See [Alert policy permissions](#alert-policy-permissions) for details.
