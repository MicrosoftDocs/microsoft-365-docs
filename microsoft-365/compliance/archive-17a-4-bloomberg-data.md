...
The first step is to access to the Data connectors page in the Microsoft Purview compliance portal and create a 17a-4 connector for Bloomberg data.
...
After you create a Bloomberg DataParser connector, you can view the connector status in the Microsoft Purview compliance portal.
