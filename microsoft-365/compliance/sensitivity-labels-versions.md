...
|[Audit label-related user activity](sensitivity-labels-office-apps.md#auditing-labeling-activities) : <br /> - Includes encryption actions | Preview: [Beta Channel](https://office.com/insider)| Under review | Under review | Under review | Under review |
