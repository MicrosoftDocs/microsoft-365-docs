...
|[Preventing oversharing as DLP configuration](dlp-create-deploy-policy.md#scenario-2-show-policy-tip-as-oversharing-popup)| Preview: Rolling out to [Beta Channel](https://office.com/insider) | Under review | Under review | Under review | Under review |
