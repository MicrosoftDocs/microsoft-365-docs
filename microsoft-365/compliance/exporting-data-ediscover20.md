...
**Add to another review set:** Copy data from one review set to a different review set. For more information, see [Add data from one review set to another review set](ediscovery-ediscovery-add-data-to-review-set-from-another-review-set.md).
