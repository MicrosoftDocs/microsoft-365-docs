...
- Verify that your account has permission to access the Security & Compliance Center. For details, see [Give users access to the Security & Compliance Center](compliance/grant-access-to-the-security-and-compliance-center.md).
