...
- **Do Compliance Security Filters Count against Search Query Limits?** Yes. Compliance Security filters do count against the character limit for Search queries. For more information, see [Limits in Advanced eDiscovery](https://docs.microsoft.com/en-us/microsoft-365/compliance/limits-ediscovery20?view=o365-worldwide).
