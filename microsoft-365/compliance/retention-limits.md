...
A single tenant can have a maximum of 10,000 policies (any configuration). This maximum number includes the different policies for retention and other policies for compliance. For example, policies for DLP, information barriers, eDiscovery holds, and policies for sensitivity labels. 
