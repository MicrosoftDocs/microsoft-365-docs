...
- If you upload a file with a sensitivity label that applies encryption, SharePoint can't process these files so coauthoring, eDiscovery, DLP, and search don't work for these files.
