...
Customers who want to develop a cardholder environment or card processing service can use the Azure validation in many of the underlying portions, thereby reducing the associated effort and costs of getting their own PCI DSS certification.
