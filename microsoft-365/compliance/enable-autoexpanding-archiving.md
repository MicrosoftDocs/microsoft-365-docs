...
Make sure you prepare end users for the changes they can expect after enabling their mailbox for auto-expanding archives.  For a brief overview of the client experience, see [What gets moved to the additional archive storage space?](https://learn.microsoft.com/microsoft-365/compliance/autoexpanding-archiving#what-gets-moved-to-the-additional-archive-storage-space).
