...
- **Current Channel** and **Monthly Enterprise Channel**: Not before version 2212+ 
...
|Admin can display labels for just files or just emails| [In preview](sensitivity-labels-versions.md#scope-labels-to-just-word-excel-and-powerpoint-or-to-just-outlook)|
