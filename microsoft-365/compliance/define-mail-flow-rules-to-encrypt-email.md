...
You can't encrypt inbound mail from senders outside of your organization. If a mail flow rule is set up to encrypt mail that Exchange Online considers coming from outside the organization, mail will be rejected and returned to the sender.
