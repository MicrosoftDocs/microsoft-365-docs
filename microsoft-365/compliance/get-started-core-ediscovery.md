...
3. Select **Roles** and then select the **eDiscovery Manager** check box.
4. On the eDiscovery Manager flyout page, select **Edit Role Group**.
5. On the **Choose eDiscovery Manager** page in the edit role group wizard, select **Choose discovery manager**.
6. Select **Add**, then select the checkbox for all users you want to add to the role group.
7. Select **Add** to add the selected users, and then select **Done**.
8. Select **Save** to add the users to the role group, and then select **Close** to complete the step.
