...
To keep up with the latest apps your organization is using, new app-based attacks, and for ongoing changes to your app compliance needs, you might need to manage your app policies in these ways:

- Create new policies targeted to new apps
...
- Select the policy in the policy list and select **Edit** on the app policy pane.
...
- **Name and description**: Change the name to make it easier to find in the list or change the policy severity.
- **Policy settings**: Change the set of apps to which the policy applies. You can also elect to use the existing conditions or modify the conditions
