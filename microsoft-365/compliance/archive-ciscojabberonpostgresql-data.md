...
description: "Learn how to set up and use a connector in the Microsoft Purview portal to import and archive data from Cisco Jabber on PostgreSQL to Microsoft 365."
---
...
Use a Veritas connector in the Microsoft Purview portal to import and archive data from the Cisco Jabber platform to user mailboxes in your Microsoft 365 organization. Veritas provides a [Cisco Jabber on PostgreSQL](https://www.veritas.com/insights/merge1/jabber) connector that is configured to capture items from the third-party data source (on a regular basis) and import those items to Microsoft 365. The connector converts the content such as messages, chats, and shared content from Cisco Jabber on PostgreSQL to an email message format and then imports those items to the user's mailbox in Microsoft 365.
...
3. The Cisco Jabber on PostgreSQL connector that you create in the Microsoft Purview portal, connects to the Veritas Merge1 site every day, and transfers the Jabber content to a secure Azure Storage location in the Microsoft cloud.
...
The first step is to access to the **Data Connectors** page in the Microsoft Purview portal and create a connector for Jabber data.
...
To map users and complete the connector setup in the Microsoft Purview portal, follow these steps:
...
After you create the Cisco Jabber on PostgreSQL connector, you can view the connector status in the Microsoft Purview portal.
