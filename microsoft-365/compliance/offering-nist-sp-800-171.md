...
Accredited third-party assessment organizations, Kratos Secureinfo and Coalfire, partnered with Microsoft to attest that it is in-scope cloud services meet the criteria in NIST SP 800–171, *Protecting Controlled Unclassified Information (CUI) in Nonfederal Information Systems and Organizations,* when they process CUI. The [Microsoft implementation of FedRAMP](offering-fedramp.md) requirements help ensure that Microsoft in-scope cloud services meet or exceed the requirements of NIST SP 800–171 using the systems and practices already in place.
...
- [Microsoft and the US Department of Defense](offering-DoD-DISA-L2-L3-L5.md)
