...
1. As an eDiscovery Manager or eDiscovery Administrator, open **eDiscovery**, and open the case that the non-Office 365 data will be uploaded to. If you need to create a case, see [eDiscovery cases in the Security &amp; Compliance Center](ediscovery-cases.md)
