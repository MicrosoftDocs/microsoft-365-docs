...
- a work or school account for Microsoft 365 to add to the **EDM\_DataUploaders** security group
...
> [!IMPORTANT]
> 1. If using Windows Server 2016 or before, you must also [install Visual C++](https://learn.microsoft.com/cpp/windows/latest-supported-vc-redist?view=msvc-170#visual-studio-2015-2017-2019-and-2022&preserve-view=true) prior to installing the EDM Upload Agent.
>
...
2. Add one or more users to the **EDM\_DataUploaders** security group. (These users manage the database of sensitive information.)
