...
3. The ServiceNow connector that you create in the Microsoft Purview compliance portal connects to the Veritas Merge1 site every day and transfers the ServiceNow content to a secure Azure Storage location in the Microsoft cloud.
...
The first step is to access to the **Data Connectors** page in the Microsoft Purview compliance portal and create a connector for ServiceNow data.
...
After you create the ServiceNow connector, you can view the connector status in the Microsoft Purview compliance portal.
