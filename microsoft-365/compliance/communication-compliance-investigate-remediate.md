...
> [!NOTE]
> If you select the **Pending** tab, you may notice that the count of policy matches in the **Pending** tab heading doesn't match the number shown in the **Items** heading in the table in the lower part of the screen. Refresh the page to update both and make them match.  
