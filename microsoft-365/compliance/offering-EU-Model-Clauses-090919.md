...
Covered services for European Union Model Clauses
...
[What is the EU Data Protection Directive 95/46/EC?](javascript:void\(0\);)
...
[Why is compliance with the Model Clauses important?](javascript:void\(0\);)
...
[Where can I see compliance information for Microsoft services?](javascript:void\(0\);)

Compliance is a contractual commitment. Microsoft Standard Contractual Clauses are available to all cloud customers in the [<span class="underline">Online Services Terms</span>](http://aka.ms/Online-Services-Terms); for other services, see your existing agreement with Microsoft.

[What is a "sub-processor"?](javascript:void\(0\);)
...
[Where do I start with my own organization’s compliance efforts?](javascript:void\(0\);)

You can enter an agreement such, as the [<span class="underline">Online Services Terms</span>](http://aka.ms/Online-Services-Terms), or explore amending your existing agreement to incorporate the Standard Contractual Clauses.
...
Resources
  ...
  - [**EU Model Clauses FAQ for Dynamics 365 and Office 365**](https://products.office.com/en-us/business/office-365-trust-center-eu-model-clauses-faq)
