---
title: "Create EDM SIT rule package new experience"
f1.keywords:
- NOCSH
ms.author: chrfox
author: chrfox
...
# Create EDM SIT rule package new experience

[!include[Purview banner](../includes/purview-rebrand-banner.md)]

You can create an exact data match (EDM) sensitive information type (SIT) by using the new experience in the compliance portal.
