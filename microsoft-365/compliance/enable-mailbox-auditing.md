...
- When Microsoft releases a new mailbox action, the action may be automatically added to the list of mailbox actions that are audited by default (subject to the user having the appropriate licensing). This means you don't need to monitor add new actions on mailboxes.
