...
Certain improvement actions can be automatically tested by Compliance Manager. [Get details](/compliance/compliance-manager-setup?view=o365-worldwide#set-up-automated-testing) on which improvement actions can and can't be tested automatically.
