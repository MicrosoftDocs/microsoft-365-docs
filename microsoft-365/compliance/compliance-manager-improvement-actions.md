...
Certain improvement actions can be automatically tested by Compliance Manager. [Get details](/microsoft-365/compliance/compliance-manager-setup.md#set-up-automated-testing) on which improvement actions can and can't be tested automatically.
