...
2. Remove old searches that are no longer needed using [Remove-ComplianceSearch][https://docs.microsoft.com/powershell/module/exchange/remove-compliancesearch?view=exchange-ps] cmdlet.
