...
3. The RingCentral connector that you create in the Microsoft Purview portal, connects to the Veritas Merge1 site every day, and transfers the RingCentral content to a secure Azure Storage location in the Microsoft cloud.
...
The first step is to access to the **Data Connectors** page in the Microsoft Purview portal and create a connector for RingCentral data.
...
After you create the RingCentral connector, you can view the connector status in the Microsoft Purview portal.
