...
> [!NOTE]
> Retention policies now support shared channels, currently in preview. Any shared channels inherit retention settings from the tenant that created the shared channel.
