...
- **Teams messages in private channels aren't supported** Currently, retention policies created for Teams don't apply to private channel messages but to standard channels and all Teams chats. 
