---
title: "Testing built-in classifiers using retention labels (preview)"
f1.keywords:
- NOCSH
ms.author: chrfox
author: chrfox
...
# Testing built-in classifiers using retention labels (preview)

Microsoft has trained and tested five classifiers which can help to identify certain categories of content. These classifiers show up in the `Ready to use` group by default and were trained using very large sample data sets.
...
- [Overview of retention labels](retention.md)
- [Auto-apply retention label policy based on a condition](retention.md#applying-a-retention-label-automatically-based-on-conditions)
