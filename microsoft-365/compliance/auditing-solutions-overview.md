...
Microsoft 365 auditing solutions provide an integrated solution to help organizations effectively respond to security events, forensic investigations, internal investigations, and compliance obligations. Thousands of user and admin operations performed in dozens of Microsoft 365 services and solutions are captured, recorded, and retained in your organization's unified audit log. Audit records for these events searchable by security ops, IT admins, insider risk teams, and compliance and legal investigators in your organization, and provides visibility into the audited activities across Microsoft 365.

## Microsoft 365 auditing solutions

Microsoft 365 provides two auditing solutions: Basic auditing and Advanced Audit. The following table compares the auditing features available for both solutions.

|Feature|Basic auditing|Advanced Audit|
|:------|:-------------|:-------------|
|Enabled by default|![Supported](../media/check-mark.png)|![Supported](../media/check-mark.png)|
|Audit search tool in Microsoft 365 compliance center|![Supported](../media/check-mark.png)|![Supported](../media/check-mark.png)|
...
||||
> [!NOTE]
> <sup>1</sup> Advanced Audit includes higher bandwidth access to the Office 365 Management Activity API, which provides faster access to audit data.<br/><sup>2</sup> In addition to the require licensing for Advanced Audit (described in the next section), a user must be assigned a 10-Year Audit Log Retention add on license to retain their audit records for 10 years.
