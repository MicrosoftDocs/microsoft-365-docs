...
The first step is to access to the Data connectors page in the Microsoft Purview compliance portal and create a 17a-4 connector for ICE Connect Chat data.
...
After you create an ICE DataParser connector, you can view the connector status in the Microsoft Purview compliance portal.
