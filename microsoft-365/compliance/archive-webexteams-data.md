...
3. The Webex Teams connector that you create in the Microsoft Purview portal, connects to the Veritas Merge1 every day, and transfers the Webex Teams items to a secure Azure Storage location in the Microsoft cloud.
...
After you create the Webex Teams connector, you can view the connector status in the Microsoft Purview portal.
