...
- Audit Logging is turned on for enterprise customers, by default, but please ensure that this is the case. For more information, see [Turn audit log search on or off](turn-audit-log-search-on-or-off.md).
