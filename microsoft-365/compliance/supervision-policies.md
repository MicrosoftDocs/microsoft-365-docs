...
You remediate supervision issues you've investigated using the following options:
...
- **Open a case in other Microsoft 365 compliance solutions**: In the most severe cases, you may need to open a case for deeper investigation and review of an issue. Communication Supervision is integrated with other Microsoft 365 compliance review features to help you with end-to-end resolution management. Opening a new case automatically resolves the alert in the Communication Supervision workflow.
