...
3. The Redtail Speak connector that you create in the Microsoft Purview compliance portal connects to the Veritas Merge1 site every day and transfers the messages to a secure Azure Storage location in the Microsoft cloud.
...
The first step is to access to the **Data Connectors** page in the Microsoft Purview compliance portal and create a connector for the Redtail Speak data.
...
After you select **Save & Finish**, the **User mapping** page in the connector wizard in the Microsoft Purview compliance portal is displayed.
...
After you create the Redtail Speak connector, you can view the connector status in the Microsoft Purview compliance portal.
