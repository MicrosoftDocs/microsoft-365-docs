...
4. All devices must be [Azure Active Directory (Azure AD) joined](/azure/active-directory/devices/concept-azure-ad-join), Hybrid Azure AD joined, or AAD registered.
   ...
   > If using either 'AAD registered' or 'Hybrid Azure AD joined' devices, then the device can joined to on-premises Active Directory.
   > For more information on Hybrid Azure AD join, refer to: https://docs.microsoft.com/azure/active-directory/devices/concept-azure-ad-join-hybrid
