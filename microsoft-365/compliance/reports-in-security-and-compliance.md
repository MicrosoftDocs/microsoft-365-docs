...
|**Report**|**Description**|
|:-----|:-----|
|**Office 365 audit log report** <br/> |You can search the Office 365 audit log for user and admin activity in your Office 365 organization. The report contains entries user and admin activity in Exchange Online, SharePoint Online, OneDrive for Business, and Azure Active Directory, which is the directory service for Office 365. For more information, see [Search the audit log in the Office 365](compliance/search-the-audit-log-in-security-and-compliance.md).  <br/> |
