...
After a retention policy is assigned to an Exchange location, the paths the content takes depend on whether the retention policy is to retain and delete, to retain only, or delete only.
