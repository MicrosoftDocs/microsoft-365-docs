...
|[Phase 5: Configure services and test EDM SIT](sit-get-started-exact-data-match-configure-services.md#configure-services)| - Microsoft 365 subscription with data loss prevention (DLP)
