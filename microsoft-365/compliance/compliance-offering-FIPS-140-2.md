...
Microsoft certifies that its cryptographic modules comply with the US Federal Information Processing Standard.
...
Certification goes into effect when Microsoft receives validation from NIST; it does not expire.
  ...
  - [**Learn how Microsoft products and cryptographic modules comply with FIPS 140**](NULL)
