...
- A maximum of 4 monitors per device are supported.
...
- To request approval for screen recording for users or groups, complete these configuration steps.
- To approve (or reject) requests for screen recording for users or groups, complete these configuration steps.
