...
[Custom sensitive information types](custom-sensitive-info-types) are used to help prevent inadvertent or inappropriate sharing of sensitive information. As an administrator, you can use the [Security & Compliance Center](create-a-custom-sensitive-information-type) or [PowerShell](create-a-custom-sensitive-information-type-in-scc-powershell) to define a custom sensitive information type based on patterns, evidence (keywords such as *employee*, *badge*, *ID*, and so on), character proximity (how close evidence is to characters in a particular pattern), and confidence levels. Such custom sensitive information types meet business needs for many organizations.
...
[Built-in sensitive information types and what they look for](what-the-sensitive-information-types-look-for)

[Custom sensitive information types](custom-sensitive-info-types)

[Overview of DLP policies](data-loss-prevention-policies)
