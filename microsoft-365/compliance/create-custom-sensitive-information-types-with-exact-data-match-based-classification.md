...
[Custom sensitive information types](https://docs.microsoft.com/en-us/office365/compliance/custom-sensitive-info-types) are used to help prevent inadvertent or inappropriate sharing of sensitive information. As an administrator, you can use the [Security & Compliance Center](https://docs.microsoft.com/en-us/office365/compliance/create-a-custom-sensitive-information-type) or [PowerShell](https://docs.microsoft.com/en-us/office365/compliance/create-a-custom-sensitive-information-type-in-scc-powershell) to define a custom sensitive information type based on patterns, evidence (keywords such as *employee*, *badge*, *ID*, and so on), character proximity (how close evidence is to characters in a particular pattern), and confidence levels. Such custom sensitive information types meet business needs for many organizations.
...
[Built-in sensitive information types and what they look for](https://docs.microsoft.com/en-us/office365/compliance/what-the-sensitive-information-types-look-for)

[Custom sensitive information types](https://docs.microsoft.com/en-us/office365/compliance/custom-sensitive-info-types)

[Overview of DLP policies](https://docs.microsoft.com/en-us/office365/compliance/data-loss-prevention-policies)
