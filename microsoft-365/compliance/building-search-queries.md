...
description: "Use keywords and conditions to narrow the scope of the search when searching for data when using the Advanced eDiscovery in Microsoft 365."
---
