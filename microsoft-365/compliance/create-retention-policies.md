...
The global admin for your organization has full permissions to create and edit retention policies. If you aren't signing in as a global admin, see the [permissions information for information governance](get-started-with-retention.md#permissions-for-retention-policies-and-retention-labels).
