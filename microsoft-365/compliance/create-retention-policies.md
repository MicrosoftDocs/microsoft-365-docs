...
Documents in SharePoint Libraries that are set to not appear in search results have retention settings applied to them as well if site is set to be indexed. 
