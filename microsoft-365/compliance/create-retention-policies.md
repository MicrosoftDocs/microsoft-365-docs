...
Documents in SharePoint libraries that are set to not appear in search results have retention settings applied to them as well if the site is set to be indexed. 
