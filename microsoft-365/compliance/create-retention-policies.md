...
> [!NOTE]
> Retention policies for Yammer are in preview and currently, do not display a message to users when their posts are deleted as a result of a retention policy.
>
