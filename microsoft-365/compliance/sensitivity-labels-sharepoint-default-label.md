...
This configuration is done by a SharePoint site admin: [Add a sensitivity label to SharePoint document library](https://prod.support.services.microsoft.com/en-us/topic/54b1602b-db0a-4bcb-b9ac-5e20cbc28089?preview=true).
