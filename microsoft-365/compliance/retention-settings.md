...
> [!TIP]
> To check whether a site is group-connected, which requires using the **Microsoft 365 Groups** location for static scopes, you can use the **Active sites** page in the SharePoint admin center and the [filter for Microsoft 365 Group](/sharepoint/customize-admin-center-site-list), which you can also add as a column in the list.
> 
