...
- **Run the Inbox Repair tool on exported PST files**: After you've exported PST files, you run the [Inbox Repair tool (ScanPST.exe)](/outlook/troubleshoot/data-files/how-to-repair-personal-folder-file) to fully decrypt the contents of the PST file.
