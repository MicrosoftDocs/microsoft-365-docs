...
### Decrypting RMS-protected email messages and encrypted file attachments using Content search or Core eDiscovery
...
- As previously explained, if you enable decryption of RMS-protected messages when you export them, you have to export the search results as individual messages. If you try to export search results to a PST file, RMS-protected messages will be exported as loose emails instead.
