...
4. Select a **rule match** event that was generated by an activity that you're monitoring.  The events the you can preview evidence for depend on the policy selections you have made previously, as in the following example:

:::image type="content" source="../media/dlp-evidence-preview-settings.png" alt-text="Screenshot of policy settings for evidence preview functionality.":::
