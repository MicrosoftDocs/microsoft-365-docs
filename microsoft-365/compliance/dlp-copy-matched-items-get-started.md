...
See the pre-requisite [licensing requirements for Azure Active Directory P1 or P2](/azure/active-directory/roles/custom-create#prerequisites) needed to create custom role-based access control (RBAC) roles. 
