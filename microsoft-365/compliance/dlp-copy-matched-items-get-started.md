...
See the pre-requisites [licensing requirements for Azure Active Directory P1 or P2](/azure/active-directory/roles/custom-enterprise-apps) needed to create custom role-based access control (RBAC). 
