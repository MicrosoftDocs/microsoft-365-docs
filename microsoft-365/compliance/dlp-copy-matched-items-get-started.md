...
4.Select a **DLP rule matched** event that was generated by an activity that you're monitoring for.  <!-- (6/22/23) Need to update this, in the df tenant, I have to select a File Print activity --> 
