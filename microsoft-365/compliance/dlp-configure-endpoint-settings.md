...
See, [[Scenario 8 Network exceptions](endpoint-dlp-using.md#scenario-8-network-exceptions-preview)](endpoint-dlp-using.md#scenario-9-network-exceptions) for more information on configuring policy actions to use network exceptions.
