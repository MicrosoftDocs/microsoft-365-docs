...
- **Visibility of non-IB users and groups**. Non-IB users and groups are users and groups excluded from IB segments and policies. Non-IB groups and users will be visible to Search in Teams and your global address list. SharePoint and OneDrive may allow search of non-IB groups and users depending on the [SharePoint Mode](/SharePoint/SharePointOnline/information-barriers.md#information-barriers-modes-and-sharepoint-sites) or [OneDrive Mode](/OneDrive/information-barriers.md#information-barriers-modes-and-onedrive).  
