...
An exception is if the inactive mailbox has one or more retention labels configured to retain the item and the retention period hasn't expired. In this case, you can't remove the hold.
