...
|**New transport rule removing antispam header**|A new transport rule to remove antispam header was detected. This might indicate that a spam campaign from the organization's mailbox is currently underway|Medium|No|E5/G5 or Defender for Office 365 P2 add-on subscription|
...
|**Suspicious inbound connector and transport rule created to remove sender email headers**|A suspicious inbound connector and transport rule were created to remove headers that identify the true source addresses of senders. This might indicate that a spam campaign is ongoing from the organization's mailbox|Medium|No|E5/G5 or Microsoft Defender for Office 365 P2 add-on subscription|
|**Suspicious email transport rule detected**|A suspicious transport rule created to forward any email in the organization to attacker owned mailbox|Medium|No|E5/G5 or Microsoft Defender for Office 365 P2 add-on subscription|
|**Suspicious pattern of inbound connector creation**|A suspicious pattern of inbound connector creation was detected. This behavior might suggest that an attacker set a malicious inbound connectors to allow anonymous relay through the organization's Exchange server|Medium|No|E5/G5 or Microsoft Defender for Office 365 P2 add-on subscription|
|**Suspicious email-sending pattern from new Exchange inbound connector**|A suspicious email-sending pattern originating from a new Exchange inbound connector was detected. This behavior might suggest that an attacker set a malicious inbound connector to allow anonymous relay through the organization's Exchange server|Medium|No|E5/G5 or Microsoft Defender for Office 365 P2 add-on subscription|
