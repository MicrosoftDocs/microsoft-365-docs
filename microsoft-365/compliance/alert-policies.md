...
|**Removed an entry in Tenant Allow/Block List**| Generates an alert when a Tenant Allow/Block List allow entry is learned by filtering system and removed. This event is triggered when the entry is removed. <br/><br/> You don't need the allow entry as email containing this entity will be delivered to inbox if nothing else in the email is bad and URL and file will be allowed at time of click. <br/><br/>  For more information on events that trigger this alert, see [Manage the Tenant Allow/Block list](../security/office-365-security/tenant-allow-block-list-about.md).|Informational|No|E1/F1/G1, E3/F3/G3, or E5/G5|
|**Graders disagreement with Tenant Allow/Block List entry**| Generates an alert when the submission corresponding to Tenant Allow/Block List allow entry is found to be malicious by Microsoft. This event is triggered as soon as the submission has been analyzed by Microsoft. <br/><br/> The allow entry will continue to exist for its stipulated duration. For more information on events that trigger this alert, see [Manage the Tenant Allow/Block list](../security/office-365-security/tenant-allow-block-list-about.md).|Informational|No|E1/F1/G1, E3/F3/G3, or E5/G5|
|**Tenant Allow/Block List entry is about to expire**| Generates an alert when a Tenant Allow/Block List entry is about to be removed. This event is triggered seven days prior to expiration date, which is based when the entry was created or last updated. <br/><br/> For both allows and blocks, you can extend the expiration date to keep the entry in place. For more information on events that trigger this alert, see [Manage the Tenant Allow/Block list](../security/office-365-security/tenant-allow-block-list-about.md).|Informational|No|E1/F1/G1, E3/F3/G3, or E5/G5|
