...
|**Admin triggered manual investigation of email**|This alert is triggered because an admin triggered manual investigation of an Email from Explorer, see [Example: A security administrator triggers an investigation from Threat Explorer] (https://docs.microsoft.com/en-us/microsoft-365/security/office-365-security/automated-investigation-response-office?view=o365-worldwide#example-a-security-administrator-triggers-an-investigation-from-threat-explorer).  This alert is to notify your organization that the investigation was started, provide information about who triggered it, and provide a link back to the investigation.  This policy has a **Informational** severity setting.|Threat management| E5/G5 or Office 365 ATP P2 add-on subscription| 
