...
description: "Learn about the limits in effect for the Content Search feature in the Microsoft 365 compliance center, such as the maximum number of simultaneous searches."
---

# Limits for Content Search and Core eDiscovery 
...
|Maximum amount of mailboxes search results that can be downloaded using the eDiscovery Export Tool <br/><br/> **Note:** To download the search results from more than 100,000 mailboxes, you have to use Security & Compliance Center PowerShell. For instructions, see [Exporting results from more than 100,000 mailboxes](#exporting-results-from-more-than-100000-mailboxes). <br/> | 100,000 <br/>|
