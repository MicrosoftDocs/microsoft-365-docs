...
|The maximum number of mailboxes in a Content Search that you can export items from. If the Content Search that you're exporting from has more source mailboxes than this limit, the export will fail. For more information about export, see [Export Content Search results](export-search-results.md).  <br/> |100,000  <br/> |
