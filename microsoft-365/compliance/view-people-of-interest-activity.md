...
For more information about viewing, filtering, or exporting audit log search results, see [Search the audit log in the Office 365](../compliance/search-the-audit-log-in-security-and-compliance.md).