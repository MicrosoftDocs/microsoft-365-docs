...
> [!IMPORTANT]
> The eDiscovery functionality described in this article has either been removed from the Microsoft 365 service or may still be available, but no longer supported. Any functionality that's still available in the system may be removed without notice. If you're still using any of these legacy tools, consider migrating to the eDiscovery tools in the Microsoft 365 compliance center or one of the alternatives described in this article.
