...
|Confidential|Sensitive business data that could cause damage to the business if shared with unauthorized people. Examples include contracts, security reports, forecast summaries, and sales account data.|This label is selected for [client-side auto-labeling](##client-side-auto-labeling) and [Service-side auto-labeling](#service-side-auto-labeling). <br /><br /> **Scope**: File, Email <br /><br />**Content marking**: No<br /><br />**Auto-labeling**: No <br /><br />**Group settings**: No<br /><br />**Site settings**: No <br /><br />**Auto-labeling for database columns**: None|
