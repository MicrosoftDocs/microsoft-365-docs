...
- **Email blast senders**: Review the list of senders of email blast messages that were filtered out from your communication compliance policies to reduce "noise." **Filter email blasts** is a communication compliance policy setting. The Email blast senders report includes the following fields:
