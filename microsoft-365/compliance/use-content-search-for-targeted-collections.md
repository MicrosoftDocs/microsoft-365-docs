...
description: "Use Content search in the Microsoft Purview portal to perform a targeted collection, which searches for items in a specific mailbox or site folder."
---
...
- You have to be a member of the eDiscovery Manager role group in the Microsoft Purview portal to run the script in Step 1. For more information, see [Assign eDiscovery permissions](assign-ediscovery-permissions.md).
