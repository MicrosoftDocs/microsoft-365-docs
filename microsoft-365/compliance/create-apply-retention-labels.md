...
In addition, when you use [SharePoint Syntex](../contentunderstanding/microsoft-sharepoint-syntex-overview.md) and publish retention labels to SharePoint locations, you can [apply a retention label to a document understanding model](../contentunderstanding/apply-a-retention-label-to-a-model.md) so that identified documents are automatically labeled.
