...
|4|Discover, label, and protect sensitive items that reside in data stores on premises by deploying the [information protection scanner](deploy-aip-scanner.md) with your sensitivity labels.| [Configuring and installing the information protection scanner](deploy-aip-scanner.md-configure-install)|
