...
**Similar job title**: Users with a combination of organizational distance and similar job titles. This option requires that your organization uses Azure AD to maintain organization hierarchy, role designations, and job titles. If you do not have Azure AD configured for organization structure and job titles, then Insider Risk Management identifies peer groups based on common SharePoint sites.
