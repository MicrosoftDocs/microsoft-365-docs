...
|**Workload1 Type**         |String value indicating the type of data source to associate with the custodian. Possible values include: <br/>- ExchangeMailbox<br/> - SharePointSite<br/>- TeamsMailbox<sup>2</sup><br/>- YammerMailbox<sup>3</sup>| 
...
<br>
> <sup>2,</sup><sup>3</sup> Group site (TeamSite and YammerSite) are added by default with TeamsMailbox and YammerMailbox workloads. You don't need to specify TeamsSite and YammerSite separately in CSV.
