...
|--------------|----------|-------------------| 
| **Data loss prevention**| **DLP Policies** | **Limitation:** Scanning images embedded in Microsoft Office documents isn't supported.|  
| **Insider risk management** | **Insider risk management policies** <br><br> IRM policies will consider sensitive information types and trainable classifiers present in images for risk scoring| **Limitation:** Scanning images embedded in Microsoft Office documents isn't supported.|
