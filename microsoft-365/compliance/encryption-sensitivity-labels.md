...
4.  On the **Encryption** page, select one of the following options:
    ...
    - **Remove encryption if the file is encrypted**: When you select this option, applying the label will remove existing encryption for a file, even if it was applied independently from a sensitivity label.
