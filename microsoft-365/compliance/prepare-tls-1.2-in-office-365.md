...
- To identify the version of TLS used by SMTP clients, see [SMTP Auth clients insight and report in the Security & Compliance Center](/microsoft-365/security/office-365-security/mfi-smtp-auth-clients-report).
