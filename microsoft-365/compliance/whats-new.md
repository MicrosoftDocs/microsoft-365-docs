...
- [SharePoint and OneDrive data resiliency in Microsoft 365](assurance/assurance-sharepoint-onedrive-data-resiliency) - changes to blob storage resilience section.
