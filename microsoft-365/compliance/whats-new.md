...
- **In preview**: Now supported for Windows, macOS, iOS, and Android, auditing details for sensitivity labels include encryption actions such as a change in the encryption status and settings, and the Rights Management owner.
