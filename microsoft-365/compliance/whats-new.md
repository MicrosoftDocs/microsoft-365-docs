...
- **Rolling out**: A [default retention label for Outlook](create-apply-retention-labels.md#applying-a-default-retention-label-to-an-outlook-folder) is always retained when an item is moved to the **Deleted Items** folder.
