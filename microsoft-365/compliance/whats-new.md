...
- [Azure, Dynamics 365, and Windows breach notification under the GDPR](regulatory/gdpr-breach-azure-dynamics-windows) - updated to clarify that customers don't need to use a pay service such as Defender for Cloud to receive security and privacy notifications
