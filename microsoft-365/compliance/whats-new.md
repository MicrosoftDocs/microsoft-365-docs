...
- Rolling out: In the Microsoft Purview compliance portal, the horizontal tabs for **Overview**, **Labels**, **Label policies**, and **Auto-labeling** are now displayed as vertical options in the left navigation pane when you expand **Information protection**.
