...
- **In preview**: Now supported for Windows in the Beta Channel, auditing details for sensitivity labels include encryption actions such as a change in the encryption status and settings, and the Rights Management owner.
