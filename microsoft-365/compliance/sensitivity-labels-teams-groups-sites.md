...
After a sensitivity label has been applied to a site, you must have the following roles to change that label in SharePoint or Teams:
- Group-connect site: [Microsoft 365 group Owners](admin/create-groups/office-365-groups)
- Site that isn't group-connected: [site admin](/sharepoint/site-permissions#site-admins)
