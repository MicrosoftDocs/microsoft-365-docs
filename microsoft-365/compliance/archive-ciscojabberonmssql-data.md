...
3. The Cisco Jabber connector that you create in the Microsoft Purview portal connects to the Veritas Merge1 site every day and transfers the items to a secure Azure Storage location in the Microsoft cloud.
...
The first step is to access to the **Data Connectors** in the Microsoft Purview portal and create a connector for Cisco Jabber on MS SQL data.
...
To map users and complete the connector set up in the Microsoft Purview portal, follow these steps:
...
After you create the Cisco Jabber on MS SQL connector, you can view the connector status in the Microsoft Purview portal.
