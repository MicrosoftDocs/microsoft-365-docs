...
Retention settings do not apply to organizing structures that include libraries, lists, and folders. Or to system lists that are hidden lists used by SharePoint to manage the system and include the master page catalog, solution catalog, and data sources.
