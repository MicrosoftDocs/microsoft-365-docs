...
[Read how Genetec cleared criminal investigations](https://customers.microsoft.com/en-us/story/genetec)
...
Services subject to CJIS Security Policy commitments include:
  ...
  - > Office 365 U.S. Government [<span class="underline">detailed list</span>](https://go.microsoft.com/fwlink/p/?LinkID=2077751)
...
[Where can I request compliance information?](javascript:void\(0\);)
...
[How does Microsoft demonstrate that its cloud services enable compliance with my state’s requirements?](javascript:void\(0\);)
...
[Where do I start with my agency’s compliance effort?](javascript:void\(0\);)
