...
- In an Exchange hybrid deployment, you can't use the Content search tool to search on-premises mailboxes. You can only use te tool to search cloud-based mailboxes.
