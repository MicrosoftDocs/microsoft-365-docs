---
title: "Create and run a Content search in the Microsoft Purview portal"
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
- To access to the Content search tool in the <a href="https://go.microsoft.com/fwlink/p/?linkid=2077149" target="_blank">Microsoft Purview portal</a> (to run searches and preview results and export results), an administrator, compliance officer, or eDiscovery manager must be a member of the eDiscovery Manager role group in the Microsoft Purview portal. For more information, see [Assign eDiscovery permissions](assign-ediscovery-permissions.md).
...
2. In the left navigation pane of the Microsoft Purview portal, click **Content search**.
