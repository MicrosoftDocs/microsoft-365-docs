...
|Conditions: Sensitive info types [in images](ocr-suppt-in-microsoft-purview.md) |No |Yes (SharePoint and OneDrive only) |
...
- If you plan to use [sensitive information types](sensitive-information-type-learn-about.md):
  ...
  - To scan for your selected sensitive information types in images, see [Support for optical character recognition in Microsoft Purview](ocr-suppt-in-microsoft-purview.md).
