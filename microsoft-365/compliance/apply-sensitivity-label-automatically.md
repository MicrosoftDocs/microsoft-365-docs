...
The Azure Information Protection unified labeling client supports automatic labeling for built-in and custom sensitive info types, but not trainable classifiers or sensitive info types that use Exact Data Match (EDM).
