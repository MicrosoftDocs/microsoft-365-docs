...
This option is currently in preview. If you use this option, make sure you have at least one other sensitivity label in your tenant that's configured for auto-labeling and the [sensitive info types option](#configuring-sensitive-info-types-for-a-label).
