...
- If you plan to use [sensitive information types](sensitive-information-type-learn-about.md):
  ...
  - If you want to use the condition **Document property is**, be aware that this uses SharePoint managed properties. The [preparation for DLP policies](protect-documents-that-have-fci-or-other-properties.md#before-you-create-the-dlp-policy) equally applies for when you use this condition with auto-labeling policies.
