...
- **Service-side labeling when content is already saved (in SharePoint or OneDrive) or emailed (processed by Exchange Online)**: Use an auto-labeling policy. 
    ...
    - Maximum of 10 site locations for each auto-labeling policy.
        - These site locations can be any combination of SharePoint site collections or individual sites, and OneDrive sites.
