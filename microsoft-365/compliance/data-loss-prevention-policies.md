...
If you choose to include specific distribution groups in Exchange, DLP policy will be scoped only to the members of that group. Similarly excluding a distribution group will exclude all the members of that distribution group from policy evaluation. You can chose to scope a policy to the members of Distribution lists, Dynamic distribution groups and Security groups. A DLP policy can contain no more than 50 such inclusions and exclusions.
...
To learn more about user notifications and poicy tips in DLP policies, see https://docs.microsoft.com/en-us/microsoft-365/compliance/use-notifications-and-policy-tips
