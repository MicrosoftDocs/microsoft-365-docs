...
Find more information about about modifying sensitive information types via XML in [Customize a built-in sensitive information type](customize-a-built-in-sensitive-information-type).
