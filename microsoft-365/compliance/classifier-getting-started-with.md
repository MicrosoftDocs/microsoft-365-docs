...
- Offensive Language
- Resumes - detects items that document an individuals employment, education, personal history, contact information and other personally identifying information.
- SourceCode - Detects a set of instructions and statements written in a computer programming language.
- Harassment - detects items that contain language which indicates offensive conduct targeting one or multiple individuals regarding race, color, religion, national origin, gender, sexual orientation, age, disability and genetic information.
- Profanity - detects items that contain swear words or vulgar language.
- Threat - detects items that contain threats to commit violence or do physical harm or damage to a person or property.
...
When the pre-trained classifiers don't meet your needs, you can create and train your own classifiers. There is significantly more work involved with creating your own, but they'll be much better tailored to your organizations needs.
