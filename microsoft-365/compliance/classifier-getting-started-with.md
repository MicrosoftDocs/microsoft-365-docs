...
> [!IMPORTANT]
> Both **Automated pattern matching** and **Trainable classifiers** are available as conditions for [applying a retention label automatically based on conditions](labels.md#applying-a-retention-label-automatically-based-on-conditions) and [communication compliance](communication-compliance.md).
