...
|From|The sender of an email message.<sup>1</sup>|`from:pilarp@contoso.com`|Messages sent by the specified user.<br>([See Recipient Expansion](keyword-queries-and-search-conditions.md#recipient-expansion))|
