...
The last step is to create an Android Archiver connector in the Microsoft Purview compliance portal. The connector uses the information you provide to connect to the TeleMessage site and transfer Android communication to the corresponding user mailbox boxes in Microsoft 365.
