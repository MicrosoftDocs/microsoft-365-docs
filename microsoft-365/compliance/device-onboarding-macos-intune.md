---
title: Configure macOS devices with Intune for Endpoint DLP
f1.keywords:
    NOCSH
ms.author: chrfox
author: chrfox
...
# Configure macOS devices with Intune for Endpoint DLP

Assumes that the device is already managed through Intune. If not, the device must be onboarding through Intune, see [Deployment guide: Manage macOS devices in Microsoft Intune](https://docs.microsoft.com/en-us/mem/intune/fundamentals/deployment-guide-platform-macos)
