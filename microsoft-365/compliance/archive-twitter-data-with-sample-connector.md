...
Complete the following prerequisites before you can set up and configure a connector in the Microsoft Purview compliance portal to import and archive data from your organization's Twitter account.
...
## Step 5: Set up a Twitter connector in the Microsoft Purview compliance portal

The final step is to set up the Twitter connector in the Microsoft Purview compliance portal that will import data from your organization's Twitter account to a specified mailbox in Microsoft 365. After you complete this step, the Microsoft 365 Import service will start importing data from your organization's Twitter account to Microsoft 365.
