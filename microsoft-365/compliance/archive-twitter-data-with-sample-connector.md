...
Complete the following prerequisites before you can set up and configure a connector in the Microsoft Purview portal to import and archive data from your organization's Twitter account.
...
The final step is to set up the Twitter connector in the Microsoft Purview portal that will import data from your organization's Twitter account to a specified mailbox in Microsoft 365. After you complete this step, the Microsoft 365 Import service will start importing data from your organization's Twitter account to Microsoft 365.

For step-by-step instructions, see [Set up a Twitter connector in the Microsoft Purview portal](deploy-twitter-connector.md#step-5-set-up-a-twitter-connector-in-the-microsoft-365-compliance-center). 
