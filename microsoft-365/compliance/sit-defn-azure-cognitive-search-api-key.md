...
This SIT  is designed to match the security information that's used to authenticate inbound requests to [Azure Cognitive Search APIs.](https://docs.microsoft.com/azure/search/search-security-api-keys) 
