...
1. Enter the customer information, including name, email address, phone number, and more options.

1. Select the staff member to provide the service. The list of staff members is based on what you set up on the services page.

   ![Image of staff list UI.](../media/bookings-staff-list.png)

1. Enter the service details, including date, time, location, and other relevant information by selecting **More options**. The customer confirmation includes an attachment for them to add to their calendar. Selected staff members also receive meeting invitations with the appointment information so they can add them to their personal calendars.
...
1. Select **Save changes**.
   ...
   Here's an example email of the reminder your customer receives:
