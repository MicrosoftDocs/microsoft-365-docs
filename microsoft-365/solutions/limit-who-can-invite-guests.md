...
If your business processes require that you limit who can share with guests, or if you want users to complete training before they're able to share with guests, you can limit who can share by using the Guest inviter role in Microsoft Entra ID.
...
1. In [Microsoft Entra ID](https://aad.portal.azure.com/), select **External identities**.
