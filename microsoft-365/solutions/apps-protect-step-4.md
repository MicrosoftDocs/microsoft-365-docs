...
[:::image type="content" source="../media/configure-managed-apps/configure-managed-apps-02.png" alt-text="Step 5. Verify and monitor app protection" border="false" :::](apps-protect-step-5.md)
