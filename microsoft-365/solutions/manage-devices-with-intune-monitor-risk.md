...
:::image type="content" source="../media/devices/secconmgmt-baseline-card.png" alt-text="A screenshot example of the card in Defender for Endpoint for monitoring compliance to security baselines." lightbox="../media/devices/secconmgmt-baseline-card.png":::
...
|2     |  Deploy Windows security baseline settings for Intune. If not, see the guidance in [Step 5. Deploy configuration profiles](manage-devices-with-intune-configuration-profiles.md).        |
