...
* The storage system must be able to store data beyond the retention period required by the rule, in the case of a subpoena or other legal order.
...
To help financial institutions meet the requirements of SEC rule 17a-4, Microsoft 365 provides a combination of capabilities related to how data is retained, how retention policies are configured, and how data is stored within the service. These include:
...
* Start or continur a chat session
