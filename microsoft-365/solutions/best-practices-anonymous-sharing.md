...
See [ATP for SharePoint, OneDrive, and Microsoft Teams](../security/defender-365-security/atp-for-spo-odb-and-teams.md) and [Turn on ATP for SharePoint, OneDrive, and Microsoft Teams](../security/defender-365-security/turn-on-atp-for-spo-odb-and-teams.md) for additional guidance.
