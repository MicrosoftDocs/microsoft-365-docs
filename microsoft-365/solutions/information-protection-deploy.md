...
- Assessing data privacy risks, readiness, and the occurrence of target sensitive information types in your environment.
- Using Microsoft Compliance Score and Compliance Manager to track and manage improvement actions related to compliance with data privacy regulations.
- Common identity, device, and threat protection capabilities potentially impacting compliance with data privacy regulations.
- Protecting information subject to data privacy regulation in your organization.
- Governing information subject to data privacy regulation in your organization.
- Monitoring and responding to data privacy incidents in your organization.
