...
| Apps included with your Intune license | The license you use with Microsoft Intune may include the app licenses you require. For more information, see [App licenses included with Intune](apps-license-overview.md?#app-licenses-included-with-intune).  |
...
<sup>1</sup> For more information about Android Enterprise and Android work profiles.
