...
- MET150
- MOE150
description: "Learn how to import email to Microsoft 365for business."
---
...
5. Verify that you are including sub-folders. Then select  **Next**.
...
3. Select  **Outlook data file** , and then select  **Next**.
4. Select  **Browse**, and go to the file you just exported. Select it, and then select  **Open**, and then **Next**.
5. Verify that you are including sub-folders and that you're importing items into the same folder in your new email account. Choose  **Finish**.