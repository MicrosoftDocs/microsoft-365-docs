...
| 4. [Protect all devices](#4-protect-all-devices). | Microsoft 365 Business Basic: [Turn on MFA](m365bp-turn-on-mfa.md) (for basic protection).<br/><br/>Microsoft 365 Business Standard: [Turn on MFA](m365bp-turn-on-mfa.md), and [Install Microsoft 365 Apps on devices](m365bp-users-install-m365-apps.md).<br/><br/>Microsoft 365 Business Premium: [Turn on MFA](m365bp-turn-on-mfa.md), [Install Microsoft 365 Apps on devices](m365bp-users-install-m365-apps.md), and [Secure both managed and unmanaged devices](m365bp-managed-unmanaged-devices.md). |
