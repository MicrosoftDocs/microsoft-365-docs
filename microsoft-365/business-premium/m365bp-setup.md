...
| Browser requirements | Microsoft Edge, Safari, Chrome or Firefox<br/><br/>For more information, see [Browser requirements](https://www.microsoft.com/microsoft-365/microsoft-365-and-office-resources#coreui-heading-uyetipy).  |
| Operating system | **Windows OS** (Windows 11, Windows 10, Windows 8.1, Windows Server 2019 or later, or Windows Server 2016)<br/><br/>**macOS** (One of the three most recent versions of macOS) |
