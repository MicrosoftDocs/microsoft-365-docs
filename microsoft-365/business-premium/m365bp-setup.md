...
|   | Set up Safe Attachments to protect your organization from malicious email attachments | [[Protect against malicious attachments and files with Safe Attachments](../admin/security-and-compliance/secure-your-business-data.md#9-protect-against-malicious-attachments-and-files-with-safe-attachments)](../admin/security-and-compliance/secure-your-business-data.md#set-up-safe-attachments) |
|  | Set up Safe Links to  protect your organization by providing time-of-click verification of web addresses (URLs) in email messages and Office documents | [Set up Safe Links](../admin/security-and-compliance/secure-your-business-data.md#set-up-safe-links) |
