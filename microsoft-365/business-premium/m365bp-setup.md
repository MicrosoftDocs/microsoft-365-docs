...
| Operating systems (servers) | Windows Server or Linux Server with Microsoft Defender for Business servers (currently in preview) <br/>See [How to get Microsoft Defender for Business servers (preview)](../security/defender-business/get-defender-business-servers.md).  |
