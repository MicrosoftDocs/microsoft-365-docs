...
|  | Set up Safe Links to  protect your organization by providing time-of-click verification of web addresses (URLs) in email messages and Office documents | [Protect against phishing attacks with Safe Links](../admin/security-and-compliance/secure-your-business-data.md#10-protect-against-phishing-attacks-with-safe-links) |
