...
| Operating system | One of the following operating systems: <br/><br/>**Windows OS**:<br/>- Windows 11<br/>- Windows 10<br/>- Windows 8.1<br/>- Windows Server 2019 or later<br/>- Windows Server 2016 <br/><br/>**macOS**: One of the three most recent versions of macOS. When a new version of macOS is released, the macOS requirement becomes one of the then-current three most recent versions: the new version of macOS and the previous two versions.<br/><br/>For more information, see [Requirements for Microsoft 365 for business, education, and government](https://www.microsoft.com/microsoft-365/microsoft-365-and-office-resources?rtc=1#coreui-heading-7142msj). |
