...
> [!IMPORTANT]
> The following information applies to Copilot for Microsoft 365 currently and will start rolling out to Microsoft Copilot in the second half of September 2024 for users signed in with an Entra account.
...
- **We secure your data:** We help protect your data with [encryption](microsoft-365/compliance/office-365-encryption-in-the-microsoft-cloud-overview) at rest and in transit, rigorous physical security controls, and data [isolation](/compliance/assurance/assurance-microsoft-365-isolation-controls) between tenants.
...
- [Learn more about data, privacy, and security of web queries](microsoft-365/manage-public-web-access.md)
