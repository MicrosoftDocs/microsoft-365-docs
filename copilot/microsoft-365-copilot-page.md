...
To learn more about managing agents that work with Microsoft 365 Copilot, including how to control the integration of non-Microsoft apps and first-party apps, see [Manage Copilot agents in Integrated Apps](/../manage/manage-copilot-agents-integrated-apps.md).
...
To learn more, see [Use AllowSelfServicePurchase for the MSCommerce PowerShell module](/../commerce/subscriptions/allowselfservicepurchase-powershell.md).
